...
table tr:nth-child(even) {
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="store_admin.php">Dashboard</a></li> 
                                     <li><a href="outgoing_items.php">Issue Stock </a></li> 
                                    <li class='dropdown '>
    ...
    <ul class="stats_box" >
	 ...
	 <div class="box">  
      <h1 class="page-head-line">STORES REQUISITION</h1>  
                <!-- /. ROW  --> 
     ...
     <div  class="row text-center contact-info">
         <div class="col-md-push-5 col-md-push-8">
          ...
          <div class="col-xs-pull-7 col-md-push-9">
           </p>
          <div class="input-group">
                <span class="input-group-addon" style="width: 134px;background-color:#FFFFBB; text-align:left;">Requisition date</span>
                 <input type="date"  id="REQUISTIONDATE" value="<?php echo date('d-m-y'); ?>" disabled="disabled" class="form-control" style="height:28px;"/>
              </div>  
              <br>   
              
               <div class="input-group">
                <span class="input-group-addon" style="width: 134px;background-color:#FFFFBB;text-align:left;">Requisition No.</span>
                 <input type="numeric" input name="REQUISTIONNO"  id="REQUISTIONNO" disabled="disabled" class="form-control" style="height:28px;"/>
              </div>  
              <br>  
              
              <div class="input-group">
                <span class="input-group-addon" style="width: 134px; background-color:#FFFFBB;text-align:left;">UD initials</span> 
                <input type="numeric" input name="USERINITIAL"  id="USERINITIAL" disabled="disabled" class="form-control" style="height:28px;"/> 
              </div>   
               <br>
                 
              <div class="col-xs-pull-8 col-md-push-10" >
              </p>
                <div class="input-group">
                <span class="input-group-addon" style="width: 134px; background-color:#FFFFBB;text-align:left;">Order type</span>
                <select class="form-control" id="REQUISITIONTYPE" input name="REQUISITIONTYPE" disabled="disabled"style="height:28px; width: 179px;"/>
              ...
              <div class="input-group">
                <span class="input-group-addon" style="width: 134px; background-color:#FFFFBB;text-align:left;">Requesting unit</span>
                <select class="form-control" id="DEPARTMENT" input name="DEPARTMENT" disabled="disabled" style="height:28px; width: 179px;"/>
                <option value="_1"> </option>
...
<option value="Advocacy and Research">Advocacy and Research</option>  
              ...
              <div class="input-group">
                <span class="input-group-addon" style="width: 134px; background-color:#FFFFBB;text-align:left;">Initiated by</span> 
                <input type="numeric" input name="INITIATOR"  id="INITIATOR" disabled="disabled" placeholder="title" class="form-control" style="height:28px; width: 179px;"/> 
              </div>   
               <br>
                
            <div class="col-xs-1 col-md-push-11" >   
               <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFFFBB;text-align:left;">Issued by</span>
                 <input type="numeric" input name="ISSUEDBY"  id="ISSUEDBY" required="required" class="form-control" style="height:28px; width: 233px;"/>
              </div>  
              <br>   
              
              <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFFFBB; text-align:left;">Issued date</span>
                 <input type="date"  id="ISSUEDDATE" value="<?php echo date('d-m-y'); ?>"  class="form-control" style="height:28px; width: 233px;"/>
              </div>  
              <br> 
                
              <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFFFBB;text-align:left;">Recieved by</span>
                 <input type="numeric" input name="RECIEVEDBY"  id="RECIEVEDBY" required="required" class="form-control" style="height:28px; width: 233px;"/>
              </div>  
              <br>  
           
            <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFFFBB; text-align:left;">Recieved date</span>
                 <input type="date"  id="RECIEVEDDATE" value="<?php echo date('d-m-y'); ?>"   class="form-control" style="height:28px; width: 233px;"/>
              </div>  
              <br>   
  ...
  function addRow12(tableId){
   ...
   var select1  =  '<input type="numeric" name="QUANTITYINSTOCK" disabled="disabled"  id="qis_'+rowCount+'"'+
	 ...
	 var   select2  =  '<input type="numeric" name="QUANTITYNEEDED" disabled="disabled" id="qn_'+rowCount+'"'+
                    'style= " height:20px; width:53px; background-color:#eeeeee;" >'+ 
                    '</select>';				
					  
					
	 var   select3  =  '<input type="numeric" name="QUANTITYISSUED" required="required"  id="qid_'+rowCount+'"'+
                    'style= " height:20px; width:53px; background-color:#fff;" >'+ 
                    '</select>';
					
					
	 var select4  =  '<select name="UOM" required="required"  id="uo_'+rowCount+'"'+
                    'style= "height:20px; width:100px; background-color:#fff;" >'+
	 ...
	 var   select5  =  '<input type="numeric" name="UNIT" required="required"  id="ut_'+rowCount+'"'+
                    ...
                    '</select>';
					 ...
					 var   select6  =  '<input type="date" name="EXPIRY" placeholder="dd/ mm/ yyyy" required="required"  id="ex_'+rowCount+'"'+
                                       'style= " height:20px; width:80px; background-color:#fff;" >';
  ...
  function deleteRow12(tableID) {
	     ...
	     for(var i=1; i<rowCount; i++) { //0
		  ...
		  table.rows[x].cells[5].childNodes[0].id="qid_"+x;
		  table.rows[x].cells[6].childNodes[0].id="uo_"+x;
		  table.rows[x].cells[7].childNodes[0].id="ut_"+x;  
		  table.rows[x].cells[8].childNodes[0].id="ex_"+x;
...
<div class="container" style="width: 715px;font-size: 12px;margin-left: -363px;margin-top: -40px;"> 
  ...
  <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFFFBB;text-align:left;">Order valuation</span>
                 <input type="numeric" input name="ORDERVALUE"  id="ORDERVALUE" disabled="disabled" class="form-control" style="height:28px; width: 193px;"/>
              </div>  
              <br>  
  
  <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFFFBB;text-align:left;">Total items</span>
                 <input type="numeric" input name="TOTALITEMS"  id="TOTALITEMS" disabled="disabled" class="form-control" style="height:28px; width: 193px;"/>
              </div>  
              <br>  
  ...
  <div class="input-group">
                ...
                <textarea id="REASONFORSUPPLY" style= " width:546px; height:50px; background-color:#fff;" disabled="disabled" placeholder="Reason for placing a requisition order.."></textarea>
              </div>  
              <br> 
            ...
            <div class="input-group">
              ...
              <div class="col-xs-pull-11" style="margin-top: -97px; margin-left: 342px;">
               <div class="input-group">
          ...
          <div class="input-group">
           ...
           <input type="submit" name="button" id="button" value="Update an order" style="background-color:red;">  
        </div>  
