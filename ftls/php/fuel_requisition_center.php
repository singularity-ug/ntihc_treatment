    ...
    <div class="row-fluid"> 
      <div class="widget-box"> 
        <div class="widget-title bg_lg"><span class="icon"><i class=""></i>
         <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-fast-backward"></i> Dashboard </a> 
        </span> 
          <h5 style="text-align:center;">Fuel and lubricants requisitions  </h5>
        </div>
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE AUTHORIZATIONSTATUS ='AUTHORISED' GROUP BY SERIALNO ORDER BY DATECREATED DESC");
