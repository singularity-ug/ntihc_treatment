      ...
      <div class="widget-box"> 
        <div class="widget-title bg_lg"><span class="icon"><i class=""></i>
         <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-fast-backward"></i> Dasboard </a>
          ...
          <h5>  &nbsp;<a href="fuel_authorise.php" title="Go to Home" class="tip-bottom"><i class="icon-backward"></i> Home </a>
           &nbsp;
         <a href="fuel/my_fuel_authorization.php" title="History" class="tip-bottom"><i class="icon-share"></i> My authorization(s) </a></h5>
        </div>
        ...
        <center> <p style="color:#000; font-weight:bold;font-size:10px; background-color:#fff; margin-top: 0px;">
         <b>FUEL AND LUBRICANTS ORDERS DUE FOR AUTHORISATION</b> </p> </center> 
		  ...
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'fuel/fuel_interface.php?q='+odno,
         ...
         <tr>   
                     ...
                     <th style="background-color:#ecf0f5; font-size:10px;">STATUS</th> 
                     <th style="background-color:#ecf0f5; font-size:10px;">ACTION</th>  
           </tr>
        </thead>
        <tfoot>
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE AUTHORIZATIONSTATUS ='PENDING' AND SENDTO = '$rm' GROUP BY SERIALNO ORDER BY DATECREATED DESC");
  
	while($res = mysqli_fetch_array($result)) {
	$dtsz = $res['ORDERNO']."***".$res['SERIALNO'];
		echo "<tr>"; 
		echo '<td> &nbsp; 
			    <a id="1__'.$dtsz.'" href="javascript:void(0)"  onclick="getresorder(this.id)" data-toggle="tooltip" title="click"
               style="color: #fff;border-radius: 3px; height: 20px;" <button class="btn btn-danger"> Authorise</span></a> 
               &nbsp;&nbsp;
               </td>';  	 
