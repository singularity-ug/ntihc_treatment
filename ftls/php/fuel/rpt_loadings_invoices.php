...
<div class="panel-body">
	...
	<thead>
		<tr>
            ...
            <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'CN' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				for($i=0; $cxz = $resultia->fetch(); $i++){
				$zxc=$cxz['sum(Discountallowed * Fueloaded)'];
				echo formatMoney($zxc, true);
				}
				?> 
				</th>
            ...
            <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'LK' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'MA' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'CH' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EK' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EL' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EN' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EC' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			<?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EM' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			<?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EMC' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			<?php 
				$resultia = $db->prepare("SELECT sum(Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'SC' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
	...
	<thead>
		<tr>
            ...
            <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'CN' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				for($i=0; $cxz = $resultia->fetch(); $i++){
				$zxc=$cxz['sum(Fueloaded - Discountallowed * Fueloaded)'];
				echo formatMoney($zxc, true);
				}
				?> 
				</th>
            ...
            <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'LK' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'MA' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'CH' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EK' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EL' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EN' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EC' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			<?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EM' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			<?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'EMC' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:right;">
			<?php 
				$resultia = $db->prepare("SELECT sum(Fueloaded - Discountallowed * Fueloaded) FROM fuellogs WHERE Cardcode = 'SC' AND Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' AND Fiscalpaymentmonth BETWEEN :c AND :d");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
