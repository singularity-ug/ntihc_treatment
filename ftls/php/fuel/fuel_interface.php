...
.progress{
 ...
 <form class="form-horizontal" method="post" action="fuel/fuel_updateauthorizer.php" style="height:auto;">   
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
          ...
          <table class="table-responsive" style="margin-top:0px;">
             ...
             <table class="table" style="border:0px;">
              ...
              <th style="width:60%;border:0px;"> </th>    
               ...
               <tr>  
				...
				<th style="width:60%;border:0px;"> <input type="text" id="ARBY" name="ARBY"  value="<?php echo $desc; ?>"  
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"> </th>   
             ...
             <table class="table" style="border:0px;">
              <tr>  
                 <th style="width:40%;border:0px;">Name</th> 
				<th style="width:60%;border:0px;"> <input type="text" id="ARNAME" name="ARNAME"  value="<?php echo $nameofuser; ?> " 
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"> </th>     
              </tr>
			  </table>  
              </tr>
               ...
               <input type="hidden" id="AUTHDEPT" name="AUTHDEPT"  value="<?php echo $dept; ?>"  >
            ...
            <table class="table" style="border:0px;">
              <tr>  
                ...
                <th style="width:40%;border:0px;">Date</th> 
				<th style="width:60%;border:0px;"> <input type="text" id="ARDATE" name="ARDATE"   value="<?php echo date('Y-m-d'); ?>" 
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"> </th>    
              </tr>
			  </table> 
            ...
            <table class="table" style="border:0px;"> 
                ...
                <th style="width:40%;border:0px;">Forward to:</th> 
				<th style="width:60%;border:0px;"> <select id="FORWARDTO" name="FORWARDTO" required="required"  autofocus="autofocus" 
                ...
                <table class="table-responsive" style="margin-top:-20px;">
                 ...
                 <input type="radio" name="AUTHORIZATIONSTATUS" id="AUTHORIZATIONSTATUS" value="AUTHORISED" checked>
                <label for="AUTHORISED">Authorise</label>
                 </th> 
				<th style="width:40%; border:0px;"> 
                <input name="AUTHORIZATIONSTATUS" type="radio" id="AUTHORIZATIONSTATUS" value="REJECTED">
         ...
         <div class="col-sm-4"> 
          <table class="table-responsive" style="margin-top:0px;">
              ...
              <tr>  
				...
				<th style="width:60%;border:0px;"> <input type="text" id="RVDBY" name="RVDBY"  
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"> </th>   
           ...
           <table class="table-responsive" style="margin-top:-20px;">
             <table class="table" style="border:0px;">
              <tr>  
                 ...
                 <th style="width:40%;border:0px;">Name</th> 
				<th style="width:60%;border:0px;"> <input type="text" id="RVDNAME" name="RVDNAME"  
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"> </th>    
              </tr>
			  </table> 
            ...
            <table class="table" style="border:0px;">
                 <tr>      
                 <th style="width:40%;border:0px;">Date</th> 
				 <th style="width:60%;border:0px;"> <input type="text" id="RVDDATE" name="RVDDATE"  
				 readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"> </th>   
              </tr>
			  </table>  
              ...
              <tr>   
                <th style="width:40%;border:0px;">Comment</th> 
				<th style="width:60%;border:0px;"> <textarea id="RVWERCOMMENT" name="RVWERCOMMENT"  
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff; height:20px;"> </textarea></th>    
              </tr>
			  </table>
                   </div>
