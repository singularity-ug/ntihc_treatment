...
.progress{
  ...
  margin-bottom: 0px;
   ...
   <td style="width:60%;"><input type="numeric" name="id" id="id" value="<?php  echo $id; ?>"  readonly="readonly"
...
<?php 
 ...
 while($row=$res->fetch_assoc()){
    ...
    <td style="width:60%;"><input type="numeric" class="qty" type="text" name="CURRENTMILEAGE" name1="qty[]"  required="required"   
    style="width:100%; text-align:center;background-color:#fff;"></td> 
    ...
    <td style="width:60%;"><input type="numeric" id="DISTANCECOVERED" name="DISTANCECOVERED" name1="DISTANCECOVERED[]" readonly="readonly"  
    style="width:100%; text-align:center;background-color:#fff;"></td> 
    ...
    <td style="width:60%;"><input type="numeric" id="RUNNINGMILEAGE" name="RUNNINGMILEAGE" name1="RUNNINGMILEAGE[]"  readonly="readonly"   
    style="width:100%; text-align:center;background-color:#fff;"></td> 
 ...
 $sql  = "SELECT * FROM getentrant ORDER BY id DESC LIMIT 1";
  ...
  while($row=$res->fetch_assoc()){ 
    ...
    <td style="width:60%;"><input type="numeric" class="qtyexplode" name="UNITPRICE" name1="qtyexplode[]" required="required"      
    style="width:100%; text-align:center;background-color:#fff; height:22px;"> 
    </td>  
    </tr>
    </table>     
    ...
    <td style="width:60%;"><input type="numeric" name="TOTALAMOUNT" id="TOTALAMOUNT" name1="TOTALAMOUNT[]" readonly="readonly"       
    style="width:100%; text-align:center;background-color:#fff; height:22px;"> 
    </td>  
    </tr>
    </table>   
    ...
    <th style="width:40%;">Division</th>         
              <td style="width:60%;"><select name="DIVISION" id="DIVISION" required="required"   
    ...
    <td style="width:60%;"><select name="DIRECTORATE" id="DIRECTORATE" required="required"     
    style="width:100%; text-align:left;background-color:#fff;height:22px;">
                  <option></option>
...
function pop(dat){
  ...
  $("#PURPOSE"+num).val(data[2]);
  $("#SOURCEOFFUND").val(data[2]); 
...
function domee(ths){
  ...
  success: function(result){
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;" width="100%"> 
    ...
    <td style="width:60%;"><input type="text" name="PURPOSE" id="PURPOSE"  onKeyUp="domee(this)"  
    required="required"   
    style="width:100%; text-align:left;background-color:#fff; height:22px;"> 
    </td> 
    </tr>
    ...
    <input type="hidden" name="SOURCEOFFUND" id="SOURCEOFFUND"  required="required" value="<?php  echo $SOURCEOFFUND; ?>"  >
	
	<div id="res" style="border:0px;"> </div>
	
    <input type="hidden" name="DATECAPTURED" id="DATECAPTURED"  value="<?php echo date('y-m-d'); ?>">
    
    <?php 
					$d=mysqli_query($conn,"select * from disc order by id desc limit 1");
					$drow=mysqli_fetch_array($d);
				?>
     <input type="hidden" name="discount" id="discount" value="<?php echo $drow['disc']; ?>"  > 
    <br>
