...
.progress{
  ...
  <div id="content-header" style="margin-top: 0px;">
   <div id="breadcrumb"> <a href="../fuel_master.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> 
                          </div> 
  </div> 
 ...
 <div class="col-sm-1">
      ...
      <div class="widget-box">
        <div class="widget-title"><span class="icon"><i class="icon-bookmark"></i></span>
          <h5>Purposes of fuel consumption</h5> 
        </div>
       ...
       <table id="exapurpose" class="table table-tabled table-tabled" style="font-weight:normal; font-size:9px; width:100%;">
        ...
        <tr>   
					 ...
					 <th style="background-color:#ecf0f5; color:#000;font-size:10px;">PURPOSE</th> 
                     <th style="background-color:#ecf0f5; color:#000;font-size:10px;">SOURCE OF FUND</th> 
...
$result = mysqli_query($mysqli, "select * from purposecategory order by Purpose asc");
  
	while($res = mysqli_fetch_array($result)) {
	$shunxpds = $res['PURPOSE']."***".$res['purposeid'];
		echo "<tr>"; 
		echo "<td>".$res['purposeid']."</td>";
		echo "<td>".$res['PURPOSE']."</td>"; 
		echo "<td>".$res['SOURCEOFFUND']."</td>"; 
		 echo '<td>  
		        <a id="1881__'.$shunxpds.'" href="javascript:void(0)" onclick="getshunxpd(this.id)" data-toggle="tooltip" title="Update" 
				style="color: #fff;border-radius: 6px; height: 17px; width:100%;" <button class="btn btn-primary">Edit info </span></a>    
               </td>';   	
	}
