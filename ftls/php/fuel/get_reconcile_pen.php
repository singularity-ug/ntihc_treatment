...
.progress{
 ...
 <div class="col-sm-1">
      ...
      <div class="widget-box" style=" background-color:#fff;">
        ...
        <a href="../fleet_administrator.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> &nbsp;
        <a href="get_rec_history.php" title="Go to Home" class="tip-bottom"><i class="icon-fast-forward"></i> Data</a>
         </i></span>
