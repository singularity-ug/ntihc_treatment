       ...
       <ul class="site-stats">
	    ...
	    <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
		 ...
		 <td style="width:46%; border: 0px; background-color:transparent;"> <a href="#myModalfuel" data-toggle="modal" class="">
			...
			border: 0px; padding: 2px 3px;"><small>Fleet&nbsp;mgr</small></button> </a>
          </div>  
	      </td>  
...
<div id="content" style="background:#f9f9e9;" />
...
?>     
                ...
                <li class="bg_ly"> <i class="icon-repeat"></i> <strong style="color:#fff;font-size:12px;"> 
                Quick
...
$result = mysqli_query($mysqli, "select * from purchase where Approval ='Reviewed' AND Loadreview ='Pending' AND Toaccount='$rm' order by date desc");
      ...
      <div class="span4">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-eye-open"></i> </span>
            <h5>Fleet reservation trends</h5>
          </div>
 ...
 <div id="mybooking" class="modal hide">
          ...
          <div class="accordion-group widget-box">
            <div class="accordion-heading">
              <div class="widget-title"> <a data-parent="#collapse-group" href="#collapseGThreecaro" data-toggle="collapse"> <span class="icon"><i class="icon-eye-open">
			  </i></span>
                <h5> </h5>
                </a> </div>
            </div>
  ...
  <?php
    ...
    ?>
             ...
             <div id="myModalfuel" class="modal hide">
              <div class="modal-header">
                <button data-dismiss="modal" class="close" type="button">×</button>
                <h3><b>Welcome:</b>&nbsp; <?php  echo $nameofuser; ?>
                &nbsp;&nbsp;<span>&nbsp; </span>
                </h3>
              </div>
              <div class="modal-body"> 
                    ...
                    <p style="text-align:center;">  Please confirm your password to login as an administrator</p> 
                      ...
                      <input type="password" class="form-control" style="height:25px;" placeholder="Password" name="pwd" required="" autocomplete="off" value=""> 

                     <input type="text" class="form-control" style="height:25px;" placeholder="Username"  
                      name="username" value="<?php  echo $rm; ?>" autocomplete="off"> 
