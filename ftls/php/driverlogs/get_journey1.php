...
function domeexck(ths){
  ...
  success: function(result){
    ...
    <tr> 
        ...
        <th style="width:70%; text-align:left;border:0px;"> <input type="text" id="text" name="timeout" required="" value=" <?php  echo $timeout; ?>"
        placeholder="h:m" style="width:100%; font-weight:normal; background-color:#fff; text-align:left; border:1px solid green; "> </th> 
    </tr>   </table>
