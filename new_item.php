                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="">ITEMS MANAGEMENT</a></li>
                                    <li><a href="">Back</a></li>
                                    <li class='dropdown '>
...
<div class="row">
    <div class="col-lg-127" style="height:600px; margin-left:4px;">
	<div class="box">
     
      <!-- Tabs --> 
<h2 class="demoHeaders">List of items by category</h2> 
<div id="tabs" style="width:1309px;">
	<ul>
