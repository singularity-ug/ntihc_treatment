...
<div class="icons"><i class="icon-th"></i></div> 
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="sys_admin.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; text-align:left;"><i class="icon-lock icon-white"></i>Home</a></li>
                                    <li class='dropdown '>
 ...
 <div class="col-sm-6" >
				<div class="thumbnail"  style="background-color: #fb455f;border-radius:11px;">
                 <a href=<button data-toggle="modal"  data-target="#uiModal1" </button  >   
				 <img src="database icons/sytemadmin.jpg" width="80" height="140" class="img-circle" >
                 <p style="color:#000; font-weight:bold;text-align:center; font-size:13px; color:#ffffff;">Users</p>
                 </div>
                 
				<div class="thumbnail" style="background-color: #8bcf3f; border-radius:11px;">
	            <a href=<button  data-toggle="modal"  data-target="#uiModal2 " </button > 
                <img src="database icons/sytemadmin.jpg" width="80" height="140" class="img-circle" >
				<!-- /thumbnail -->
                <p style="color:#000; font-weight:bold;text-align:center; font-size:13px;">Config</p>
                </div> 
                ...
                <img src="database icons/sytemadmin.jpg" width="80" height="140" class="img-circle" >
				<!-- /thumbnail -->
                <p style="color:#000; font-weight:bold;text-align:center; font-size:13px;">.</p>
                </div> </div>
                 

     <div class="col-sm-6">
	 <div class="thumbnail" style="background-color: #f4cb55; border-radius:11px;">
	 <a href=<button data-toggle="modal"  data-target="#newReg7" </button >
     <img src="database icons/sytemadmin.jpg" width="80" height="140" class="img-circle" >
				 <p style="color:#000; font-weight:bold;text-align:center; font-size:13px; color:#ffffff;">Clients mgt</p> 
                 <!-- /thumbnail -->
                </div>
      ...
      <div class="col-sm-5" style=" border-radius:11px; height:auto; background-color:#fffff; "> 
       <div class="col-sm-4">
        <div class="dash-unit">  
                <h1>Active users</h1> 
				<div class="thumbnail"> 
                <div id="stat_div" style="font-size:124px;"> <?php echo $total_visitors;?>
				</div><!-- /thumbnail --> 
				<br>
					<div class="info-user">  
                   <a href="client_management.php"><i class="li_settings fs1"></i> </a> 
					</div>
				</div></div>
                </div>
        ...
        <div class="dash-unit"> 
		     <h1>Online users</h1> 
				<div class="thumbnail"> 
                <div id="stat_div" style="font-size:124px;"> <?php echo $total_online_visitors;?>
				</div><!-- /thumbnail --> 
				<br>
					<div class="info-user">  
                   <a href="client_management.php"><i class="li_settings fs1"></i> </a> 
         ...
         <div class="col-sm-4"> 
      		<div class="dash-unit">   
		  		   <h1>Registered</h1> 
				<div class="thumbnail"> 
                <div id="stat_div" style="font-size:124px;"> 
				<?php
...
if ($result = mysqli_query($link, "SELECT id, Name FROM sys_users")) {
...
?>
      ...
      background:url(database%20icons/syspanel.png); background-repeat:repeat-x; margin-left:-38px;">
                                        <div class="item active"> 
                                     <div class="col-sm-10 col-md-offset-1"> 
                                   <h4><i class=""><img src="database icons/access-administrator-account.jpg" width="50" height="60"></i> ....<i class=""></i></h4>                                           <p style="color:#000000; text-align:center; font-weight:bold; font-size:36px; margin-top:-35px;">0 </p>
                    ...
                    <h4><i class=" "><img src="database icons/access-administrator-account.jpg" width="50" height="60"></i> .... <i class=" "></i></h4>                                       <p style="color:#000000; text-align:center; font-weight:bold; font-size:36px; margin-top:-35px;">0 </p>
                                        ...
                                        <h4><i class=" "><img src="database icons/access-administrator-account.jpg" width="50" height="60"></i>......<i class=" "></i></h4>
       ...
       <div class="progress progress-striped active">
		...
		Number of users by authentication levels<span class="sr-only">60% Complete</span>
		</div>
	    </div>  
...
$sql = "SELECT COUNT(id), Type FROM sys_users GROUP BY Type ORDER BY COUNT(id) DESC ";
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br>  
  ...
  <ul class="nav nav-tabs">
                                <li class="active"><a href="#home" data-toggle="tab">Manage aunthentication levels</a>
                                </li>
                                <li><a href="#profile" data-toggle="tab">Register</a>
                                </li>
...
$result = mysqli_query($mysqli, "SELECT * FROM sys_users ORDER BY id DESC");
	...
	$dts = $res['id']."***".$res['Name']."***".$res['Phonecontact']."***".$res['Username']."***".$res['Type']."***".$res['Description']."***".$res['Authorised']    ."***".$res['Dept']."***".$res['Healthcenter'];
		...
		echo '<td><a id="'.$dts.'" href="javascript:void(0);"   onclick="referpat1(this.id)">Switch User</a> </td>'; 
...
<p style="font-weight:bold; text-align:left;">REGISTRATION DESK RECORDS BY CURRENT DATE</p>
...
$result = mysqli_query($mysqli, "SELECT * FROM cmpatientsregistration WHERE TIMESTAMP >='$date' AND OUTSVSTATUS ='NO' ORDER BY RID DESC");
	...
	$dts = $res['RID']."***".$res['NTIHCNO']."***".$res['SERVICETYPE']."***".$res['VISTTYPE'];
		...
		echo '<td><a id="'.$dts.'" href="javascript:void(0);"   onclick="regnrecords(this.id)">Edit</a> </td>';
