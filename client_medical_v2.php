   ...
   <div class="col-md-3" style=" background-color:transparent;">  
    <ul class="nav nav-tabs" style="border: 0px;"> 
	 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
		<thead> 
		<tr>  
      <td style="width:25%; border: 0px; background-color:transparent;">  <a data-toggle="tab" href="#tab1">
       <center><img src="database icons/queue-512.png"width="100" height="100" class=" " style=" height:30px; width:30px; background-color:transparent"> <br>
        <a href="client_management.php">Medical <b class="data-taggle" class="tooltip" title="No. of clients due for medical services">
		&nbsp;
<?php
...
?>
		...
		<td style="width:25%;border:0px ; background-color:transparent;"> 
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM cmpatientsregistration WHERE SERVICETYPE ='OTHER SERVICES' AND INSVCSTATUS ='NO' GROUP BY NTIHCNO
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM clientsexamination WHERE TIMESTAMP >='$date' GROUP BY NTIHCNO ORDER BY DATECREATED")) {
...
?> 
 <center></a> 
     ...
     <a data-toggle="tab" href="#tab4">
       <center><img src="assets/imgx/indexreewss.png"width="100" height="100" class=" " style=" height:30px; width:30px; background-color:transparent"> <br> 
         Edit center &nbsp;
		   <?php
$link = mysqli_connect("localhost", "root", "toor2", "patientmgt");
...
$result = mysqli_query($mysqli, "SELECT * FROM  clientsexamination WHERE TIMESTAMP >='$date' GROUP BY NTIHCNO ORDER BY DATECREATED");
    ...
    ?>
		...
		<thead> 
		<tr> 
             <th style="width:39%; text-align:left; border:0px;">  <strong>Clients&nbsp;due&nbsp;for medical&nbsp;services</strong></th>
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM cmpatientsregistration WHERE TIMESTAMP >='$date' AND SERVICETYPE ='MEDICAL SERVICES' AND INSVCSTATUS ='NO' GROUP BY NTIHCNO
                                ORDER BY NTIHCNO DESC")) {
...
?>  
			 ...
			 <th style="width:39%; text-align:left; border:0px;"><strong>No.&nbsp;clients&nbsp;served by <?php echo $nameofuser; ?></strong>  </th>
			 <th style="width:10%; text-align:left; border:0px;">  
			 <b style="text-align:center; font-size:40px;font-size: 15px;border-radius: 11px;" class="button 5">
			  <?php
$link = mysqli_connect("localhost", "root", "toor2", "patientmgt");
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM clientsexamination WHERE TIMESTAMP >='$date' 
...
?>  
          ...
          <div class="col-md-6" style=" background-color:transparent;">  
			  ...
			  Clients Management - Treatment Room</center><br>
		  ...
		  var ddt = jose.split("__")[1];
		      postclient(ddt);
                ...
                <form class="form-horizontal" action="treatmentroom_process.php" method="post" style="height:auto;"/>  
          ...
          <tr> 
				...
				<th style="width:24%;border:0px;"> <input type="text"  name="DATECREATED" id="DATECREATED" value="<?php echo date('d-m-y'); ?>"
				required="required" style="width:100%; font-weight:normal; background-color:transparent;">  </th>

                 <th style="width:2%; text-align:left; border:0px;">  </th>
				 <?php include('client_medical_vb.js'); ?> 

	            <th style="width:20%;border:0px;">Vist by </th>
				<th style="width:29%;border:0px;"> <select  name="VISTBY" id="cboOptions" onChange="showDiv('div',this)"
         ...
         <th style="width:25%; text-align:left; border:0px;color:#d70000;">Specify</th>
                 <th style="width:75%; text-align:left;border:0px;">
           <select  name="ESCORTEDBY" id="ESCORTEDBY" style="text-transform: uppercase; width:100%; background-color:transparent;width:100%;" />
		   <option></option>
	     ...
	     <div class="col-sm-6" style=" background-color:transparent;">   
          ...
          <thead> 
          <tr> 
			    <th style="width:25%;border:0px;">Problem category </th>
				<th style="width:75%;border:0px;"> <select  name="EXAMPICKERDESC" id="cboOptions" onChange="showDiv2('div',this)"
				required="required" style="width:100%; font-weight:normal; background-color:transparent;">
   ...
   <th>DESCRIPTION</th>
      ...
      <tbody>
	   ...
	   <div class="col-sm-6" style=" background-color:transparent;">  
		...
		<thead> 
		<tr> 
			    <th style="width:25%;border:0px;background-color:transparent;">Problem brief</th>
				<th style="width:75%;border:0px;">
          <textarea name="PROBLEMBRIEF" required="required"  style="width:100%; font-weight:normal; background-color:transparent;">
          </textarea>
         </th>
         </tr>
	     </table>
		...
		<thead>  
            ...
            <td style="border:0px;width:25%;background-color:transparent;">Urgency</td>
            <td  style="border:0px;width:75%;">  <input type="radio" name="URGENCYTYPE" id="URGENCYTYPE" value="NORMAL" checked>
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		...
		<tr>  
			<?php include('client_medical_cd.js'); ?> 
	            ...
	            <th style="width:25%;border:0px;">Counselling done</th>
				<th style="width:75%;border:0px;"> <select  name="COUNSELLINGDONE" id="cboOptions" onChange="showDiv3('div',this)"
				required="required" style="width:100%; font-weight:normal; background-color:transparent;">
	   ...
	   <p></p>
             ...
             <thead> 
             <tr> 
			    <th style="width:25%;border:0px; color:blue;">Specify</th>
				<th style="width:75%;border:0px;"> <input type="text"  name="COUNSELLINGGIVEN" 
	  ...
	  <div class="col-sm-6" style=" background-color:transparent;"> 
	     <hr style="margin-top:8px; margin-bottom:8px;"> <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		<thead> 
		<tr>  
			    <?php include('client_medical_hc.js'); ?> 

	            <th style="width:25%;border:0px;">Is HCG required?</th>
				<th style="width:75%;border:0px;"> <select  name="HCGSTATUS" id="cboOptions" onChange="showDiv4('div',this)"
				required="required" style="width:100%; font-weight:normal; background-color:transparent;">
		...
		<thead> 
		<tr>
		 <th style="width:25%;border:0px;color:blue;">Add results?</th>
				<th style="width:75%;border:0px;"> <select  name="HCGRESULTS" id="cboOptions" onChange="showDiv5('div',this)"
				 style="width:100%; font-weight:normal; background-color:transparent;">
				                                   <option value="5"> </option>
												   <option value="NEGATIVE">NEGATIVE</option> 
                                                   <option value="POSITIVE">POSITIVE</option> 
                                                   </select>Applicable to females only
		     </th>  
		  </tr>
       </tbody>
      </table>
		...
		<thead> 
		<tr>
		 <th style="width:25%;border:0px;color:green;">Justify </th>
				<th style="width:75%;border:0px;"> <select  name="HCGPOSITIVE" id="HCGPOSITIVE"
				 style="width:100%; font-weight:normal; background-color:transparent;">
				                                   <option> </option>
	   ...
	   <hr style="margin-top:8px; margin-bottom:8px;"> <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		...
		<tr>  
			<?php include('client_medical_rf.js'); ?> 
	            ...
	            <th style="width:25%;border:0px;">Activate REFERRAL</th>
				<th style="width:75%;border:0px;"> <select  name="REFTUNER" id="cboOptions" onChange="showDiv6('div',this)"
				style="width:100%; font-weight:normal; background-color:transparent;">
		...
		<thead> 
		<tr> 
			  <td style="width:25%;border:0px;color:blue; ">Referral centre </td>
		...
		<thead> 
		<tr> 
			  <td style="width:25%;border:0px; background-color:transparent;">Service referred </td>
			  <td style="width:75%;border:0px;">
	  ...
	  <div class="col-sm-6" style=" background-color:transparent;"> 
		...
		<tr> <?php include('client_medical_fu.js'); ?> 
			    <td style="width:25%;border:0px; background-color:transparent;">Is follow up required?.</td>
				<td style="width:75%;border:0px;">
				<select name="FOLLOWUP" id="cboOptions" onChange="showDiv7('div',this)" style="width:100%; font-weight:normal; background-color:transparent;">
		...
		<thead> 
		<tr> 
			  <td style="width:25%;border:0px; background-color:transparent;">Follow up date </td>
			  <td style="width:75%;border:0px;"> <input type="date" name="FOLLOWUPDATE" id="FOLLOWUPDATE" style="width:100%; background-color:transparent;"></td>
              </tr>
			  </table>
		</div>
		...
		<thead> 
		<tr> 
			  <td style="width:25%;border:0px;">Action taken </td>
			  <td style="width:75%;border:0px;"> 
              <Select name="ACTIONTAKEN" id="ACTIONTAKEN" required="required" style="width:100%; font-weight:normal; background-color:transparent;">
		       ...
		       <thead> 
		       <tr> 
			  <td style="width:25%;border:0px; background-color:transparent;"><b>Other</b> services </td>
		...
		<thead> 
		<tr> 
			    <td style="width:25%;border:0px; ">Service status </td>
				<td style="width:75%;border:0px;">
	   ...
	   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		...
		<tr> 
            ...
            <td style="color:blue;width:42%;"><b>Make a Lab request</b> </td>
            <td style="border:0px; width:58%;">  <select name="TROOM_INITIATION" id="cboOptions" onChange="showDiv8('div',this)" required="" class="button 5"
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM laboratory WHERE TIMESTAMP >='$date' AND TESTSTATUS ='NOT STARTED' 
				                        AND REQUESTINGUNIT ='TREATMENT ROOM' AND USERINITIAL ='$nameofuser' GROUP BY NTIHCNO
				                        ORDER BY NTIHCNO DESC")) {   
    $row_cnt = mysqli_num_rows($result); 
    printf("%d  \n", $row_cnt); 
    mysqli_free_result($result);
...
if ($result = mysqli_query($link, "SELECT * FROM cmpatientsregistration WHERE TIMESTAMP >='$date' 
																	   ...
																	   AND USERINITIAL ='$nameofuser'
																	   AND ONC_ACTIONTAKEN = 'NULL' GROUP BY NTIHCNO")) {   
    $row_cnt = mysqli_num_rows($result); 
    printf("%d  \n", $row_cnt); 
    mysqli_free_result($result);
} 
...
?> 
    ...
    <thead>  
    <tr>  
        <td style="width:25%;border:0px;background-color:transparent;">User initials </td>
        <td style="width:75%;border:0px;">  <input type="text" name="USERINITIAL" id="USERINITIAL" value="<?php echo $nameofuser; ?>"  
    ...
    <thead>  
    <tr>  
        <td style="width:25%;border:0px;background-color:transparent;">Service provider </td>
        <td style="width:75%;border:0px;"> <Select id="SERVICEPROVIDER" name="SERVICEPROVIDER" required="required" 
        style="width:100%; font-weight:normal; background-color:transparent;">
                                              <option> </option>
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM cmpatientsregistration WHERE TIMESTAMP >='$date' AND SERVICEEXTENTION = 'TREATMENT ROOM' 
                                AND SERVICEEXTENTIONSTATUS ='NULL' GROUP BY NTIHCNO
                                ORDER BY NTIHCNO DESC")) {
 ...
 <center></a> 
	...
	<td style="width:33.333333%;border:0px ; background-color:transparent;"> 
	 <a data-toggle="tab" href="#tab3a">
          <center><img src="database icons/images.jpg"width="100" height="100" class=" " style=" height:30px; width:30px; background-color:transparent"> <br>
           Outreach
		   <?php
$link = mysqli_connect("localhost", "root", "toor2", "patientmgt");
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM cmpatientsregistration WHERE SERVICETYPE ='OUTREACH' AND INSVCSTATUS ='NO' GROUP BY NTIHCNO
                                ORDER BY NTIHCNO DESC")) {
...
?>  
		...
		<thead> 
		<tr> 
             <th style="width:39%; text-align:left; border:0px;">  <strong>Pending&nbsp;lab requests&nbsp;&nbsp;(All)</strong></th>
			 <th style="width:10%; text-align:left; border:0px;">   
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT * FROM laboratory WHERE TIMESTAMP >='$date' AND TESTSTATUS ='NOT STARTED' AND REQUESTINGUNIT ='TREATMENT ROOM' GROUP BY NTIHCNO
                                ORDER BY NTIHCNO DESC")) {
...
?>  
			 ...
			 <th style="width:2%; text-align:left; border:0px;">  </th>
			 <th style="width:39%; text-align:left; border:0px;"><strong>Completed&nbsp;lab orders&nbsp;(All) </strong>  </th>
			 <th style="width:10%; text-align:left; border:0px;">  
...
?>  
            ...
            <div id="scrollable-content" style="background-color:transparent;">
            <ul>
                               <div class=""  id="labresultsxtn" style="margin-left: -41px;">
...
#footer {
  height: 0px;
            ...
            <div id="tab2a" class="tab-pane"> 
				 <table id="exampleoutex" class="table table-tabled table-bordered" style="font-weight:normal; font-size:9px; width:100%; background-color:transparent;">
        <thead>
        <tr>   
...
$result = mysqli_query($mysqli, "SELECT * FROM  cmpatientsregistration WHERE TIMESTAMP >='$date' 
                                                                       ...
                                                                       AND SERVICEEXTENTION = 'TREATMENT ROOM' 
    ...
    ?>
            ...
            <div id="tab3a" class="tab-pane">
             <table id="exampleout" class="table table-tabled table-bordered" style="font-weight:normal; font-size:9px; width:100%; background-color:transparent;">
        <thead>
        <tr>   
...
<table class="table table-tabled table-bordered" style="background-color:transparent; margin-top:0px; ">
   ...
   <td style="border:2px solid #ecf0f5;">If pregnant EDD/<B>em</B> TCT? write gestation in weeks and ANC # </th> 
   ...
   <td style="border:2px solid #ecf0f5;">Refer or consult or link/provide (including nutritional support and infant feeding)  </th>
  <td style="border:2px solid #ecf0f5;">Pill counting</th>
   ...
   <td style="border:2px solid #ecf0f5;">  Age in months if <=2 yrs</th> 
   <td style="border:2px solid #ecf0f5;"> </th>
   <td style="border:2px solid #ecf0f5;"> </th>
   <td style="border:2px solid #ecf0f5;"> </th> 
   <td style="border:2px solid #ecf0f5;">  </th>
