...
function domeexck(ths){
  ...
  success: function(result){
    ...
    $("#res").html(result);
		 ...
		 <form class="form-horizontal" action="booking/update_travel2.php" method="POST" style="height:auto;">
        ...
        <th style="width:70%; text-align:left;border:0px;"><input type="date" id="journeypoint_start" name="journeypoint_start" value="<?php  echo $journeypoint_start; ?>"
        ...
        <th style="width:70%; text-align:left;border:0px;"> <input type="date" id="Reservationdate_from" name="Reservationdate_from" value=" <?php  echo $Reservationdate_from; ?>"
				required="required" style="width:100%; font-weight:normal; background-color:#fff; "> </th> 
		</tr>   </table>
        ...
        <th style="width:70%; text-align:left;border:0px;"> <input type="time" id="timeout" name="timeout" required="" value=" <?php  echo $timeout; ?>"
        ...
        <th style="width:70%; text-align:left;border:0px;"><input type="date" id="Destination_to" name="Destination_to" value="<?php  echo $Destination_to; ?> "
				required="required" style="width:100%; font-weight:normal; background-color:#fff; ">  </th> 
		</tr>   </table>
		...
		style="width:100%; font-weight:normal; background-color:#fff; "> </th> 
		  ...
		  <input type="hidden" name1="distancecovered[]" id="distancecovered" name="distancecovered" 
		...
		<input type="hidden" id="Servicedate" name="Servicedate" value="<?php echo date('y-m-d'); ?>" />
		  ...
		  <label>Dear&nbsp;<b style="color:blue;"><?php  echo $applicantname; ?></b>&nbsp;:Thank you for supporting <b style="color:green;"><?php  echo $Drivername; ?></b> </label>
          </form>  
        </div> 
