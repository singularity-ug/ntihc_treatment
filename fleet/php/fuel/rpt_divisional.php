...
<div class="panel-body">
	...
	<tbody> 
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT FUELISSUANCEDATE, Fiscalmonth,
	...
	<thead>
		<tr>
			<th colspan="2" style="border-top:1px solid #999999">Amount after discount  </th> 
...
<?php   
 $from_date = "$d1";
 $to_date = "$d2";
  $strQuery = "  SELECT SUM(TOTALAMOUNT), DIVISION  
									             FROM fuellogs WHERE FUELISSUANCEDATE >= '" . $from_date . "' AND FUELISSUANCEDATE <= '" . $to_date . "' 
