...
?> 
                  <!-- Info boxes --> 
    <br>
   <form action="cordination_monthly.php" method="get">
<center><strong>
...
<img src="../../img/logsbig.png" width="100%" height="30%">
 Transport cordination report from&nbsp;<?php echo $_GET['d1'] ?>&nbsp;to&nbsp;<?php echo $_GET['d2'] ?>   
...
<div class="panel-body">
	...
	<tbody> 
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT Allocationdate, fiscalmonth, Sum(Ratedas) as moll,
				                                                sum( if( Allocationstatus = 'Allocated', Ratedas, 0 ) ) AS Allocated,   
                                                                sum( if( Allocationstatus = 'Rejected', Ratedas, 0 ) ) AS Rejected 
				                                                FROM ftlvehiclebooking WHERE  Allocationdate BETWEEN :a AND :b GROUP by fiscalmonth DESC ");
