      ...
      <div class="widget-box"> 
        ...
        <table id="example3" class="table table-table-bordered" style="font-size:9px; width:100%;">
         ...
         <tr>   
                     ...
                     <th style="background-color:#ecf0f5; font-size:10px; ">DIVISION</th> 
                     <th style="background-color:#ecf0f5; font-size:10px; ">DIRECTORATE</th> 
...
$x=$x+1;
 ...
 ?>
  ...
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;" width="100%"> 
		<thead> 
		<tr> 
               <th style="width:50%; text-align:left; border:0px;background-color:#fff; text-align:right; font-size:20px;">  </th>
               <th style="width:20%; text-align:left; border:1px solid;background-color:#fff; text-align:right; font-size:20px;">Closing balance </th>
               <td style="width:30%;border:1px solid;background-color:#fff; text-align:right;font-size:20px;"> <?php echo"".$bal; ?> </td>  
			</tr>             
            </table>         
