        ...
        <div class="widget-title bg_lg"><span class="icon"><i class=""></i>
         <a href="../dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-fast-backward"></i> Dasboard </a>
          ...
          <h5>  &nbsp;<a href="../fuel_authorise.php" title="Go to Home" class="tip-bottom"><i class="icon-backward"></i> Home </a>
           &nbsp;
         <a href="my_fuel_authorization.php" title="History" class="tip-bottom"><i class="icon-share"></i> Requisition tracker </a></h5>
        </div>
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE AUTHORIZATIONSTATUS ='AUTHORISED' AND SENDTO = '$rm' GROUP BY SERIALNO ORDER BY DATECREATED DESC");
