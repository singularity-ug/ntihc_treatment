    ...
    <div class="row-fluid"> 
      <div class="widget-box"> 
        ...
        <a href="../fuel_datacenter.php" title="Home" class="tip-bottom"><i class="icon-home"></i> Home</a>&nbsp;
          ...
          <h5>  
           <a href="fuel_addin.php" <i class="icon-home"></i>Back</a> 
           &nbsp;
        ...
        <div class="widget-content" style="background-color:#fff;">
		  ...
		  var odno = ((jose.split("__")[1]).split("***"))[1];
            ...
            <strong style="font-size:15px; font-family:algerian;"><center> My fuel data capture as of <?php echo date('y-m-d'); ?></center></strong>
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE APPROVALSTATUS ='APPROVED' AND REVIEWFUEL = 'REVIEWED' 
			                                            AND  FUELISSUANCESTATUS = 'ISSUED' AND ISSUERACCOUNT = '$rm'
													    AND DATECAPTURED = '$date' ORDER BY FUELISSUANCEDATE DESC");
