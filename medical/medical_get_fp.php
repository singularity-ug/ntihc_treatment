 ...
 if($res){}
  ...
  <table id="example3" class="table table-table-bordered" style="font-weight:normal; font-size:9px; width:100%;">
   ...
   <th style="">SERVICE PROVIDER</th>
             ...
             $result = mysqli_query($mysqli, "SELECT * FROM family_planning  WHERE `NTIHCNO` = '$id'");
             ...
             $dts = $res['NTIHCNO']."***".$res['id'];
              ...
              echo "<td>".$res['BP']."</td>"; 
			  echo "<td>".$res['WT']."</td>";
              echo "<td>".$res['GSPGSN']."</td>";  
	          echo "<td>".$res['FPCOMMENTS']."</td>";
              echo "<td>".$res['FAMILYPLANNINGMETHOD']."</td>";
              echo "<td>".$res['QUANTITY']."</td>"; 
			  echo "<td>".$res['RETURNDATE']."</td>"; 
              echo "<td>".$res['USERINITIAL']."</td>";   
			  echo '<td>  
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
              <a id="3__'.$dts.'" href="javascript:void(0)" onclick="hagyx(this.id)" data-toggle="tooltip" title="Update"
