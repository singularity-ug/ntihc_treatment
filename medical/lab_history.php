...
<body class="hold-transition skin-blue sidebar-mini" style="background-color:transparent;">  
        ...
        <td style="width:50%; border: 0px;background-color:transparent;">
		  <div class="small-box bg-grey-gradient" style="background-color:transparent;">
		  <a href="#tab_1-1" data-toggle="tab" style="background-color:transparent;">
          <center><img src="../../databaseicons/guests.jpg"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969; height:50px; width:50px;"> 
          HCT&nbsp;results&nbsp;  </center></a> 
		  </div> 
		  </td>
		  ...
		  <a href="#tab_2-2" data-toggle="tab">
           <img src="../../databaseicons/icon-resources-staffing.png"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969;height:50px; width:50px;" > 
           HCT&nbsp;history&nbsp;&nbsp; </a> </td>  
           </tbody>
           </table>
		   </div> 
        ...
        <td style="width:50%; border: 0px;">
		  <div class="small-box bg-grey-gradient">
		  <a href="#tab_3-3A" data-toggle="tab">
          <center><img src="../../databaseicons/approve2.png"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969; height:50px; width:50px;"> 
          ...
          <td style="width:50%; border: 0px;">
          <div class="small-box bg-grey-gradient">
		  <a href="#tab_3-3B" data-toggle="tab">
           <img src="../../databaseicons/exchange-512.png"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969;height:50px; width:50px;" > 
        ...
        <td style="width:50%; border: 0px;">  
           ...
           <img src="../../databaseicons/delete4.jpg"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969;height:50px; width:50px;" > 
		...
		<thead> 
		<tr>  
        <td style="width:35%; border: 0px;">Request date</td>
   
        <td style="width:65%;border:0px;"> <?php echo $arow['TIMESTAMP']; ?> </td>  
           </tbody>
           </table>
		    <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
		<thead> 
		<tr>  
        <td style="width:35%; border: 0px;">HCT date</td>
   
        <td style="width:65%;border:0px;"> <?php echo $arow['RECIEVEDDATE']; ?> </td>  
           </tbody>
           </table>   
	    <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
		<thead> 
		<tr>  
        <td style="width:35%; border: 0px;">Client number</td>
   
        <td style="width:65%;border:0px;"> <?php echo $arow['NTIHCNO']; ?> </td>  
           </tbody>
           </table>
		<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
		<thead> 
		<tr>  
        <td style="width:35%; border: 0px;">Client name</td>
		...
		<tr> 
         ...
         <th></th>
         <th><center>HIV Test 1</center></th>
         <th><center>HIV Test 2</center></th>
         <th><center>HIV Test 3</center></th>
         </thead>

         <thead>
         <th>Kit name</th>
         <th><center>Determine</center></th>
         <th><center>Start Pack</center></th>
         <th><center>Unigold</center></th>
         </thead>
    <tbody>
      <tr>
        <th>Lot No.</th>
        ...
        <td ><center>3</center></td>
         ...
         <tr>
         <th >Expiry date</th>
        <td ><center> <?php  echo $EXPIRYDATET1; ?> </center> </td>
        <td ><center> <?php  echo $EXPIRYDATET2; ?> </center> </td>
        <td ><center> <?php  echo $EXPIRYDATET3; ?> </center></td>
     </tr>
    <tr>

    <tr>
        <th>Reactivity</th>
        <td> <center> <?php  echo $REACTIVITYT1; ?> </center> </td>
        <td> <center> <?php  echo $REACTIVITYT2; ?> </center> </td>
        <td> <center> <?php  echo $REACTIVITYT3; ?> </center> </td> 
    </tr>
    </tbody>
    </table>
	 </div>
	...
	<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
		<thead> 
		<tr>
				<th style="border:0px;">Final reactivity</th>
				<th style="border:0px;"><b style="font-size:35px; font-weight:normal;font-family:lcd;"><?php  echo $FINALREACTIVITY; ?>
				 </b>  </th>  
				</tr>
			    </table>
		...
		<tr>
									...
									<?php
										$total=0;
										$total2=0;
										$s=mysqli_query($conn,"select * from laboratory where NTIHCNO='$id' AND TESTSTATUS='POST TEST COUNSELLING DONE'");
										while($srow=mysqli_fetch_array($s)){
											?>
											<tr>
                                            <td><?php echo $srow['TIMESTAMP']; ?></td>
                                            <td><?php echo $srow['RECIEVEDDATE']; ?></td> 
											
											<td><?php echo $srow['NAME']; ?></td>
                                            <td><?php echo $srow['NTIHCNO']; ?></td>
											 
											<td><?php echo $srow['TESTDESCRIPTION']; ?></td>
											 
											<td><?php echo $srow['COUNSELORSNAME']; ?></td>
											<td><?php echo $srow['TESTSTATUS']; ?></td>
                                            <td><?php echo $srow['FINALREACTIVITY']; ?></td> 
                                             <td class="hidden">
													<?php 
									...
									?>
									<tr>
										<td colspan="7" align="left"><strong>TOTAL VISTS</strong></td>
              ...
              <!-- /.tab-pane -->
      <div class="tab-pane" id="tab_3-3A" style="background-color:transparent;"> 
...
<form  class="form-horizontal" action="anc_artprocesor.php" method="POST" style="height:auto; font-weight:normal;"> 
 ...
 $res = $conn->query($sql); 
  ...
  <tr>
		...
		<center> <input type="image" name="submit" id="button" src="../../databaseicons/switchb1.png" width="50" height="50" 
				data-toggle="tooltip" title="Save art episode"></center> 
				</form> 
			 
			  </div></div>
			 
			  <div class="tab-pane" id="tab_3-3B"> 
			 <center> ART HISTORY</center>
  ...
  <th style="">Pill counting</th>
   ...
   <tbody>
    ...
    <td class="hidden">
        ...
        <td style="width:100%;border:0px;">   <input type="image" name="submit" id="button" src="../../databaseicons/delete5.jpg" width="50" height="45" 
