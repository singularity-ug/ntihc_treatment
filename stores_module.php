    ...
    <section class="content">
     ...
     <!-- Main content -->
      <div class="row">
          ...
          <div class="box box-solid">
            <div class="box-header with-border" style="background-color: #ecf0f5; border:2px solid;border-radius: 11px;">
              <h3 class="box-title">Threshold for procurement of <b style="color:green;"> supplies </b> </h3>
          ...
          <div class="box box-solid">
            <div class="box-header with-border" style="background-color: #ecf0f5; border:2px solid;border-radius: 11px;">
              <h3 class="box-title"> Threshold for<b style="color:green;"> Non consultancy services</b> </h3>
          ...
          <div class="box box-solid">
            <div class="box-header with-border" style="background-color: #ecf0f5; border:2px solid;border-radius: 11px;">
              <h3 class="box-title"> Threshold for procurement of <b style="color:green;">works</b> </h3>
          ...
          <div class="box box-solid">
            <div class="box-header with-border" style="background-color: #ecf0f5; border:2px solid;border-radius: 11px;">
              <h3 class="box-title"> Threshold for <b style="color:green;">consultancy services</b> </h3>
        ...
        <!-- /.col -->  
         ...
         <center> <img src="../database icons/budget.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center></a> 
            <div class="inner">  
            <a href="budget_mgr.php" class="small-box-footer">Orders <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div></div> </li>
        <!-- ./col -->         
         ...
         <div class="col-lg-2 col-xs-4">
          ...
          <div class="small-box bg-grey-gradient">
          <center> <img src="../database icons/admin.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center></a> 
            <div class="inner">  
            <a href="#" class="small-box-footer">Approvals <i class=" "></i></a>
          </div>
        </div></div></li>
        <!-- ./col -->          
      ...
      <div class="col-lg-2 col-xs-4">
          ...
          <div class="small-box bg-grey-gradient">
         <center> <img src="../database icons/admin2.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center></a> 
            <div class="inner">  
            <a href="#" class="small-box-footer">Suppliers   <i class=""></i></a>
          </div>
        </div></div></li>
        <!-- ./col -->
        ...
        <div class="col-lg-2 col-xs-4">
          ...
          <div class="small-box bg-grey-gradient">
         <center> <img src="../database icons/microfinance-product-management-system.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" >
         </center></a> 
            <div class="inner">  
            <a href="#" class="small-box-footer">Contracts <i class=""></i></a>
          </div>
        </div></div></li>
        <!-- ./col -->
        ...
        <div class="col-lg-2 col-xs-4">
          ...
          <div class="small-box bg-grey-gradient">
         <center> <img src="../database icons/syspanel1.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center></a> 
            <div class="inner">  
            <a href="#" class="small-box-footer">Payments <i class=" "></i></a>
          </div>
        </div></div></li>
        <!-- ./col -->
         ...
         <div class="col-lg-2 col-xs-4">
          ...
          <div class="small-box bg-grey-gradient">
         <center> <img src="../database icons/press-nozbe.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center></a> 
            <div class="inner">  
            <a href="#" class="small-box-footer">stores <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div></div></li>
        <!-- ./col -->
                    </div>
...
?>
           ...
           <div class="panel-body">
                    ...
                    <div class="row">
                    <div class="col-lg-12">
                        <div class="modal" id="supreg" tabindex="-1"    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color:red;" >
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
...
<img src="../assets/img/logs.PNG" width="100%" height="100%">
          ...
          <center> <legend style="color:#000; font-weight:bold;font-size:12px;"> Supplier Registration Form </legend> </center>
