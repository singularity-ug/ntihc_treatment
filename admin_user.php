 ...
 <?php
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <li><a href=<button class="fa fa-th" data-toggle="modal"  data-target="#notificationModal" </button> </i>Receipts and invoices</a></li>
     <li><a href=<button class="fa fa-th" data-toggle="modal"  data-target="#notificationModal" </button> </i>Imprest requisition</a></li>
     <li><a href=<button class="fa fa-th" data-toggle="modal"  data-target="#notificationModal "  </button> </i>Travel advance requisition</a></li> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <p>
      <a href="javascript:void(0)"> <B> ADMIN USER DASHBOARD</B>&nbsp;&nbsp;&nbsp TITLE: &nbsp <B style="color:black;"> <?php echo $desc; ?> </B>  </a>  
        <small></small>
      </p>
      <ol class="breadcrumb">
...
mysqli_close($link);
?>   </span></a>  
               <li><a href=<button class="fa fa-envelope-o" data-toggle="modal"  data-target="#notificationModal"></button></i> 
               My travel advance requests<span class="label label-warning pull-right"  data-toggle="tooltip" title="Pending">0</span></a>  
          ...
          <div class="box box-solid">
            ...
            <div class="box-body no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href=<button class="fa fa-circle-o text-red" data-toggle="modal"  data-target="#notificationModalzero"></button></i> procurement requests <span class="label label-warning pull-right"><?php
...
?> </span></a>
        ...
        <div class="col-lg-2 col-xs-4">
         ...
         <center> <img src="../database icons/budget.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner">
             <a href=<button class="small-box-footer" data-toggle="modal"  data-target="#notificationModal"></button>Cash <i class=" ">
            </i></a> 
            <div class="pull-right box-tools">
             ...
             <div class="btn-group">
                  ...
                  <li><a href="pettycash_sup.php" data-toggle="tooltip" title="Confirm"> Authorise imprest rqns &nbsp 
                   <?php
$link = mysqli_connect("localhost", "root", "toor2", "dbmultiple");
...
?>
                  ...
                  <li><a href="pettycash_fin.php" data-toggle="tooltip" title="Approve"> Approve imprest rqns &nbsp;&nbsp;&nbsp 
                   <?php
$link = mysqli_connect("localhost", "root", "toor2", "dbmultiple");
...
?>   
                  ...
                  <li><a href="petty_cash.php" data-toggle="tooltip" title="Verifire"> Cash payment orders &nbsp;&nbsp; &nbsp 
                     <?php
$link = mysqli_connect("localhost", "root", "toor2", "dbmultiple");
...
?>   
                    ...
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="tooltip" title="Approved"> Travel advance orders &nbsp 0 </a></li> 
                    <li class="divider"></li>
                    <li><a href="#" data-toggle="tooltip" title="Sub module"> Receipts and invoices &nbsp; &nbsp 0</a></li>
                  </ul>
                </div></div>
      ...
      <div class="col-lg-2 col-xs-4">
        ...
        <div class="col-lg-2 col-xs-4"> 
          <!-- small box -->
          <div class="small-box bg-grey-gradient">
         <center>  <a href="procurement_module.php" </a> 
         <img src="../database icons/employee.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
             <a href="procurement_module.php" class="small-box-footer">procure <i class=" "></i></a>  
             <div class="pull-right box-tools">
                <!-- button with a dropdown -->
             <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
        ...
        <div class="col-lg-2 col-xs-4">
          <!-- small box --> 
          <div class="small-box bg-grey-gradient">
         <center> <a href="stores_module.php" </a> 
         <img src="../database icons/admin.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
             <a href="stores_module.php" class="small-box-footer">Stores <i class=" "></i></a> 
            <div class="pull-right box-tools">
                <!-- button with a dropdown -->
             <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
                    <i class="fa fa-bars"></i></button>
                  <ul class="dropdown-menu pull-left" role="menu">
                    <li><a href=<button class="small-box-footer" data-toggle="modal"  data-target="#notificationModal"></button> Reports</a></li> 
                    <li class="divider"></li> 
                  </ul>
                </div></div>
          </div>
        ...
        <!-- ./col -->
         ...
         <div class="col-lg-2 col-xs-4"> 
          <!-- small box -->
          <div class="small-box bg-grey-gradient">
         <center> <a href="assets_module.php"</a>
         <img src="../database icons/press-nozbe.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
             ...
             <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-right" role="menu">
                    <li><a href="property_mgt.php">Assets management</a></li> 
                    <li class="divider"></li>
                    <li><a href="#"></a></li>
                  </ul>
                </div>
