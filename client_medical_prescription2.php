...
#footer {
 ...
 $sql  = "SELECT * FROM presctemp
   ...
   ?>
        ...
        <form class="form-horizontal" action="prescription/presc_process.php" method="post" style="height:auto;"/>
        ...
        <thead> <tr> 
          ...
          <thead> 
          <tr> 
                <th style="width:43%;">DRUG DESCRIPTION</th>
				<th style="text-align:center;">BOOK&nbsp;IN</th>
   ...
   <tbody>
   <tr> 
                <th style="border:0px;"> <input type="text" onKeyUp="domee(this)" name="DRUGNAME" id="DRUGNAME" 
				required="required" autocomplete="off" style="width:100%; font-weight:normal; background-color:#fff;"> 
				 </th>   
			     
				 <th style="border:0px;"> <input type="text" class="e" size="4" name="BOOKIN" id="BOOKIN" readonly="readonly" 
				 autocomplete="off" style="width:100%; font-weight:normal;text-align:center; background-color:transparent;"> 
				 </th> 
				 
				 <input type="hidden" class="e" size="4" name="ID" id="ID">
				 
				 <th style="border:0px;"> <input type="text" class="a" size="4" name="FREQUENCY" id="FREQUENCY" autocomplete="off"
				 required="required" style="width:100%; text-align:center; font-weight:normal; background-color:#fff;"> 
				 </th> 
				 
				 <th style="border:0px;"> <input type="text" name="TIMES" id="TIMES" class="qt" size="4" autocomplete="off"
				 required="required" style="width:100%; text-align:center; font-weight:normal; background-color:#fff;">  
				 </th> 
				 
				 <th style="border:0px;"> <input type="text" class="c" size="4" name="PERIOD" id="PERIOD" autocomplete="off"
				 required="required" style="width:100%; text-align:center; font-weight:normal; background-color:#fff;"> 
				 </th> 
				 
				 <th style="border:0px;"> <input type="text" class="t" size="4"
				  name="QTYPRESCRIBED" id="QTYPRESCRIBED" readonly="readonly" autocomplete="off"
				 style="width:100%;text-align:center; font-weight:normal; background-color:transparent;"> 
				 </th> 
				 
				 <th style="border:0px;"> <input type="text" class="h" size="4"
				name="QTYLEFT" id="QTYLEFT" autocomplete="off"
				 readonly="readonly" 
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;"> 
				 </th> 
				 
				 <th style="border:0px;">  
				 <input type="submit" name="button" id="button" value="Book" class="btn btn-success" style="width:100%; border-radius:11px;" /> 
				 </th>  	       				                        
             </tr>
       <hr>
			    <?php
				include('prescription/conn.php');
				$date = date("Y-m-d").' 00:00:00';
				$query=mysqli_query($conn,"select * from `prescription`  
				Where SERVICEPROVIDERACCOUNT ='$rm' 
				AND RESERVATIONSTATUS='CREATED'
				AND TIMESTAMP >='$date'");
				while($row=mysqli_fetch_array($query)){
				?>
					<tr>
						<td style="text-align:left;"><input type="text" value="<?php echo $row['DRUGNAME']; ?>"
						 readonly="readonly" 
				...
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;">
						...
						<td style="text-align:center;"><input type="text" value="<?php echo $row['FREQUENCY']; ?>"
						 readonly="readonly" 
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;"></td>
						<td style="text-align:center;"><input type="text" value="<?php echo $row['TIMES']; ?>"
						 readonly="readonly" 
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;"></td>
						<td style="text-align:center;"><input type="text" value="<?php echo $row['PERIOD']; ?>"
						 readonly="readonly" 
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;"></td>
						<td style="text-align:center;"><input type="text" value="<?php echo $row['QTYPRESCRIBED']; ?>"
						 readonly="readonly" 
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;"></td>
						<td style="text-align:center;"><input type="text" value="<?php echo $row['QTYLEFT']; ?>"
						 readonly="readonly" 
				style="width:100%; font-weight:normal; text-align:center; background-color:transparent;"></td>
						<td style="text-align:center;">
							 
							<a href="#del<?php echo $row['DID']; ?>" data-toggle="modal"><span class="glyphicon glyphicon-trash"></span></a>
							<?php include('prescription/button.php'); ?>
						</td>
					</tr>
					<?php
				}
           ...
           <div id="res" style="border:0px; background-color:transparent;"> </div> 
			    
			  <br>
	    <form class="form-horizontal" action="prescription/presc_sudo_aptdisp.php" method="post" style="height:auto;"/>
				   
        <input type="hidden" id="RSVNID" name="RSVNID"  value="<?php echo $RSVNID; ?>">  
		<input type="hidden" name="RID" id="RID"  value="<?php echo $RID; ?>">  
		<input type="hidden" name="RESERVATIONSTATUS" id="RESERVATIONSTATUS" value="BOOKED">
    ...
    <tr>  
        ...
        <td style="width:60%;border:0px;">  <input type="text"  name="CAPTUREDBY" id="CAPTUREDBY" 
		required="required" value="<?php echo $nameofuser; ?>"  
        style="width:100%; font-weight:normal; background-color:transparent;"> 
       </td>
       </tr>
       </table>  
    ...
    <tr>  
        ...
        <td style="width:60%;border:0px;">  <input type="date"  name="CAPTUREDATE" id="CAPTUREDATE"  
        style="width:100%; font-weight:normal; background-color:transparent;"> 
       </td>
       </tr></thead>
       </table>  
	...
	<div class="panel-body" style="font-weight: normal; width: 100%;   
		  ...
		  <center><input type="submit" name="button" id="button" value="Prescribe now" 
	...
	<div class="panel-body" style="font-weight: normal; width: 100%;   
	    ...
	    <form class="form-horizontal" action="prescription/presc_sudo_nano.php" method="post" style="height:auto;"/>
		  	   
        <input type="hidden" id="RSVNID" name="RSVNID"  value="<?php echo $RSVNID; ?>">  
		<input type="hidden" name="RID" id="RID"  value="<?php echo $RID; ?>">  
		<input type="hidden" name="RESERVATIONSTATUS" id="RESERVATIONSTATUS" value="BOOKED">
		   
		  <center><input type="submit" name="button" id="button" value="Not required" 
		  style="font-size:15px; border-radius:11px;"/> </center> 
