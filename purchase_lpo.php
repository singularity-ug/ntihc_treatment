                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="pdu.php">Dashboard</a></li> 
                                     <li><a href="purchase_req_editor.php">Back to requisition </a></li> 
    ...
    <ul class="stats_box" >
     ...
     <div  class="row text-center contact-info">
         <div class="col-md-push-5 col-md-push-8">
          ...
          <div class="col-xs-pull-7 col-md-push-9" style="width: 500px;">
           </p>
         ...
         <div class="input-group">
          ...
          <div class="input-group"> 
          <input type="text" input name="SERVICEPROVIDER"  id="SERVICEPROVIDER" class="form-control" style="height:28px; width: 775px;"/>
              </div>   
               
          <div class="input-group"> 
          <input type="text"  input name="ENTITYBOXADDRESS" id="ENTITYBOXADDRESS" class="form-control" style="height:28px; width: 306px;"/>
              </div>     
              
              <div class="input-group"> 
              <input type="text" input name="ENTITYLOCATION"  id="ENTITYLOCATION" class="form-control" style="height:28px; width: 306px;"/>
              </div>  
              <br>  
               ...
               <div class="input-group">
               <span class="input-group-addon" style="width:124px; background-color:#FFF;text-align:left;">Purchase type</span>
               <input type="text" class="form-control" id="PURCHASETYPE" input name="PURCHASETYPE"  style="height:28px; width: 290px;;"/> 
               </div>   
               </p> 
               
                <div class="input-group">
               <span class="input-group-addon" style="width:124px; background-color:#FFF;text-align:left;">LPO number</span>
               <input type="text" class="form-control" id="LPONO" input name="LPONO"  style="height:28px; width: 290px;;"/> 
               </div>   
               
               <div class="col-xs-pull-8 col-md-push-10" style="margin-top:-81px; margin-left: 422px;"/>
               </p> 
               <div class="input-group">
              <span class="input-group-addon" style="width: 185px;background-color:#FFF; text-align:left;">LPO Date</span>
              <input type="date" input name="LPODATE" id="datepicker" value="<?php echo date('d-m-y'); ?>" class="form-control" style="height:28px; width: 166px;"/>
              </div>  
              </p>  
                
              <div class="input-group">
          <span class="input-group-addon" style="width: 123px;background-color:#FFF; text-align:left;">Expected date of delivery</span>
                 <input type="date"  input name="LPODATE"id="datepicker" value="<?php echo date('d-m-y'); ?>" class="form-control" style="height:28px;     width: 166px;"/>
              </div>  
              <br>
                 
               
                <div class="input-group" style="margin-left: -422px;">
                <span class="input-group-addon" style="width:124px;background-color:#FFF;text-align:left;">Payment terms</span>
                 <textarea id="wysihtml" name="CREDITTERMS" class="form-control"   style= "width:648px; height:50px; background-color:#fff;" placeholder=""></textarea>
               </div>  
               </p> 
                    
   <strong style="margin-left: -419px;"> 
   We are pleased to confirm our purchase of the following items.</strong> 
   <p> </p>            
   <div class="col-md-31" style="margin-left: -72px;" > 
...
<div class="container" style="width: 715px;font-size: 12px;margin-left: -363px;margin-top: -40px;"> 
  ...
  <div class="input-group">
                <span class="input-group-addon" style="width:124px;background-color:#FFF;text-align:left;">Delivery terms</span>
               ...
               <div class="input-group">
               <span class="input-group-addon" style="width: 124px;background-color:#FFF;text-align:left;">Approved by</span>
               <input type="numeric" input name="APPROVEDBY"  id="APPROVEDBY" disabled="disabled" class="form-control" style="height:28px;  background-color:#FFF; width: 193px;"/>
               </div>  
               </p>  
               
               <div class="input-group">
               <span class="input-group-addon" style="width: 124px;background-color:#FFF; text-align:left;">Approval date</span>
               <input type="date"  id="APPROVALDATE" disabled="disabled" class="form-control" style="height:28px; background-color:#FFF; width: 193px;"/>
              </div>  
              <br>   
              
              <div class="col-xs-pull-11" style="margin-top: -90px; margin-left: 342px;">
               <div class="input-group">
                <span class="input-group-addon" style="width: 134px;background-color:#FFF;text-align:left;">Authorised by</span>
                 <input type="numeric" input name="AUTHORISEDBY"  id="APPROVEDBY" disabled="disabled" class="form-control" style="height:28px; background-color:#FFF; width: 193px;"/>
              </div>  
              </p>  
           
          <div class="input-group">
                <span class="input-group-addon" style="width: 134px;background-color:#FFF; text-align:left;">Authorised date</span>
                 <input type="date"  id="AUTHORISEDBY" disabled="disabled" class="form-control" style="height:28px;background-color:#FFF; width: 193px;"/>
              </div>  
         </div>    
         </div>     
          <div class="col-xs-pull-10" style="margin-left: 323px; margin-top:-129px;">
              <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFF;text-align:left;">Sub total (ugx)</span>
                 <input type="numeric" input name="ORDERVALUE"  id="ORDERVALUE"  class="form-control" style="height:28px; width: 185px;"/>
              </div>  
              <br>    
              
              <div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#FFF;text-align:left;">Tax(% on bill)</span>
                 <input type="double" input name="INVOICETAX"  id="INVOICETAX" class="form-control" style="height:28px; width: 185px;"/>
              </div>  
              <br>  
              
              <div class="input-group">
              <span class="input-group-addon" style="width: 124px;background-color:#FFF;text-align:left;">Total cost (ugx)</span>
              <input type="numeric" input name="ORDERTOTALCOST"  id="ORDERTOTALCOST" class="form-control" style="height:28px; width: 185px;"/>
              </div>  
              <br>   
              
              </div> 
           <input type="submit" name="button" id="button" value="Submit &raquo;" style=" height: 33px; margin-left: -5px; margin-top: -6px;"/>  
            <input class="submit" type="submit" value="Print Invoice &raquo;" style=" height: 33px; "/>
            <input class="submit" type="submit" value="Download In Pdf &raquo;" style=" height: 33px;"/> 
        </div>  
         <div class="row">
         <div class="col-md-push-12" style="margin-left: -403px;">
            <strong> Note: </strong>
             <ol>
                  <li>
