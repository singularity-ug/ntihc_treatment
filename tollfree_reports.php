...
<link rel="stylesheet" href=" assets/plugins/switch/static/stylesheets/bootstrap-switch.css" />
  ...
  <script type="text/javascript" src="assets/fusion/js/fusioncharts.js"></script>
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="dashboard.php" style="background-color:#518dc1;border: 2px solid #f4f4f4;padding: 10.5px; text-align:left;color:#fff;">Dashboard</a></li>
                                      <li><a href="report_module.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; text-align:left;"><i class="icon-lock icon-white"></i>Home</a></li>
                                    <li class='dropdown '>
                                 ...
                                 <li><a href="tollfree_gender.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Age group and gender</a></li> 
                                 
                                  <li><a href="tollfree_monthly.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Monthly calls</a></li> 
                                  
                                    <li><a href="tollfree_district.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Callers by location</a></li> 
                                    
<li><a href="tollfree_prob.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Callers by reason</a></li> 

<li><a href="tollfree_action.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Callers by action taken</a></li> 
            ...
            <div id="div-5" class="accordion-body collapse in body"> 
              ...
              <div class="col-sm-12" >    
      <P style="font-weight:bold; text-align:center; font-size:11px;"> DAILY TOLLFREE PERFORMANCE </P> 
   
    <div class="col-sm-1"> 
    <div class="panel-body" style="border:2px solid #000000; border-radius:11px;">
   <p style="text-align:center;">Counselled</p>
...
?>
   ...
   <div class="col-sm-1" > 
    <div class="panel-body" style="border:2px solid #000000; border-radius:11px;">
    <p style="text-align:center;">In-sch</p>
        <p style=" text-align:center; font-weight:bold; font-size:35px;">
        <?php
$link = mysqli_connect("localhost", "root", "toor2", "dbtollfree");
...
?>
    ...
    <div class="col-sm-12" >   
   <br><br>
    <P style="font-weight:bold; text-align:center; font-size:11PX;">SUMMARY OF CALLS LOOKUP BY AGE GROUP AND CLIENTS DEMOGRAPHY</P> 
  
    <div id="work" style="width:100%;">
    <table id="example9" class="table table-striped table-bordered"  style="font-size:90%; " cellspacing="0" width="100%">
        <thead>
          <tr>
              <th>No.</th>
              <th>AGE GROUP</th> 
...
$sql = "SELECT SEX, SCHOOLINGSTATUS, DISTRICT, MARITALSTATUS, EMPLOYMENTSTATUS, HEAREDABOUTNTIHC, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' 
                         WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' 
						 WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' 
						 WHEN AGE >= 25 THEN '25 +' END AS agegroup, 
						 count(age) AS total
						 FROM tollfree GROUP BY SEX, SCHOOLINGSTATUS, DISTRICT, MARITALSTATUS, EMPLOYMENTSTATUS, HEAREDABOUTNTIHC, agegroup ORDER BY total DESC ";
...
$x=$x+1;
 ...
 ?>
   ...
   <P style="font-weight:bold;"> DATA CODES: FEMALE=1 MALE=2 </P>
  
    <br>
    <p style="font-weight:bold; text-align:center; font-size:11PX;"> SUMMARY OF MONTHLY CALLS BY FISCAL YEAR</p>
...
$sql = "SELECT FISCALYEAR,  
											 
											 MAX(CASE WHEN FISCALMONTH = 01 THEN CID END) AS JAN, 
											 MAX(CASE WHEN FISCALMONTH = 02 THEN CID END) AS FEB, 
											 MAX(CASE WHEN FISCALMONTH = 03 THEN CID END) AS MAR, 
											 MAX(CASE WHEN FISCALMONTH = 04 THEN CID END) AS APRIL,
											 MAX(CASE WHEN FISCALMONTH = 05 THEN CID END) AS MAY,
											 MAX(CASE WHEN FISCALMONTH = 06 THEN CID END) AS JUNE,
											 MAX(CASE WHEN FISCALMONTH = 07 THEN CID END) AS JULY,
											 MAX(CASE WHEN FISCALMONTH = 08 THEN CID END) AS AUG,
											 MAX(CASE WHEN FISCALMONTH = 09 THEN CID END) AS SEPT,
											 MAX(CASE WHEN FISCALMONTH = 10 THEN CID END) AS OCT,
											 MAX(CASE WHEN FISCALMONTH = 11 THEN CID END) AS NOV,
											 MAX(CASE WHEN FISCALMONTH = 12 THEN CID END) AS DECEMBER
											 FROM tollfree GROUP BY FISCALYEAR  ";
...
<div class="row">
  <div class="col-lg-12">
	...
	<h5> . </small></h5>
     ...
     <p style="font-weight:bold;">CLIENTS BY NUMBER OF CALLS PLACED</p>
               <div id="work" style="width:100%;">
    <table id="example7" class="table table-striped table-bordered"  style="font-size:90%; font-weight:normal; " cellspacing="0" width="100%"> 
          <thead>
          <tr>
              <th>No.</th>
              <th>DATE OF 1st REGN.</th>
              <th>PHONE CONTACT</th>
              <th>SCHOOLINGSTATUS</th> 
              <th>GENDER</th>
               <th>AGE GROUP</th>
              <th>MARITALSTATUS</th>  
...
require('php/configtollfree.php');
$sql = "SELECT COUNT(CID), TIMESTAMP, PHONECONTACT, SCHOOLINGSTATUS, MARITALSTATUS, EMPLOYMENTSTATUS, 
               DISTRICT, DIVISION, LIVING_WITH, HEAREDABOUTNTIHC, SEX,
			  ...
			  CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' 
										...
										WHEN AGE >= 25 THEN '25 +' END AS agegroup, 
										count(age) AS total  
			   FROM tollfree GROUP BY PHONECONTACT, DISTRICT , SEX 
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
          ...
          <center> <legend style="color:#000; font-weight:normal;font-size:11px;"> TOLLFREE REPORT</legend> </center>

            <form class="form-horizontal" style="height:auto;">
  <p style="font-weight:bold;font-size:12px;">NUMBER OF CALLS BY MONTH</p>
...
require('php/configtollfree.php');
$sql = "SELECT FISCALMONTH, FISCALYEAR, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' 
                                             WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' 
											 WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' 
											 WHEN AGE >= 25 THEN '25 +' END AS agegroup,
											 count(PID) AS total 
											 FROM tollfree GROUP BY FISCALMONTH, FISCALYEAR, agegroup";
...
include("assets/fusion/src/fusioncharts.php");
...
<?php 
    ...
    $strQuery = "SELECT FISCALMONTH, FISCALYEAR, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' WHEN AGE >= 25 THEN '25 +' END AS agegroup, count(age) AS total FROM tollfree GROUP BY FISCALMONTH, FISCALYEAR, agegroup"; 
...
// Push the data into the array
        ...
        $columnChart = new FusionCharts("column2D", "myFirstChart" , 569, 310, "chart-1", "json", $jsonEncodedData);
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
          ...
          <center> <legend style="color:#000; font-weight:bold;font-size:12px;"> TOLLFREE REPORT</legend> </center>

            <form class="form-horizontal" style="height:auto;">
  <p style="font-weight:bold;font-size:12px;">NUMBER OF CALLERS BY REASON</p>
...
require('php/configtollfree.php');
$sql = "SELECT COUNT(PID), TOPIC, SEX FROM tollfree_problems GROUP BY TOPIC, SEX ORDER BY COUNT(PID) DESC ";
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
   ...
   <center> <legend style="color:#000; font-weight:bold;font-size:12px;"> TOLLFREE REPORT</legend> </center>
            ...
            <form class="form-horizontal" style="height:auto;">
  <p style="font-weight:bold;font-size:12px;">NUMBER OF CALLERS BY GENDER AND LOCATION</p>
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
         ...
         <center> <legend style="color:#000; font-weight:normal;font-size:11px;"> FUEL / MAINTENANCE CARDS BY USAGE STATUS</legend> </center>
                 
          <form class="form-horizontal" action="fleet_fuelcardsprocess.php" method="POST" style="height:auto;">
               
                 
                <div class="col-sm-5">
                 <h4 style="text-align:center; font-size:14px; font-weight:bold;">Add new card</h4>
                <div class="form-group">
                    <label for="text1" class="control-label col-sm-4">Card number</label>
                    <div class="col-sm-8">
                        <input type="alphanumeric" class="form-control"  id="CARDIDENTITYNO" name="CARDIDENTITYNO"  required="required"
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-sm-4">Card name</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control"   name="CARDNAME" id="CARDNAME" data-placement="top" required="required"
                    style=" font-size: 11px;"/>
                    </div>
                ...
                <!-- /.form-group -->
                    ...
                    <div class="col-sm-8">
                        <select class="form-control"  id="CARDCATEGORY" name="CARDCATEGORY"  required="required"
                        style="text-transform:uppercase;font-size: 11px;"/>
                        <option value="FUEL CARD">FUEL CARD </option>
                        <option> SERVICE CARD</option>
                ...
                <div class="form-group">
                    <label for="pass1" class="control-label col-sm-4">Product Vendor</label>
                    <div class="col-sm-8">
                   <input type="text" class="form-control"   name="VENDOR" id="VENDOR" data-placement="top" required="required"
                   style=" font-size: 11px;"/>
                   </div>
                </div>
                ...
                <!-- /.form-group -->
                  <div class="form-group">
                    <label for="pass1" class="control-label col-sm-4">Reorder level</label>
                    <div class="col-sm-8">
                   <input type="numeric" class="form-control"   name="MINFUELLEVEL" id="MINFUELLEVEL" data-placement="top" placeholder="Minimum amount " required="required" style="font-size: 11px; "/>
                   </div>
                </div>

                <!-- /.form-group -->
                 <div class="form-group">
                    <label for="pass1" class="control-label col-sm-4">Currency</label>
                    <div class="col-sm-8">
                        <select class="form-control"  id="CURRENCY" name="CURRENCY"  required="required"
                        style="text-transform:uppercase;font-size: 11px;"/>
    ...
    <table id="example3" class="table table-striped table-bordered"  style="font-size:90%; font-weight:normal; " cellspacing="0" width="100%">
        <thead>
          <tr>
              <th>No</th>
              <th>CARD ID</th>
...
$x=1;
 while($row=$res->fetch_assoc()){
 $vx =  $row['CARDIDENTITYNO']."__".$row['id'];
  echo'<tr>'.
       '<td>'.$x.'</td>'.
		  ...
		  '<td>'.$row['CARDSTATUS'].'</td>'.
		     '<td><input type="button" style="background-color:#ecf0f5;"  id="'.$vx.'" onclick="postvalues(this.id)" value="EDIT"></td>'.
   '</tr>';
$x=$x+1;
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
          ...
          <center> <legend style="color:#000; font-weight:bold;font-size:12px;"> TOLLFREE REPORT </legend> </center>
          <form class="form-horizontal" style="height:auto;">
          <p style="font-weight:bold;font-size:12px; text-align:left;">Number of young people calling on toll-free by age group and gender</p>
...
require('php/configtollfree.php');
$sql = "SELECT SEX, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' 
                         WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' 
						 WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' 
						 WHEN AGE >= 25 THEN '25 +' END AS agegroup, 
						 count(age) AS total FROM tollfree GROUP BY SEX, agegroup";
...
<?php
    ...
    $strQuery = " SELECT SEX, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' WHEN AGE >= 25 THEN '25 +' END AS agegroup, count(age) AS total FROM tollfree GROUP BY SEX, agegroup";
