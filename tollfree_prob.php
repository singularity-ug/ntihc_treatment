...
<div class="col-sm-2"> </div>  
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
    ...
    <div class="col-sm-12"> 
     <legend style="color:#000; font-size:11px; text-align:center; font-weight:bold; text-transform:uppercase;">Number of callers by reason for calling </legend>  
...
$sql = "SELECT TOPIC, FISCALYEAR,   	 
											 MAX(CASE WHEN SEX = 1 THEN PID END) AS FEMALE,  
											 MAX(CASE WHEN SEX = 2 THEN PID END) AS MALE  
											 FROM tollfree_problems GROUP BY TOPIC, FISCALYEAR ORDER BY FISCALYEAR DESC";
