...
<head>
  ...
  <![endif]-->
    ...
    var t = setInterval(function() {
        var today = new Date();
        document.getElementById('CHECKOUT').value = today.getHours() + ":" + checkTime(today.getMinutes()) +
            ":" + checkTime(today.getSeconds());
 ...
 ?-->
    ...
    <div class="col-md-5" style=" background-color:transparent;">
        <ul class="nav nav-tabs" style="border: 0px;">
            ...
            <div class="col-md-5" style=" background-color:transparent;"> </div>
...
$result = mysqli_query($mysqli, "SELECT * FROM  cmpatientsregistration WHERE TIMESTAMP >='$date' AND
	...
	$dtsxxc = $res['RID']."***".$res['NTIHCNO']."***".$res['AGE1']."***".$res['AGE_GROUP']."***".$res['SEX']."***".$res['RSVNID']."***".$res['DATECREATED'];
		...
		<span class="glyphicon glyphicon-user"> </span></a> &nbsp;&nbsp; 
		 ...
		 echo "<td><a href=\"client_lab_hist.php?NTIHCNO=$res[RSVNID]\">View</a>  </td>";     	
	}
...
$result = mysqli_query($mysqli, "SELECT * FROM  cmpatientsregistration WHERE  
	...
	while($res = mysqli_fetch_array($result)) {
	$dtsxxcW = $res['RID']."***".$res['NTIHCNO']."***".$res['AGE1']."***".$res['AGE_GROUP']."***".$res['SEX']."***".$res['RSVNID']."***".$res['DATECREATED'];
		echo "<tr>"; 
		echo "<td>".$res['TIMESTAMP']."</td>"; 
		echo "<td>".$res['NTIHCNO']."</td>"; 
		echo "<td>".$res['CLIENTNAME']."</td>";  
    ...
    ?>
          ...
          background-color: transparent; border: 1px solid rgb(222, 212, 211); box-shadow: 3px 2px 0px 0px rgba(12, 12, 12, 0.1) !important; border-radius: 11px;">
                    <table border="1" cellpadding="4" cellspacing="0"
                        ...
                        <thead>
                            <tr>
                                <th style="width:38%; text-align:left; border:0px;"> <strong>Clients&nbsp;due&nbsp;for
                                        Testing</strong></th>
			...
			$date = date("Y-m-d").' 00:00:00';
			 ...
			 ?>
                                ...
                                <th style="width:38%; text-align:left; border:0px;"><strong>No.&nbsp;completed
                                        clients</strong> </th>
                                <th style="width:10%; text-align:left; border:0px;">
                                    <b style="text-align:center; font-size:40px;font-size: 15px;border-radius: 11px;"
                                        class="button 5">
            ...
            <center>
                <p>Clients due for urgent results</p> &nbsp; <?php 
			include('client_medical_conn.php');
			$date = date("Y-m-d").' 00:00:00';
				$result = $db->prepare("SELECT * FROM cmpatientsregistration WHERE TIMESTAMP >='$date' AND
        ...
        <table border="1" cellpadding="4" cellspacing="0"
            ...
            <thead>
                <tr>
                    ...
                    <th style="width:28%;border:0px;"> <?php echo $nameofuser; ?> </th>

                    <th style="width:4%;border:0px;"> </th>

                    <th style="width:20%;border:0px;">Title</th>
                    <td style="width:28%;"> <?php echo $dept; ?></td>
                </tr>
                <tr>
                    </tbody>
        </table>
...
$date = date("Y-m-d").' 00:00:00';
 $sql  = "SELECT * FROM laboratory WHERE TIMESTAMP >='$date' AND NTIHCNO = '$id' ";
 ...
 $res = $conn->query($sql);
     ...
     ?>
            ...
            <table class="table table-table table tabled" id="mytable2" style="font-weight:normal; ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> <select name="aa[]" type="text" value="<?php echo $aa[$s]; ?>"
                        ...
                        <td> <select name="dnx[]" type="text" value="<?php  echo $dnx[$s]; ?>"
                                style="width:100%; background-color:transparent; " />
                        ...
                        <td> <select name="fqx[]" type="text" value="<?php echo $fqx[$s]; ?>"
                        ...
                        <td> <select name="abb[]" type="text" value="<?php echo $abb[$s]; ?>"
                                style="width:100%; background-color:#fff; " />
                        ...
                        <td> <select name="acc[]" type="text" value="<?php echo $acc[$s]; ?>"
                                style="width:100%; background-color:#fff; " />
                        ...
                        <td> <select name="add[]" type="text" value="<?php echo $add[$s]; ?>"
                                style="width:100%; background-color:#fff; " />
                        ...
                        <td> <select name="aee[]" type="text" value="<?php echo $aee[$s]; ?>"
                                style="width:100%; background-color:#fff; " />
                        ...
                        <td> <select name="aff[]" type="text" value="<?php echo $aff[$s]; ?>"
                                style="width:100%; background-color:#fff; " />
                ...
                <thead>
                    <tr>
                        ...
                        <th style="width:40%;border:0px;">
                            <center>
                                <input type="submit" name="buttonsend" id="button" value="Update test"
        ...
        <form class="form-horizontal" method="post" action="client_lab_histpro4.php"
            style="height: auto;background-color:transparent;">
 ...
 $conn = new mysqli($servername, $username, $password, $dbname);
 $date = date("Y-m-d").' 00:00:00';
 $sql  = "SELECT * FROM hivtests WHERE TIMESTAMP >='$date' AND NTIHCNO = '$id' GROUP BY DATECREATED";
 ...
 $res = $conn->query($sql);
     ...
     ?>
            ...
            <input type="hidden" name="RSVNID" value="<?php echo $RSVNID;?>" />
            <input type="hidden" name="TESTEDBY" value="<?php echo $nameofuser;?>" />
            <input type="hidden" name="TECHTITLE" value="<?php echo $desc;?>" />
	 ...
	 text-align:left; border:0px; background-color:transparent;" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="width:25%;border:0px;"> <input type="text" name="LOTA" id="LOTA"
                                    value="<?php echo $LOTA;?>"
                                    style="width:100%; font-weight:normal; background-color:transparent;"> </th>

                            <th style="width:25%;border:0px;"> <input type="text" name="LOTB" id="LOTB"
                                    value="<?php echo $LOTB;?>"
                                    style="width:100%; font-weight:normal; background-color:transparent;"> </th>
	 ...
	 text-align:left; border:0px; background-color:transparent;" width="100%">
                    <thead>
                        <tr>
                            ...
                            <td style="width:25%;"><input type="date" name="EXPIRYDATET3" id="EXPIRYDATET3"
                                    value="<?php echo $EXPIRYDATET3;?>"
                                    style="width:100%; font-weight:normal; background-color:transparent;"> </th>
                        </tr>
                        <tr>
                            </tbody>
	 ...
	 text-align:left; border:0px; background-color:transparent;" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="width:25%;border:0px;"> <select id="REACTIVITYT1" name="REACTIVITYT1"
                                    value="<?php echo $REACTIVITYT1;?>"
                            ...
                            <th style="width:25%;border:0px;"> <select id="REACTIVITYT2" name="REACTIVITYT2"
                                    value="<?php echo $REACTIVITYT2;?>"
                                    style="width:100%; font-weight:normal; background-color:transparent;">
                            ...
                            <th style="width:25%;border:0px;"> <select id="REACTIVITYT3" name="REACTIVITYT3"
                                    value="<?php echo $REACTIVITYT3;?>"
                                    style="width:100%; font-weight:normal; background-color:transparent;">
	 ...
	 text-align:left; border:0px; background-color:transparent;" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th style="width75%;border:0px;"> <select name="FINALREACTIVITY" id="FINALREACTIVITY"
                                    value="<?php echo $FINALREACTIVITY;?>"
                                    style="width:100%; font-weight:normal; background-color:transparent;">
                                    <option value="<?php echo $FINALREACTIVITY;?>"> <?php echo $FINALREACTIVITY;?>
                                    <option>
                                    <option>NEGATIVE</option>
                                    <option>POSITIVE</option>
                                    <option>INV</option>
 ...
 $conn = new mysqli($servername, $username, $password, $dbname);
$date = date("Y-m-d").' 00:00:00';  
 $sql  = "SELECT * FROM laborders WHERE TIMESTAMP >='$date' AND NTIHCNO = '$id' AND TESTSTATUS='NOT STARTED'";
 ...
 $res = $conn->query($sql);
     ...
     ?>
          ...
          background-color: transparent; border: 1px solid rgb(222, 212, 211); box-shadow: 3px 2px 0px 0px rgba(12, 12, 12, 0.1) !important; border-radius: 11px;">
                ...
                <input type="hidden" name="LABTIMEOUT" id="CHECKOUT">
                <center>
                    <input type="submit" name="buttonsend" id="button" value="Save results"
                        style="border-radius:9px;" />
                </center>
        </form>
