...
?></b>completed </center>  </a>
   ...
   <center style="color:#000; font-weight:bold; font-size:12px;">FAMILY PLANNING</center> 
    </td> 
...
box-shadow: 0px 1px 1px 1px rgba(0, 0, 0, 0.1) !important;">
          <center> <b style=" font-size:11px;">Family planning</b></center> <i class=" "></i> 
      ...
      var ddt = jose.split("__")[1];
          postclient(ddt);
                $.ajax({
                       type    : 'POST',
             data    :{bb:odno},
                       url     : 'medical/medical_get_fp.php?q='+odno,
                       success : function(data){
                                $('#dem').html(data);
                $("#demm").modal("show");
                                 }
...
<div class="col-sm-7" >
                ...
                <form class="form-horizontal" action="familyplanning_process.php" method="post" style="height:auto;"/>  
        ...
        required="required" style="width:100%; font-weight:normal; background-color:transparent;">
         ...
         <table class="table" style="border:0px;">
                <tr> 
              <th style="width:25%;border:0px;">HCT Code </th>
        <th style="width:25%;border:0px;"> <select  name="HCTCODE" id="HCTCODE"
        required="required" style="width:100%; font-weight:normal; background-color:transparent;">
                  <option> </option>
                <option>TR</option>
                <option>TRK</option>
...
$("#impres4").modal("show");
     ...
     <script> 
          setInterval(function() {
                $.ajax({
                       type    : 'POST',
                       url     : 'medical/medicalvists_fp.php',
                       success : function(data){
...
<script>
  ...
  function addRow12(tableId){
     ...
     var rowCount = table.rows.length;
         ...
         var s1 = '<input type="text"  name="p_'+rowCount+'" id="p_'+rowCount+'" required="required" '+
              ...
              ' style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; background-color:#fff" >'+
                      ...
                      '<option>DEPO PROVERA</option>'+ 
                        ...
                        '<option>NORISTERAT</option>'+ 
                                            ...
                                            '<option>SYNA PRESS</option>'+  
                                            '</Select>';
                                    
           var sff = '<input type="number"  name="ff_'+rowCount+'" id="ff_'+rowCount+'" '+
               'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:transparent;" />';                  
   ...
   var pd = '<input type="text" onkeyup="dostg(this.id)" onchange="dostg(this.id)" name="pd_'+rowCount+'" id="pd_'+rowCount+'" required="required" '+
                                        'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:transparent;" />';
