...
<div class="wrapper">
 ...
 <i class="fa fa-rocket fa-5x" style="color:#f39c12;"></i>
                  ...
                  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                           <a href=<button class="" data-toggle="modal" data-target="#m4"></button>
 <i class="fa fa-lightbulb-o fa-5x" style="color:#f56954;"></i>
                      <h4> Electricity accounts </h4>
                      </a>
                      </div> 
                  </div>
                   ...
                   <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                          <a href=<button class="" data-toggle="modal" data-target="#m5"></button>
 <i class="fa fa-clipboard fa-5x" style="color:#00a65a;"></i>
                      <h4>Water accounts </h4>
                      </a>
                      </div>
 ...
 <i class="fa fa-comments-o fa-5x" style="color:#f39c12;"></i>
                 ...
                 <div class="col-sm-3">
                  ...
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div class="div-square">
                          <a href=<button class="" data-toggle="modal" data-target="#m7"></button>
 <i class="fa fa-key fa-5x" style="color:#f56954;"></i>
                      <h4> Find property </h4>
                      </a>
                      </div>
                   ...
                   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <div class="div-square">
                         <a href=<button class="" data-toggle="modal" data-target="#m8"></button>
 <i class="fa fa-gear fa-5x" style="color:#00a65a;"></i>
                      <h4>Running budget</h4>
                      </a>
                      </div>
                </div>  </div>  
                        ...
                        <div class="modal" id="m1" tabindex="-1"    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #fff;" >
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel" style="text-align:center;">Welcome to: Payments wizard </h4>
                                        </div>
                                        <div class="modal-body">
                    <!--------->   
                        <center><a href="payments_rpt.php?d1=0&d2=0"> <i class="fa fa-circle-o">payments report</i> </a></center>                   <!--------->            
                   <div class="col-sm-12">
           <div class="panel-body"> 
           </div>
                        ...
                        <div class="modal" id="m2" tabindex="-1"    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #fff;" >
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel" style="text-align:center;">User contacts </h4>
                                        </div>
                                        <div class="modal-body">
                    <!--------->   
                        ...
                        <div class="modal" id="m3" tabindex="-1"    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color: #fff;" >
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel" style="text-align:center;">CUG Panel </h4>
                                        </div>
                                        <div class="modal-body">
                    <!--------->   
                        <p style="text-align:center;">Waiting for user comments on modal navigation flow</p>
