...
$("#chkMOTHERLASTNAMEAvailability").click(function(){
var ct = $("#MOTHERLASTNAME").val();

// Returns successful data submission message when the entered information is stored in database.
var dataString = 'MOTHERLASTNAME='+ ct;
...
$("#FATHERFIRSTNAME").val(data[13]);
$("#FATHERLASTNAME").val(data[14]);
$("#HEAREDABOUTNTIHC").val(data[15]);
