	...
	<div class="box">
	   <div class="body" style="height: 550px; width: 296.6%; background:url(../img/pattern/diamond_upholstery.png); margin-left: 106px;">
        ...
        <div class="col-md-23">
         ...
         <h2 class="demoHeaders">Human Resource placements</h2>
<div id="accordion">
	<h3> New employees placement by department and sub unit</h3>
	<div>
  ...
  <fieldset class="row13" style= "margin-left: 276px; margin-top: -120px; width:260px; height:200px;"/>  
       ...
       <fieldset class="row14" style= "margin-left: 554px; margin-top: -200px; width:260px; height:200px;"/> 
           ...
           <label>Aggreement duration</label>
        <input type="text" name="AGGREEMENTDURATION" id="APPRAISALDURATION" required="required"class="form-control chzn-select" style= "background-color:#fff;"/>
        </p> 
          
          <label>Placement status</label>  
       <input type="radio" name="PLACEMENTSTATUS" id="APPOINTMENT" value="APPOINTMENT" checked>
        <label for="CONTINUAPPOINTMENTING">Appointed </label> 
		 </p>  
           </fieldset>  
       <fieldset class="row110" style= "margin-left: 1px; margin-top: -76px; width:560px; background-color:#FFCB00;"/>    
                                ...
                                <th> <label for="DESIGNATION" class="label">DESIGNATION </label>  </th> 
                                ...
                                <th><label for="SALARYSCALE" class="label">SALARY SCALE</label>                </th> 
                     			...
                     			<td><select name="DESIGNATION" id="DESIGNATION" required="required" style= "margin-left: 0px;margin-top: 5px;height:20px; width:240px; background-color:#fff;"/>
                     		                       	<option value="-1"> </option>
                     			                                <option>PROGRAMME DIRCETOR</option>
