 ...
 <!--Chart-box-->    
    <div class="row-fluid"> 
      <div class="widget-box"> 
        ...
        &nbsp;
        <a href="fuel/my_fuel_approvals.php" title="History" class="tip-bottom"><i class="icon-share"></i> My approval(s) </a></h5>
        ...
        <center> <p style="color:#000; font-weight:bold;font-size:10px; background-color:#fff; font-family:lcd;margin-top: 0px;">
         <b>FUEL AND LUBRICANTS ORDERS DUE FOR APPROVAL</b> </p> </center> 
		  ...
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'fuel/fuel_approvaldom.php?q='+odno,
         ...
         <tr>   
                     ...
                     <th style="background-color:#ecf0f5; font-size:10px;">APPROVAL</th> 
                     <th style="background-color:#ecf0f5; font-size:10px;">ACTION</th>  
           </tr>
        </thead>
        <tfoot>
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE APPROVALSTATUS ='PENDING' AND FORWARDTO = '$rm' GROUP BY SERIALNO ORDER BY DATECREATED DESC");
	...
	$dtsz = $res['ORDERNO']."***".$res['SERIALNO'];
		...
		echo '<td> &nbsp; 
               ...
               style="color: #fff;border-radius: 6px; height: 20px;" <button class="btn btn-success"> Approve</span></a> 
               &nbsp;&nbsp;
               </td>';  	 
