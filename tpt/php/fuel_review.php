    ...
    <div class="row-fluid"> 
      <div class="widget-box"> 
        <div class="widget-title bg_lg"><span class="icon"><i class=""></i>
         <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-fast-backward"></i> Home</a> &nbsp; 
        </span>
          <h5> </h5>
        </div>
        ...
        <center> <p style="color:#000; font-weight:bold;font-size:10px; background-color:#fff; font-family:lcd;margin-top: 0px;">
         <b>APPROVED FUEL / LUBRICANTS ORDERS DUE FOR REVIEW</b> </p> </center> 
		  ...
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'fuel/fuel_confirmation.php?q='+odno,
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE 
                                                       APPROVALSTATUS ='APPROVED' AND REVIEWFUEL = 'WAITING'  
														GROUP BY SERIALNO ORDER BY DATECREATED DESC");
  
	while($res = mysqli_fetch_array($result)) {
	$dtsz = $res['ORDERNO']."***".$res['SERIALNO'];
		echo "<tr>"; 
		echo '<td> &nbsp; 
			    <a id="1__'.$dtsz.'" href="javascript:void(0)"  onclick="getresorder(this.id)" data-toggle="tooltip" title="Review"
                style="color: #fff;border-radius: 6px; height: 20px;" <button class="btn btn-danger"> Click</span></a> 
               &nbsp;&nbsp;
               </td>';  	 
    ...
    ?>
			 ...
			 <div class="col-sm-4"></div>
			  <div class="col-sm-4"> 
			 <center> <a href="fuel_datacenter.php">
                <img src="../img/icons/reset6.jpg"width="100" height="100" style="height:30%; width:30%;" class="img-circle"> </a> </center>
