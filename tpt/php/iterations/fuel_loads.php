...
<div class="container">
	...
	<div class="row">
		<div class="col-lg-12">
			<h2 style="color:#000;font-size:15px;"> <a rel="" href="../dashboard.php" class="btn btn-danger" /><i class=""></i> << Back</button></a>
                    ...
                    <tbody>
						<?php
							...
							?>
								<tr>
									<td class="hidden"></td>
                                    <td>NTIHC/ADMIN/FTL/<?php echo $row1['purchaseid']; ?>/<?php echo $row1['Yearval']; ?>/<?php echo $row1['Monthno']; ?></td>
