...
<div id="content" style="background: #fff;">
  <div id="content-header" style="margin-top: 1px;">
   <div id="breadcrumb"> <a href="dashboard.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
                          <a href="fuel_datacenter_editor.php" class="">My fuel data</a> 
                          <a href="#myModal21" data-toggle="modal" class="">Data center</a>  
                          </div> 
  </div> 
    ...
    <div class="row-fluid"> 
      <div class="widget-box"> 
        <div class="widget-title bg_lg"><span class="icon"><i class="icon-signal"></i></span>
          <h5>Approved fuel requisitions</h5>
        </div>
        <div class="widget-content" >
		  ...
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'fuel/fuel_issue.php?q='+odno,
         ...
         <tr>   
                     ...
                     <th style="background-color:#ecf0f5; font-size:10px; ">R/NO.</th>
					 <th style="background-color:#ecf0f5; font-size:10px; ">DATE</th> 
					 <th style="background-color:#ecf0f5; font-size:10px; ">REGN.NO</th> 
...
$result = mysqli_query($mysqli, "SELECT * FROM fuellogs WHERE APPROVALSTATUS ='APPROVED' AND REVIEWFUEL = 'REVIEWED' 
	...
	$dtsz = $res['id']."***".$res['REGISTRATIONNO']."***".$res['DATECREATED'];
		echo "<tr>"; 
		echo '<td> 
			    <a id="1__'.$dtsz.'" href="javascript:void(0)"  onclick="getdetailsextension(this.id)" data-toggle="tooltip" title="Issue"
...
if ($result = mysqli_query($link, "SELECT SERIALNO FROM fuellogs WHERE APPROVALSTATUS ='APPROVED'
													  AND REVIEWFUEL = 'REVIEWED' GROUP BY SERIALNO")) { 
...
mysqli_close($link);
?>
                </strong> <small> Total approved orders</small></li>
...
$date = date("Y-m-d").' 00:00:00';
if ($result = mysqli_query($link, "SELECT REGISTRATIONNO FROM fuellogs WHERE APPROVALSTATUS ='APPROVED' 
                                   AND FUELISSUANCESTATUS = 'ISSUED' AND ISSUERACCOUNT = '$rm' AND FUELISSUANCEDATE = '$date' GROUP BY REGISTRATIONNO")) {
...
mysqli_close($link);
?>
</strong> <small>My todays issued vehicles  </small></li>
...
<!--Footer-part-->
<div class="row-fluid">
  <div id="footer" class="span12"> 2017 &copy; Kampala capital city authority <a href="http://themedesigner.in"> </a> </div>
</div>
<!--end-Footer-part-->
