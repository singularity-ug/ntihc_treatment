   ...
   <th style="border:2px solid #ecf0f5;">Payment period</th>  
	...
	<tbody>
			...
			function formatMoney($number, $fractional=false) {
				...
				include('../tweak/connectproc.php'); result = $db->prepare("SELECT * from fuellogs  where Loadreview ='Verified' AND Loadreview ='Verified' 
                                                              AND Reconciliation='Reconciled' 
															  AND Recstatus='Successfull' order by FUELISSUANCEDATE asc");
				$result->execute();
