...
.progress{
  ...
  <div id="content-header" style="margin-top: 0px;">
   ...
   <a href="../iterations/fuel_loads.php" title="Go to load" class="tip-bottom"><i class="icon-home"></i> Load center</a> 
                          </div> 
  </div> 
...
$result = mysqli_query($mysqli, "select * from purchase where Approval ='Approved' AND Loadreview ='Verified' order by date desc");
