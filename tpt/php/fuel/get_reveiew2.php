...
?>  
        ...
        <form class="form-horizontal" action="fuel/get_review_update2.php" method="POST" style="height:auto; font-weight:normal; background-color:#fff;">
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#fff;"><input type="text" name="Ref" id="Ref" readonly="readonly"
                value="NTIHC/ADMIN/FTL/<?php  echo $purchaseid; ?>/<?php  echo $Yearval; ?>/<?php  echo $Monthno; ?>"  
			   style="width:100%; font-size:11px;  background-color:#fff; text-align:left; font-weight:bold; border:0px;border:0px; text-align:left;"> </td> 
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#fff;"><input type="text" name="date" id="date" readonly="readonly" value="<?php  echo $date; ?>"  
			   style="width:100%; font-size:11px;  background-color:#fff; text-align:left; font-weight:bold; border:0px; text-align:left;"> </td> 
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#fff;"> <select name="Toaccount" class="form-control"  required="required"   
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#fff;"><input type="text" name="Throughonetitle" id="Throughonetitle" required="required" 
               value="<?php  echo $desc; ?>"  
			   style="width:100%; font-size:11px;  background-color:#fff; text-align:left; font-weight:bold;  border:0px; text-align:left;"> </td> 
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;" width="100%"> 
        ...
        <td style="width:70%;border:0px;background-color:#fff;"><input type="text" name="Title" id="Title" value="<?php  echo $Title; ?>" readonly="readonly"
				  style="width:100%; font-size:11px; background-color:#fff; text-align:left; font-weight:bold;  border:0px; "> </td>  
              </tr>
			  </table> 
              <?php
...
<?php
 ...
 <?php  $tot = count($dFuelcardname); $s=0; $totals =0;
     ...
     <table width="100%" class="table table-striped table-bordered table-hover" style="margin-top:-20px;">
		...
		<thead> 
		<tr> 
                 <th style="width:40%; border: 0px; text-align:left; background-color:#fff;">ConfirmationDate</th>
                 <td style="width:60%; border: 0px; text-align:right;background-color:#fff;"> 
				 <input type="date" name="Throughoneaccountdate" value="<?php echo date('Y-m-d'); ?>" required="required"
                 style="width:100%; font-weight:normal; background-color:#fff; text-align:left; font-weight:normal; border:0px; " /> </td>   
			 </tr>             
             </table>    
		...
		<thead> 
		<tr>    
                <th style="width:40%;border:0px; background-color:#fff;">
              ...
              <th style="width:20%;border:0px;background-color:#fff;"><input type="submit" name="button" id="button" value="Save" style="border-radius: 11px; height: 38px;"/></th>   
              </tr>
			  </table>  
              <br />
