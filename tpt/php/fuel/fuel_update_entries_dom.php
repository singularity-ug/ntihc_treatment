 ...
 while($row=$res->fetch_assoc()){
   ...
   <div class="col-sm-3">   
    ...
    <th style="width:40%;">Project</th>         
              <td style="width:60%;"><input type="text" name="DIVISION" id="DIVISION" value="<?php  echo $DIVISION; ?>" required="required"   
    ...
    style="width:100%; text-align:left;background-color:#fff;height:22px;">
                  ...
                  <option>FIN AND ADMIN">ED'S OFFICE</option>
...
?>   
    ...
    <td style="width:60%;"><input type="text" name="PURPOSE" id="PURPOSE"  value="<?php  echo $PURPOSE; ?>"  
    required="required"   
    style="width:100%; text-align:left;background-color:#fff; height:22px;"> 
    </td> 
    </tr>
