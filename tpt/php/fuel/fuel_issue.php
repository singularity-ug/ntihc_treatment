 ...
 $sql  = "SELECT * FROM getentrant ORDER BY id DESC LIMIT 1";
  ...
  while($row=$res->fetch_assoc()){ 
    ...
    <th style="width:40%;">Project</th>         
              <td style="width:60%;"><input type="text" name="DIVISION" id="DIVISION" required="required"   
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;" width="100%"> 
    ...
    <td style="width:60%;"><textarea name="PURPOSE" id="PURPOSE"  value="<?php  echo $PURPOSE; ?>"  
    required="required"   
    style="width:100%; text-align:left;background-color:#fff; height:22px;"> </textarea>
    </td> 
    </tr>
    </table> 
