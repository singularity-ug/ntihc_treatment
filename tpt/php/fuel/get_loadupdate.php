...
function myFunction() {
    window.print();
        ...
        <form class="form-horizontal" action="fuel/get_loadupdate_process.php" method="POST" style="height:auto; font-weight:normal; background-color:#f9f9f9;">
         <div class="col-sm-12"> 
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#f9f9f9;"> KCCA/AHR/FTL/<?php  echo $purchaseid; ?>/<?php  echo $Yearval; ?>/<?php  echo $Monthno; ?> </td> 
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#f9f9f9;"><?php  echo $date; ?>  </td> 
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#f9f9f9;">   <input type="text" name="Toapprover" id="Toapprover" required="required" 
               value="<?php  echo $desc; ?>"  
			   style="width:100%; font-size:11px; background-color:#f9f9f9; text-align:left; text-align:left;"> </td> 
		...
		<tr> 
               ...
               <td style="width:70%;border:0px;background-color:#f9f9f9;"> <?php echo $brow['Throughonetitle']; ?> </td>  
			</tr>             
            </table>         
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;" width="100%"> 
        ...
        <td style="width:70%;border:0px;background-color:#f9f9f9;">  <?php echo $brow['Title']; ?>  </td>  
              </tr>
			  </table> 
        ...
        <td style="width:70%;border:0px;background-color:#f9f9f9;"> <b style="font-size:12px;">Request for loading of fuel cards worth UGX <?php echo number_format($brow['total'],2); ?> shillings</b> </td>  
              </tr>
			  </table>     
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		<thead> 
		<tr> 
   <th style="width:50%;border:0px; background-color:#f9f9f9;">Authoriser's comment</th>
   <th style="width:50%;border:0px;background-color:#f9f9f9;">Approver's comment</th>
   </tr>
   </thead>
   <tbody>
   <tr>
   <td style="width:50%;border:0px;background-color:#f9f9f9;"><textarea name="Throughonecomment"  readonly="readonly" 
   style="width:100%; text-align:left;background-color:#f9f9f9;border:0px; "> <?php echo $brow['Throughonecomment']; ?> </textarea> </td>
  
   <td style="width:50%;border:0px;background-color:#f9f9f9;"><textarea name="Toaccountcomment" id="Toaccountcomment"  required="required"
  ...
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		<thead> 
		<tr>   
   <td style="width:50%;border:0px;background-color:#f9f9f9;">&nbsp; &nbsp;<?php echo $brow['Throughoneaccountdate']; ?>  </td>
  ...
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	border: 0px;text-align:left;" width="100%">
		<thead> 
		<tr>   
   <td style="width:50%;border:0px;background-color:#f9f9f9;"> </td>
    
  <th style="width:25%;border:0px;background-color:#f9f9f9;">
  ...
  <th style="width:50%;border:0px;background-color:#f9f9f9;"> <input type="submit" name="button" id="button" value="Save" style="border-radius: 11px; height: 38px;"/> </td> 
   </tr> 
 </tbody>
 </table>                          
