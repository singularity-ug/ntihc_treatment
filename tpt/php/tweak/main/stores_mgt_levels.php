...
<div class="container-fluid">
	...
	<div class="contentheader">
			...
			<ul class="breadcrumb">
            <i class="icon-table"></i> Stock levels &nbsp;&nbsp;
			<li><a href="stores_mgt_levels.php">Stock levels</a></li> &nbsp; &nbsp;
			<li><a href="issue_stock.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i> Issue stock</a>  </li>    
             
			</ul>


<div style="margin-top: -19px; margin-bottom: 21px;">
<a  href="../../stores_mgt.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
			<?php 
			include('../connect.php');
