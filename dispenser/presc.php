   ...
   <table class="table-responsive" style="margin-top:0px;">
            <table class="table" style="border:0px;">
              <tr> 
				...
				<th style="width:30%;border:0px solid #ECF0F5;"> <input type="text" id="SERVICE_EPISODE" name="SERVICE_EPISODE"  
				required="required" style="width:100%; font-weight:normal; background-color:#fff;">   </th>   
...
?>
            ...
            <table class="table" style="border:0px;">
              <tr> 
				...
				<th style="width:80%;border:0px;"> <textarea id="RECOMMENDEDDRUGS" name="RECOMMENDEDDRUGS" readonly="" 
            ...
            <table class="table" style="border:0px;">
              <tr> 
				...
				<th style="width:30%;border:0px;"> <input type="text" id="USERINITIAL" 
          name="USERINITIAL" style="width:100%; font-weight:normal; background-color:#fff;"> </th>   
