...
<div class="wrapper" style="background-color: #000;">
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
      ...
      <table class="table-responsive" style="margin-top:-7px;"> 
            <table class="table"  style="border:0px;">
              <tr>  
                 <th style="width:86%; text-align:left;border:0px; text-align:right;">ORDER VALUATION</th>
                <td style="width:14%;border:0px;"><input type="numeric" name="ORDERVALUE" id="ORDERVALUE"  value="<?php  echo $totals; ?>" 
