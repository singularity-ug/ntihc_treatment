      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
       ...
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href=<button class="button 5" data-toggle="modal"  data-target="#notifx" 
            style="height: 33px; border-radius: 4px; padding: 6px 9px; margin-top: 10px;"></button>Generate new store requisition </span></a></li>
             
             <li><a href="../admin/proc/stores_mgt.php" 
            style="height: 33px; border-radius: 4px; padding: 6px 9px; margin-top: 10px;"></button>Stores dashboard</span></a></li> 
          </ul>
      </div>
      <!-- Navbar Right Menu -->
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        <li class="header" font style=" font:bold 15px 'Aleo'; text-shadow:1px 1px 15px #000; color:#fff;">MAIN NAVIGATION</li>
          ...
          <li>
          <a href="store_orders.php" class="button5" style="height: 33px; border-radius: 0px; padding: 6px 9px; margin-top: 10px; color:#fff;">
            <i class="fa fa-th"></i>  <span style="color:#fff;"> Pending confirmations </span>
...
?>    </small>
          ...
          <li>
          <a href="inc_approvals.php"  class="button5" style="height: 33px; border-radius: 0px; padding: 6px 9px; margin-top: 10px; color:#fff;">
            <i class="fa fa-th"></i> <span style="color:#fff;"> My pemding approvals</span>
            <span class="pull-right-container">
              <small class=" "> 
               <?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
?>     
         ...
         <li>
          <a href="inc_confirm.php"  class="button5" style="height: 33px; border-radius: 0px; padding: 6px 9px; margin-top: 10px; color:#fff;">
            <i class="fa fa-th"></i> <span style="color:#fff;"> Unclassified approvals</span>
            <span class="pull-right-container">
              <small class=" "> 
               <?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
?>     
          ...
          <li>
          <a href="inc_viewall.php"  class="button5" style="height: 33px; border-radius: 0px; padding: 6px 9px; margin-top: 10px; color:#fff;">
            <i class="fa fa-th"></i> <span style="color:#fff;"> Approved requisitions</span>
            <span class="pull-right-container">
              <small class=" ">  </small>
            </span>
          </a>
    ...
    <section class="content">
      <div class="row">
        <div class="col-xs-12">
         ...
         Store requisitions due for confirmation</p> </center> 
         <p></p>
           ...
           <tfoot>
            <tr>
             ...
             $result = mysqli_query($mysqli, "SELECT TIMESTAMP,ORDERSERIALID,REQBYNAME,REQUESTINGUNIT,FACILITYNANE,APPROVAL,REQBY,
			  AMOUNT, SUM(AMOUNT),ORDERTYPE,CONFIRMATIONOFREQUEST,DATECREATED
			  FROM outgoingorders WHERE REQUISTIONTYPE ='STANDARD' AND CONFIRMATIONOFREQUEST = 'PENDING'
			  GROUP BY ORDERSERIALID ORDER BY DATECREATED ASC");
       ...
       <br>
        <table class="table-responsive" style="margin-top:-10px;"> 
            <table class="table"  style="border:0px;">
			  ...
			  <th style="width:20%; text-align:left;border:0px;">Requesting / Usage unit </th>
