        ...
        <table class="table-responsive" style="margin-top:-10px;"> 
            ...
            <table class="table" style="border:0px;">
			  ...
			  <th style="width:13.25%; text-align:left;border:0px;">Facility name</th>
                ...
                <td style="width:14.75%"> <input type="text" name="REQUISTIONTYPE" id="REQUISTIONTYPE"  value="<?php  echo $REQUISTIONTYPE; ?>"  
				style="width:100%; text-align:left;background-color:#fff;"></td> 
            ...
            <table class="table"  style="border:0px;">
              <tr> 
               <th style="width:71%; text-align:left; border:0px;"> </th>
                ...
                <td style="width:14.75%"><input type="numeric" name="ORDERVALUE" id="ORDERVALUE"  value="<?php  echo $totals; ?>" 
