...
<body class="hold-transition skin-blue sidebar-mini" style="background-color:#fff;">   
 ...
 $sql  = "SELECT NTIHCNO,FIRSTNAME,LASTNAME,SCHOOLINGSTATUS,SEX, PID,AGE,CURDATE(), TIMESTAMPDIFF(YEAR,AGE,CURDATE()) AS age FROM cmpatientsnewregistration
  ...
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
   ...
   <td style="width:33.3333%; border: 1px;">  <a href="../index.php">
    ...
    <img src="../assets/img/ntihclog2.png"width="90" height="100" style="border: 0px;">  
    </td>
   ...
   <center style="color:#000; font-weight:bold; font-size:12px;">DISPENSARY</center> 
     </td> 
...
include_once("../php/configpatientmgtdb.php"); 
    ...
    $date = date("Y-m-d").' 00:00:00';
           ...
           .'______'.$row['RECOMMENDEDDRUGS'].'______'.$row['USERINITIAL'].'______'.$row['REQUESTINGUNIT']. '" value="Dispense"  onclick="getClient(this.id)">' . "</td>".
                 "</tr>";
                   }
                     }
                     $st = $st.' </tbody>
...
$.ajax({
   ...
   var s = data.split("______");
      ...
      <div class="col-md-7">
          <div class="box box-primary" style="border:0px; text-align:left;background-color: transparent;">  
     ...
     <form class="form-horizontal" method="post" action="update_dispenser.php" style="height:auto; background-color:transparent;">  
      ...
      <table class="table-responsive" style="margin-top:0px;">
        ...
        required="required" style="width:100%; font-weight:normal; background-color:#fff;">  </th> 
                ...
                <th style="width:15%;border:0px solid #ECF0F5;">  </th>
        <th style="width:30%;border:0px solid #ECF0F5;"> <input type="hidden" id="SERVICE_EPISODE" name="SERVICE_EPISODE" required="required" 
        required="required" style="width:100%; font-weight:normal; background-color:#fff;">   </th>   
      ...
      <th style="width:10%;"> PERIOD  </th>
          ...
          <th class="hidden" style="width:10%;"> COST </th>
                              </tr>
                              </thead>
                              <tbody id="tablebody">
                                <tr id="1_rowdata" >
                               ...
                               <td class="hidden" ><input type="numeric" name="UNITRATE" id="UNITRATE" required="required" 
                               style= ' width:100%; background-color:#fff;'/>
     ...
     style="width:100%; font-weight:normal; background-color:#fff;">
        ...
        required="required" style="width:100%; font-weight:normal; background-color:#fff;"> </th>    
            ...
            <center>  
                ...
                </button>  Add new drug<span class="sr-only">(current)</a>
                </span></a---> 
               </center>
                    </form> 
       ...
       <div class="clearfix visible-sm-block"></div>  
         ...
         <div class="col-lg-3 col-xs-6">
          ...
          </i> <center>New&nbsp;orders</center><i class=" "></i><p></p>
...
?>    
   ...
   <div class="col-lg-3 col-xs-6">
      ...
      </i><center>Dispensed</center> <i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          <?php
$link = mysqli_connect("localhost", "root", "toor2", "patientmgt");
...
?>     
  ...
  <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfs"></button></i><center>
      Expiry alerts</center> <i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          0 
          <p/></center></a> 
          </div></div>  
   ...
   <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfs"></button>
      </i><center>drug levels</center> <i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          0 
          <p/></center></a> 
          </div></div>  
  ...
  <div class="col-sm-12">  
  <a href="drugs_mgr.php"><br>
       <center><img src="../database icons/switchb1.png" width="100" height="100" class="img-circle" data-toggle="tooltip" title="Refresh" 
     style="border: 6px solid #ecf0f5; height:60px; width:50px;"> 
      </center>    </a> 
        </div> 
