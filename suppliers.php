                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="">SERVICE PROVIDERS MANAGEMENT</a></li> 
                                    <li class='dropdown '>
...
<div class="row">
	...
	<div class="box">
      ...
      <!--start accordion-->
      <!-- start tabs -->  
<div id="accordion" style="width:1310px; margin-top:30px;"> 
	<h3>SERVICE PROVIDERS REGISTER BY CATEGORY</h3>
	<div>
       
<div id="tabs" style="width:1285px; margin-left:-6px;">
	<ul>
		<li><a href="#tabs-1">Vendors</a></li>
		<li><a href="#tabs-2">Funders</a></li>
...
<!-- end tabs -->                                 
 ...
 <h3>Supplier accounts</h3>
	...
	<h3>Suppliers payments tracker</h3>
	<div>
