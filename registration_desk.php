...
<body class="hold-transition skin-blue sidebar-mini" style="background:url(assets/img/pattern/4326703-white-background-wallpapero.jpg);">
  ...
  <br>
   ...
   <center style="color:#000; font-weight:bold; font-size:12px;font:bold 13px 'Aleo'; text-shadow:1px 1px 4px #000; color:#fff;">REGISTRATION DESK</center><BR> 
    ...
    <td style="width:10%; border: 1px;">  
     ...
     <thead> 
     <tr>
               <th style="width:40%; border:0px;background-color:transparent; font-size:11px;">NTIHC No.  </th>
               <td style="width:60%;border:0px;background-color:transparent;">
               <input type="numeric" onKeyUp="domee(this)" name="NTIHCNO" id="NTIHCNO"  value="<?php echo $NTIHCNO; ?>" required="required" autocomplete="off" 
                 placeholder="Search client " style="width:100%; background-color:transparent; text-transform:uppercase; font-size:10px;">   </td> 
                ...
                <table border="1" cellpadding="4" cellspacing="0" 
                style="font-family: arial; font-size: 12px; border:0px;text-align:left;margin-top:5px;background-color:transparent;" width="100%"> 
     <thead> 
     <tr>
               <th style="width:40%;  border:0px;background-color:transparent;">Client name </th>
               <td style="width:60%;border:0px;background-color:transparent;">
                <input type="text" name="CNAME" id="CNAME" value="<?php echo $LASTNAME; ?> <?php echo $FIRSTNAME; ?>" readonly="readonly" 
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <input type="text" name="AGE1" id="AGE" value="<?php echo $AGE; ?>"  readonly="readonly" 
     ...
     <tr>
               ...
               <input type="text" name="USERINITIAL"  id="USERINITIAL" value="<?php echo $nameofuser; ?>" readonly="readonly"  
     ...
     <tr>
               ...
               <td style="width:60%;border:0px; background-color:transparent;">
               <select name="SERVICETYPE" id="cboOptions" onChange="showDiv('div',this)" required="required"  
          ...
          <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;margin-top:5px;" width="100%"> 
          <thead>   <tr>
              <th style="width:40%; border:0px;background-color: transparent;color:#d70000;">Select MHS</th>
              <td style="width:60%;border:0px;background-color:transparent;">
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <input type="text" name="VISTTYPE" id="REVEXT" value="<?php echo $VISTTYPE; ?>" readonly="readonly" 
               style="font-size:10px; width:100%; background-color:transparent;"/> 
            </td>
            </tr>             
            </table>    
 ...
 <div class="panel-body" style="font-weight: normal; width: 100%;   
    ...
    <thead> 
    <tr> 
             <th style="width:39%; text-align:left; border:0px;">  <strong>Clients&nbsp;due for&nbsp;Medical</strong></th>
       <th style="width:10%; text-align:left; border:0px;">   
       <b style="text-align:center; font-size:40px; color:#fff; font-size: 15px;border-radius: 11px;" class="button 5"> 
       <?php 
    ...
    <?php echo $rowcount11;?>
       ...
       <th style="width:39%; text-align:left; border:0px;"><strong>Pending for M.H.Services</strong>  </th>
       <th style="width:10%; text-align:left; border:0px;">  
       <b style="text-align:center; color:#fff; font-size:40px;font-size: 15px;border-radius: 11px;" class="button 5">
        <?php 
      include('client_medical_conn.php');
      $date = date("Y-m-d").' 00:00:00';
        $result = $db->prepare("SELECT * FROM cmpatientsregistration WHERE TIMESTAMP >='$date'
 AND SERVICETYPE ='PREGNANCY RELATED SERVICES' AND INSVCSTATUS ='NO'
    ...
    <thead> 
    <tr> 
             <th style="width:39%; text-align:left; border:0px;">  <strong>Due for counselling services</strong></th>
       <th style="width:10%; text-align:left; border:0px;">   
       <b style="text-align:center; color:#fff; font-size:40px;font-size: 15px;border-radius: 11px;" class="button 5"> 
       <?php 
      include('client_medical_conn.php');
    ...
    <?php echo $rowcount13;?>
       ...
       <th style="width:2%; text-align:left; border:0px;">  </th>
       <th style="width:39%; text-align:left; border:0px;"><strong>Due for other services</strong>  </th>
       <th style="width:10%; text-align:left; border:0px;">  
       <b style="text-align:center; color:#fff; font-size:40px;font-size: 15px;border-radius: 11px;" class="button 5">
        <?php 
      include('client_medical_conn.php');
 ...
 <table id="example" class="table table-tabled table-bordered" style="font-weight:normal; font-size:9px; width:100%;">
        <thead>
        <tr> 
...
$result = mysqli_query($mysqli, "SELECT * FROM  cmpatientsnewregistration 
  ...
  $dts = $res['PID']."***".$res['NTIHCNO']."***".$res['FIRSTNAME']." ".$res['LASTNAME']."***".$res['AGE1'];
    ...
    ?>
         ...
         <div class="col-sm-11" style="background-color:transparent;">
           <br><br>
         <div class="panel-body">
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;background-color:transparent;" width="100%">
    <thead> 
    <tr> 
      <th>SERVICE DATE</th>
  ...
  <tbody>  
          ...
          <center> <script type="text/javascript" src="admin/cpane/js/gauge.js"></script> <a href="admin/index.php">
          <canvas id="canvas" width="300" height="300" style="margin-left: 55px; margin-top:-20px; height:120px; width:100px;" data-toggle="tooltip" title="Logout"> </canvas></a>
          </center> 
...
<img src="assets/img/logs.PNG" width="100%" height="100%">
          ...
          <center> <legend style="color:#000; font-weight:bold;font-size:10px;"> NEW CLIENT DEMOGRAPHY </legend> </center> 
      ...
      <tr> 
         ...
         <input type="date" name="DATECREATED"  id="DATECREATED" value="<?php echo date('d-m-y'); ?>" required=""
        style="text-transform: uppercase; width:100%; background-color:transparent;" /></th>
    ...
    <tr> 
         ...
         <select id="SEX" name="SEX" required="required"
           ...
           <th style="width:18%; border:0px;background-color: transparent;">Tribe </th>
           <th style="width:1%; text-align:right; border:0px;">*</th>
           <th style="width:1%; text-align:right; border:0px;"></th>
               <td style="width:28%;border:0px;background-color:transparent;">
               <select name="TRIBE" required="required" onChange="showDiv2('div',this)"    
               style="font-size:10px; width:100%; background-color:transparent;"/>
    ...
    <tr> 
          ...
          <th style="width:1%; text-align:right; border:0px;">*</th>
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;"> <input type="date" name="AGE" onSelect="agecalc()" onChange="agecalc()"  id="datepicker1"  
          required="required" style="background-color:transparent; width:100%;"/>
                 </th>
...
<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;border: 0px;" width="100%">
    ...
    <tr> 
          ...
          <th style="width:1%; text-align:right; border:0px;">*</th>
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;"><select id="SCHOOLINGSTATUS" name="SCHOOLINGSTATUS"  required=""
                   style="text-transform: uppercase; width:100%;background-color:transparent;" />
            <option>  </option>
        ...
        <th style="width:2%; text-align:left; border:0px;">  </th>
         ...
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;">
         <select id="HIGHESTLEVELOFEDUCATION" name="HIGHESTLEVELOFEDUCATION"  required="required" 
                        style="text-transform: uppercase; width:100%;background-color:transparent;" />
                                <option>  </option>
                                <option>NONE</option>
    ...
    <tr> 
         ...
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;">
           <select name="RELIGION" required="" id="cboOptions" onChange="showDiv3('div',this)"  
            style="text-transform: uppercase;width:100%;background-color:transparent;" />
    ...
    <thead> 
    <tr> 
                 <th style="width:18%; text-align:left; border:0px;">Employment status </th>
          <th style="width:1%; text-align:right; border:0px;">*</th>
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;"> 
         ...
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;">
          <select name="DISTRICT" required="required" id="cboOptions" onChange="showDiv4('div',this)"
                   style="text-transform: uppercase;width:100%;background-color:transparent;" />
    ...
    <tr> 
        ...
        <th style="width:2%; text-align:left; border:0px;">  </th>
         ...
         <th style="width:20%; text-align:left; border:0px;color:#d70000;">Division</th>
                 <th style="width:28%; text-align:left;border:0px;">
...
<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;border: 0px;" width="100%">
    ...
    <tr> 
         ...
         <th style="width:1%; text-align:right; border:0px;"></th>
                 <th style="width:28%; text-align:left;border:0px;"> 
         <input type="text" name="MOTHERFIRSTNAME" id="MOTHERFIRSTNAME"  required="required" style="text-transform: uppercase;width:100%;background-color:transparent;"/>
                    <input type="hidden" name="MOTHERLASTNAME"  id="MOTHERLASTNAME" style="text-transform: uppercase;background-color:transparent;"/>                 
            </th>
         ...
         <th style="width:20%; text-align:left; border:0px;">Father's name</th>
                 <th style="width:28%; text-align:left;border:0px;">
          <input type="text" name="FATHERFIRSTNAME" id="FATHERFIRSTNAME" style="text-transform: uppercase;width:100%;background-color:transparent;" />
                  <input type="hidden" name="FATHERLASTNAME"  id="FATHERLASTNAME"  style="text-transform: uppercase;" />
         </th> 
           </tr>    </table>  
...
<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;border: 0px;" width="100%">
    ...
    <tr> 
         ...
         <th style="width:1%; text-align:right; border:0px;"></th>
         <th style="width:28%; text-align:left;border:0px;">
         <select name="HEAREDABOUTNTIHC" id="cboOptions" onChange="showDiv5('div',this)"
         required="required" style="text-transform: uppercase; width:100%;background-color:transparent;"/> 
    ...
    <tr> 
      ...
      <thead> 
      <tr> 
                 <th style="width:20%; text-align:left; border:0px;"> Service provider </th>
                 <th style="width:28%; text-align:left;border:0px;">
          <input type="text"  name="REGISTEREDBY"  id="REGISTEREDBY" value="<?php echo $nameofuser; ?>"
          readonly="readonly" style="background-color:transparent; width:100%;"/>
                 </th>
        ...
        <th style="width:28%; text-align:left; border:0px;"><input type="submit" name="button" id="button" value="Save demography" /> </th>
		
        <th style="width:20%; text-align:left;border:0px;">
		<a href="clients/regn_plain_form.php" class="btn btn success" style="border: 1px solid;">Print</a> 
