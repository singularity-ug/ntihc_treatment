  ...
  <div id="work" style="width:95%;">
    ...
    <table id="example" class="table table-striped table-bordered"  style="font-size:80%; font-weight: bold;" cellspacing="0" width="100%">
        ...
        <tr>
            ...
            <td><input type="button" class="btn btn-danger"  style="font-size:13px;"value=" - Delete">
        ...
        <tr>
            ...
            <td><div class="progress" style="">
                   <div class="progress-bar progress-bar-danger progress-bar-striped active" role="progressbar"  aria-valuenow="25"
                    aria-valuemin="0" aria-valuemax="100" style="width:25%">25% IN</div>
                </div>
            </td>
            <td> 02-08-2017</td>
            <td>OK</td>
