...
<div class ="container-fluid" style="width:100%; height:100%; border: 1px #e4e4e4 solid;border-radius: 4px;  margin-top:77px;">
                                      ...
                                      <tr>
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                              <input id="fname" name="fname" value="<?php echo $names[0];?>" class="form-control input-md" type="text">
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <td>  <!-- Text input-->
                                          ...
                                          <div class="form-group">
                                            <label class="col-md-4 control-label" for="vehicletype">Sur Name:</label>
                                            <div class="col-md-8">
                                              <input id="family_name" name="family_name" value="<?php echo $names[1];?>" class="form-control input-md" type="text">
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <option <?php if ($dept=='IT(INFORMATION TECHNOLOGY)') { echo 'selected="selected"';   } ?>>ADVOCANCY AND RESEARCH</option>
                                                ...
                                                <option <?php if ($dept=='ADMIN') { echo 'selected="selected"';   } ?> >ADMIN</option>
                                      ...
                                      <tr>
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                              <input id="lmgr" name="lmgr" onKeyUp="searchmgr(this.value)" placeholder="Like: Denis Bukenya" class="form-control input-md" type="text">
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                              <input id="oksh" name="oksh" placeholder="Like: Renne Nyange" class="form-control input-md" type="text">
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            <label class="col-md-4 control-label" for="jg">NTIHC Grade:</label>
                                            <div class="col-md-8">
                                              <input id="job_grade" name="job_grade" placeholder="Like: scale 6" class="form-control input-md" type="text">
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <select name="contract_type" id="contract_type" required="required" class="form-control"/>
                                                       <option> </option>
  ...
  <div id="searchdiv" class="form-group" style="margin-left:0%; width:40%; margin-top:-3%;"></div>
                      ...
                      <div class="col-md-12">
                           ...
                           <br>
                              <div class="col-md-8">
                              <br>
                               <p style="text-align:left;">Before completing this section make sure you nd your manager have discussed the <b>Strategy</b></p> 
                             </div>
                             <div class="col-md-6">
                                ...
                                <table id="dataTable2" class="table table-bordered" border="1">
                                       <thead>
                                             <tr  style="color:#000;">
                                                  ...
                                                  <td> <input  name="acaa[]" type="alphanumeric" required="required" class="form-control input-md" style= "width:100%; "/></td>
                                                  <td> <input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)" name="self[]" type="number" required="required" style= "width:30%; height: 34px; text-align: center; "/>
                                                       <input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)" name="sup[]" type="number" required="required" disabled=""   style= "width:30%; height: 34px; text-align: center;"/>|
                                                       <input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)" name="agr[]" type="number" required="required" disabled=""  style= "width:31%; height: 34px; text-align: center;"/>
                                                 </td>
                                              </tr>
                                       </tbody>
                                </table>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)"  name="r1[]" type="alphanumeric" disabled=""  style= "width:100%; "/>
                                </td>
                          <td><input type="alphanumeric" required="required"   disabled=""     name="c1[]" class="form-control input-md" style= "width:100%; "/></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)"  name="r1[]" type="alphanumeric" disabled=""  style= "width:100%; "/>
                          </td>
                          <td><input type="alphanumeric" required="required"  disabled=""       name="c1[]"  class="form-control input-md" style= "width:100%; "/></td>
                        </tr>
                      ...
                      <tr>
                        ...
                        <td><input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)"  name="r2[]" type="alphanumeric" disabled=""  style= "width:100%; "/>
                        </td>
                        <td><input type="alphanumeric" required="required"  disabled=""      name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input onKeyUp="calcOnkeyup(this)" onChange="calcOnkeyup(this)" name="r2[]" type="alphanumeric" disabled=""  style= "width:100%; "/> </td>
                        <td><input type="alphanumeric" required="required"  disabled=""     name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                                ...
                                <tbody>
                                       <tr >
                                           <td>Career aspirations expressed by appraisee :
                                             <input type="alphanumeric" name="aspirations" required="required" class="form-control input-md" style= "width:100%; "/></td>
                                       </tr>
                            ...
                            <div class="col-md-12">
                              <table id="dataTable3" class="table table-bordered" border="1">
                                     ...
                                     <tbody>
                                            ...
                                            <tr >
                                                <td>Date : <input type="text" name="d1" VALUE="<?php  echo date('Y-m-d'); ?>" /></td>
                                                <td>Date : <input type="text" name="d2"/></td>
                                                <td>Date : <input type="text" name="d3"/></td>
                                            </tr>

                                            <tr >
                                                <td>OVERALL PERFORMANCE RATING:
                                                  <input  type="text"   name="o_self1"  id="o_self1"  value=""   style="width:100%;" />
                                                  <input  type="hidden" name="o_self"   id="o_self"   value=""   style="width:100%;" />
                                                  ...
                                                  <input  type="hidden" name="username"  value="<?php echo $nameofuser; ?>"   style="width:100%;" />
                                                </td>
