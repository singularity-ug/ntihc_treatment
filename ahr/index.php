    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form role="form" action="authenticate.php" method="POST" style="font-size:17px;";>
          <fieldset>
            <div class="row">
              <div class="center-block"> <img class="profile-img" src="imgs/ntihclog2.png" width="154" height="160"class="img-responsive" alt=""> </div>
              <hr>
            </div>
            <div class="row">
              <div class="col-sm-12 col-md-10  col-md-offset-1 ">
                ...
                <label>User account:</label>
                  <div class="input-group"> <span class="input-group-addon"> <i class="glyphicon glyphicon-user"></i> </span>
                    <input class="form-control" style="height:30px;" placeholder="Username"  name="loginname" type="text" required="" autofocus>
                  </div>
                </div>
                <div class="form-group">
                 <label>Password:</label>
                  <div class="input-group"> <span class="input-group-addon"> <i class="glyphicon glyphicon-lock"></i> </span>
                    <input class="form-control" style="height:30px;" placeholder="Password" name="password" type="password" required=""  value="">
                  </div>
                </div>
