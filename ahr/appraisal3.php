...
exit();
 ...
 $x=1;
  while($row=$res->fetch_assoc()){
     ...
     $sup = json_decode($row['sup']);
     $agr = json_decode($row['agr']);
     $r1 = json_decode($row['r1']);
     $c1 = json_decode($row['c1']);
     $r2 = json_decode($row['r2']);
     $c2 = json_decode($row['c2']);
      ...
      <div class="col-sm-12">
                    <form role="form" action="process_appraisal2.php" method="post" class="registration-form">
                        <fieldset>
                         <p style="text-align:center; font-weight:bold; font-size:20px;" >
                           NAGURU TEENAGE INFORMATION AND HEALTH CENTRE </p>
                          <div class="col-md-12">
                              <h3>Step 1 / 3</h3>
                                      ...
                                      <tr>
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                              <input id="fname" disabled="" name="fname" value="<?php  echo $fname; ?>" placeholder="eg Sofie" class="form-control input-md" type="text">
                                            </div>
                                          </div>
                                        </td>
                                        ...
                                        <td>  <!-- Text input-->
                                          <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <option <?php if ($dept=='Marketing') { echo 'selected="selected"';   } ?> >Marketing</option>
                                                </select>
                      ...
                      <div class="col-md-12">
                           <div class="col-md-6">
                             ...
                             <div class="col-md-6">
                               <h1 id="totals"><?php echo $o_agreed; ?> </h1>
                             </div>
                              </div>
                           ...
                           <div class="col-md-12" >
                               <p>
                                      <input type="button" disabled="" value="Add Item" onClick="addRow('dataTable2');" />
                                      <input type="button" disabled="" value="Remove"   onClick="deleteRow('dataTable2');"   />
                               </p>
                                ...
                                <table id="dataTable2" class="table table-bordered" border="1">
                                       <thead>
                                             <tr  style="color:#000;">
                                                  ...
                                                  <td> <input  name="self[]" disabled="" type="text" value="<?php echo $self[$s]; ?>" style= "width:30%; "/>
                                                       <input  name="sup[]" disabled="" type="text" value="<?php  echo $sup[$s]; ?>"   style= "width:30%; "/>|
                                                       <input  name="agr[]" disabled="" type="text" value="<?php  echo $agr[$s]; ?>"   style= "width:31%; "/>
                                                 </td>
                                                            </tr>
                                              <?php } ?>
                                       </tbody>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <input disabled="" value="<?php  echo $r1[0]; ?>"  name="r1[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                                </td>
                          <td><input disabled="" type="alphanumeric" value="<?php  echo $c1[0]; ?>"    name="c1[]" class="form-control input-md" style= "width:100%; "/></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><input disabled="" value="<?php  echo $r1[1]; ?>"  name="r1[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                          </td>
                          <td><input disabled="" type="alphanumeric"  value="<?php  echo $c1[1]; ?>"      name="c1[]"  class="form-control input-md" style= "width:100%; "/></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><input disabled="" value="<?php  echo $r1[2]; ?>"  name="r1[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                            </td>
                          <td><input disabled="" type="alphanumeric" value="<?php  echo $c1[2]; ?>"     name="c1[]" class="form-control input-md" style= "width:100%; "/></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td><input disabled="" value="<?php  echo $r1[3]; ?>"  name="r1[]" type="alphanumeric"  style= "width:100%; height: 34px;"/>
                          </td>
                          <td><input disabled="" type="alphanumeric" value="<?php  echo $c1[3]; ?>"     name="c1[]" class="form-control input-md" style= "width:100%; "/></td>
                        </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[0]; ?>"  name="r2[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                        </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[0]; ?>"  name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[1]; ?>"  name="r2[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                          </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[1]; ?>"  name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[2]; ?>"  name="r2[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                        </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[2]; ?>"   name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[3]; ?>"  name="r2[]" type="alphanumeric"   style= "width:100%; height: 34px;"/>
                            </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[3]; ?>"  name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[4]; ?>"  name="r2[]" type="alphanumeric"  style= "width:100%; height: 34px;"/>
                        </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[4]; ?>"   name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[5]; ?>" name="r2[]" type="alphanumeric"   style= "width:100%; height: 34px;"/> </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[5]; ?>"       name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><input disabled="" value="<?php  echo $r2[6]; ?>"  name="r2[]" type="alphanumeric"   style= "width:100%; height: 34px;"/> </td>
                        <td><input disabled="" type="alphanumeric" value="<?php  echo $c2[6]; ?>"      name="c2[]" class="form-control input-md" style= "width:100%; "/></td>
                      </tr>
                    ...
                    <center>  <button type="button" class="btn btn-next btn-info"> NEXT SECTION >>>>> </button> </center>
                      ...
                      <fieldset>
                        ...
                        <div class="col-md-12" >
                          <p>
                                 <input type="button" disabled="" value="Add Item" onClick="addRow('dataTable3')" />
                                 <input type="button" disabled="" value="Remove" onClick="deleteRow('dataTable3')"   />
                          </p>
                                ...
                                <tbody>
                                       ...
                                       <tr >
                                           <td>Comments by the appraiser :
                                             <input type="alphanumeric" name="comments"    value="<?php  echo $comments; ?>"  disabled="" class="form-control input-md" style= "width:100%; "/></td>
                                       </tr>
                                </tbody>
                         </table>
                      ...
                      <fieldset>
                            ...
                            <div class="col-md-12">
                              <table id="dataTable3" class="table table-bordered" border="1">
                                     ...
                                     <tbody>
                                            <tr >
                                                <td><textarea disabled="" name="apsr"  cols="50" rows="8"><?php echo $apsr; ?></textarea></td>
                                                <td><textarea disabled="" name="osh" cols="50" rows="8"> <?php echo $oksh; ?>  </textarea></td>
                                                <td><textarea disabled="" name="apse" cols="50" rows="8"><?php echo $apse; ?>  </textarea></td>
                                            </tr>

                                            <tr >
                                                <td>Date : <input type="text" disabled="" name="d1" VALUE="<?php  echo $d1; ?>" /></td>
                                                <td>Date : <input type="text" disabled="" name="d2" VALUE="<?php  echo $d2; ?>" /></td>
                                                <td>Date : <input type="text" disabled="" name="d3" VALUE="<?php  echo $d3; ?>"  /></td>
                                            </tr>

                                            <tr >
                                                <td>OVERALL PERFORMANCE RATING:
                                                  <input  type="text"   disabled="" name="o_self1"  id="o_self1"  value=" <?php echo $o_agreed;?>"   style="width:100%;" />
                                                  <input  type="hidden" name="o_self"   id="o_self"   value=" <?php echo $o_self;?>"   style="width:100%;" />
                                                  <input  type="hidden" name="o_sup"    id="o_sup"    value=" <?php echo $o_sup;?>"  style="width:100%;" />
                                                  <input  type="hidden" name="o_agreed" id="o_agreed" value=" <?php echo $o_agreed;?>"   style="width:100%;" />
                                                  <input  type="hidden" name="username"  value="<?php echo $username; ?>"   />
                                                  <input  type="hidden" name="id"  value="<?php echo $_GET['q']; ?>"   />
                                                </td>
                                                <td>LINE MANAGER : <input disabled="" type="text" VALUE="<?php  echo $lmgr; ?>" style="width:100%;" disabled="" /></td>
                                                <td></td>
                                            </tr>
                                     </tbody>
                            ...
                            <button type="submit" disabled="" class="btn btn-success">Submit Appraisal!</button>
                        </div>
                      </fieldset>
                    </form>
                    </div>
