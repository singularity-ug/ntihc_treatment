...
<table id="example3" class="table table-stripped table-bordered" style="font-weight:normal; font-size:9px; width:100%;">
        <thead>
        <tr> 
		      <th>DATE</th> 
			  <th>NAME</th> 
...
#footer {
 ...
 $sql  = "SELECT * FROM cmpatientsregistration
   ...
   ?>
        ...
        <form class="form-horizontal" action="prescription/presc_process_int.php" method="post" style="height:auto;"/>
