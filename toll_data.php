...
$rm = $_SESSION['MREPEAT']; 
 ...
 <?php
  ...
  $CID = '';  
  $USERINITIAL = '';  
  $HOWDIDYOUKNOABOUTTHISNO = '';  
  $DESCRIPTION = ''; 
  $UPDATEDBY = ''; 
  $ACTIONTAKEN = '';  
  $RECOMMENDEDNEARESTHEALTHCENTRE = '';  
  $REASONFORREFER = '';  
  $SPECIFYSERVICEREFERREDFOR = '';  
 ...
 $sql  = "SELECT * FROM tollfree  WHERE `CALLSERIALNO` = '$id' ";
  ...
  while($row=$res->fetch_assoc()){
   ...
   $HOWDIDYOUKNOABOUTTHISNO = $row['HOWDIDYOUKNOABOUTTHISNO'];  
   $DESCRIPTION = $row['DESCRIPTION']; 
   $UPDATEDBY = $row['UPDATEDBY']; 
   $ACTIONTAKEN = $row['ACTIONTAKEN']; 
   $RECOMMENDEDNEARESTHEALTHCENTRE = $row['RECOMMENDEDNEARESTHEALTHCENTRE'];
   $REASONFORREFER = $row['REASONFORREFER'];  
   $SPECIFYSERVICEREFERREDFOR = $row['SPECIFYSERVICEREFERREDFOR']; 
...
<body class="hold-transition skin-blue sidebar-mini"  style="background:url(assets/img/pattern/4326703-white-background-wallpapero.jpg);">
   ...
   <center style="color:#000; font-weight:bold; font-size:14px;font:bold 14px 'Aleo'; text-shadow:1px 1px 4px #000; color:#fff;">TOLL&nbsp;FREE</center><BR> 
   ...
   <td style="width:25%; border: 1px;"> <a href="admin/index.php"> 
     ...
     <br><br>
        ...
        <div class="col-sm-12"> 
            ...
            <form class="form-horizontal"  method="post" action="tollfree.php" 
     ...
     <tr>
              <th style="width:40%;  border:0px;background-color:transparent;">Call date </th>
               <td style="width:60%;border:0px; background-color:transparent;">
                 <input type="text"  name="DATECREATED"  value="<?php  echo $DATECREATED; ?>"  required="required"
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <input type="numeric" onKeyUp="domee(this)" name="PHONECONTACT" id="PHONECONTACT"  
      ...
      <th style="width:30%; text-align:left; border:0px;"> <input type="text"   name="FIRSTNAME"   id="FIRSTNAME"  
       value="<?php  echo $FIRSTNAME; ?>" style="font-size:10px; width:100%; background-color:transparent; text-transform: uppercase;"></td> 
         </tr>             
         </table> 
      ...
      <th style="width:30%; text-align:left; border:0px;"> <select id="SEX"  name="SEX"  value="<?php  echo $SEX; ?>"
     required="required" 
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <select name="AGE" id="AGE"   value="<?php  echo $AGE; ?>" required="required" 
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <select name="SCHOOLINGSTATUS" id="SCHOOLINGSTATUS" value="<?php  echo $SCHOOLINGSTATUS; ?>" required="required" 
         style="width:100%; background-color:transparent; text-transform: uppercase;" >
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <select name="HIGHESTLEVELOFEDUCATION" id="HIGHESTLEVELOFEDUCATION"  value="<?php  echo $HIGHESTLEVELOFEDUCATION; ?>" required="required" 
         style="width:100%; background-color:transparent; text-transform: uppercase;" >
          <option value="<?php  echo $HIGHESTLEVELOFEDUCATION; ?>"> <?php  echo $HIGHESTLEVELOFEDUCATION; ?> </option>
               <option>NONE</option>
                ...
                <input type="hidden" name="CALLSERIALNO" id="CALLSERIALNO"  value="<?php  echo $CALLSERIALNO; ?>">
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <select name="MARITALSTATUS" id="MARITALSTATUS"   value="<?php  echo $MARITALSTATUS; ?>" required="required" 
         style="width:100%; background-color:transparent; text-transform: uppercase;" >
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
               <select name="EMPLOYMENTSTATUS" id="EMPLOYMENTSTATUS"   value="<?php  echo $EMPLOYMENTSTATUS; ?>" required="required" 
         style="width:100%; background-color:transparent; text-transform: uppercase;" >
     ...
     <tr>
               ...
               <td style="width:60%;border:0px;background-color:transparent;">
            <select name="DISTRICT" id="cboOptions" onChange="showDiv4('div',this)" required="" value="<?php  echo $DISTRICT; ?>"
         style="width:100%; background-color:transparent; text-transform: uppercase;" >
    ...
    <tr>  
         ...
         <select id="DIVISION" name="DIVISION"  value="<?php  echo $DIVISION; ?>" 
      ...
      <tr> 
         ...
         <th style="width:40%; text-align:left; border:0px;color:#d70000;">Specify</th>
                 <th style="width:60%; text-align:left;border:0px;">
         <input type="text" id="OTHERDISTRICTS" name="OTHERDISTRICTS"  value="<?php  echo $OTHERDISTRICTS; ?>"  
    ...
    <thead> 
    <tr> 
                 <th style="width:40%; text-align:left; border:0px;"> Village</th> 
                 <th style="width:60%; text-align:left;border:0px;"> 
           <input type="text" name="PLACEOFRESIDENCEs" id="PLACEOFRESIDENCE" value="<?php  echo $PLACEOFRESIDENCE; ?>"
    ...
    <tr> 
         ...
         <select id="LIVINGWITH" name="LIVINGWITH" value="<?php  echo $LIVINGWITH; ?>"
         required="required" style="text-transform: uppercase;width:100%;background-color:transparent;"/> 
    ...
    <tr> 
                 ...
                 <th style="width:30%; text-align:left;border:0px;">  
         <select name="HEAREDABOUTNTIHC" id="cboOptions" onChange="showDiv5('div',this)" value="<?php  echo $HEAREDABOUTNTIHC; ?>"
         style="text-transform: uppercase; width:100%;background-color:transparent;"/> 
                ...
                <option value="GUARDIAN">GUARDIAN</option>
                                ...
                                <option value="ICE METERIALS">ICE METERIALS</option>
    ...
    <tr> 
         ...
         <th style="width:20%; text-align:left; border:0px; color:#d70000;">Specify</th>
                 <th style="width:30%; text-align:left;border:0px;">
         <input type="text" id="OTHERSOURCESOFINFO" name="OTHERSOURCESOFINFO"   value="<?php  echo $OTHERSOURCESOFINFO; ?>"
                        style="text-transform: uppercase; width:100%;background-color:transparent;" /> 
         </th> 
      </tr>    </table>  
    ...
    <tr>  
         <th style="width:20%; text-align:left; border:0px;"> Heard about phone</th>
                 <th style="width:30%; text-align:left;border:0px;">
         <select id="HOWDIDYOUKNOABOUTTHISNO" name="HOWDIDYOUKNOABOUTTHISNO" value="<?php  echo $HOWDIDYOUKNOABOUTTHISNO; ?>" 
                        style="text-transform: uppercase; width:100%;background-color:transparent;" /> 
                        <option value="<?php  echo $HOWDIDYOUKNOABOUTTHISNO; ?>"><?php  echo $HOWDIDYOUKNOABOUTTHISNO; ?> </option>
                        <option>PEERS</option>
     ...
     <thead> 
     <tr>
               <th style="width:40%;  border:0px;background-color:transparent;">Created by</th>
               <td style="width:60%;border:0px; background-color:transparent; text-transform: uppercase;">
               <input type="text" name="USERINITIAL"  id="USERINITIAL" value="<?php echo $USERINITIAL; ?>" required="required"  
     ...
     <tr>
               ...
               style="background-color:transparent; border:3px soloid;"><?php echo $DESCRIPTION; ?></textarea> 
      </tr>             
            </table> 
               <br> 
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
                         ...
                         <td> <input  name="fqx[]" type="text" value="<?php echo $fqx[$s]; ?>"   
    ...
    <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left; margin-top:5px;" width="100%"> 
     ...
     <tr>       
               ...
               <select name="ACTIONTAKEN" value="<?php  echo $ACTIONTAKEN; ?>" id="cboOptions" onChange="showDiv('div',this)"               required="required"  
               style="font-size:10px;width:100%; background-color:transparent; text-transform: uppercase;">
               ...
               <th style="width:20%;  border:0px;background-color:transparent;">Updated by </th> 
         <th style="width:30%;  border:0px;background-color:transparent;"> 
          <input type="text" name="UPDATEDBY" value="<?php  echo $nameofuser; ?>"  readonly="readonly"  
               style="font-size:10px;width:100%; background-color:transparent; "> </th>
            </td>
            </tr>             
            </table>
     ...
     <tr>
               ...
               value="<?php  echo $RECOMMENDEDNEARESTHEALTHCENTRE; ?>" style="font-size:10px;width:100%; background-color:transparent; text-transform: uppercase;">
                <option value="<?php  echo $RECOMMENDEDNEARESTHEALTHCENTRE; ?>"> <?php  echo $RECOMMENDEDNEARESTHEALTHCENTRE; ?></option>
     ...
     <tr>
               ...
               value="<?php  echo $SPECIFYSERVICEREFERREDFOR; ?>" style="font-size:10px;width:100%; background-color:transparent; text-transform: uppercase;">
                <option value="<?php  echo $SPECIFYSERVICEREFERREDFOR; ?>"><?php  echo $SPECIFYSERVICEREFERREDFOR; ?> </option>
...
<option> ART SERVICES</option> 
     ...
     <tr>
               ...
               style="font-size:10px;width:100%; background-color:transparent; text-transform: uppercase;">
              <?php  echo $REASONFORREFER; ?></textarea>
            </td>
            </tr>             
            </table> 
             
             <br>
             <center><input type="submit" name="button" id="button" value="Update info" 
...
$result = mysqli_query($mysqli, "SELECT * FROM  tollfree WHERE TIMESTAMP >='$date'  
  ...
  echo "<td>".$res['TIMESTAMP']."</td>";   
    ...
    echo "<td><a href=\"toll_data.php?CID=$res[CID]\">Update</a> </td>";  
  }
