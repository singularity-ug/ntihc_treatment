                     ...
                     <div class="panel panel-default" > 
                        <div class="panel-body">
                            <ul class="nav nav-pills">
                                <li class="active"><a href="#home-pills" data-toggle="tab">Notifications</a>
                                </li>
                                <li><a href="#profile-pills" data-toggle="tab">Procurement orders</a>
                                </li>
                                <li><a href="#messages-pills" data-toggle="tab">Petty cash</a>
                                </li>
        ...
        <form method="post" action="pettydebit_process.php">
                                ...
                                <th><label for="BUDGETLINE_EXTENSION" class="label">BUDGETLINE_EXTENSION</label></th>
                                       ...
                                       <tbody id="tablebody" style="width:800px;">
                                        ...
                                        style= "margin-left: 4px; height:20px; margin-top: 17px; width:370px; color:#000000;"/>

                     						       </td>
                     						       <td><input type="numeric" name="VOUCHER_NO" id="VOUCHER_NO" pattern="[0-9]+" required="required"
                                       style= "margin-left: 4px; height:20px; width:74px; color:#000000;"/>
 
                     					         </td>
                     					      	 <td><input type="numeric" name="DEBIT" id="DEBIT" pattern="[0-9]+" required="required"
                                       style= "margin-left: 4px; height:20px; width:65px; color:#000000;"/>

                     		              </td>
                     					        <td><input type="text" name="BUDGETLINE_EXTENSION" id="BUDGETLINE_EXTENSION" required="required"
                                      style= "margin-left: 4px;  height:20px; margin-top: 17px; width:261px; color:#000000;"/>
