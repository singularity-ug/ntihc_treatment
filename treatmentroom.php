 ...
 ?-->
  ...
  <div class="col-md-6" style="background-color:transparent;">  
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
    ...
    <tr>  
      <td style="width:33.33333333%; border: 0px; background-color:transparent;">  <a data-toggle="tab" href="#tab1">
       <center><img src="databaseicons/queue-512.png"width="100" height="100" class=" " style=" height:30px; width:30px; background-color:transparent"> <br>
   ...
   <a data-toggle="tab" href="#tab2">
          <center><img src="databaseicons/icon-resources-staffing.png" width="100" height="100" class=" " style=" height:30px; width:30px; background-color:transparent"> <br>
           Others
       <?php 
      include('client_medical_conn.php');
      $date = date("Y-m-d").' 00:00:00';
...
$result = mysqli_query($mysqli, "SELECT * FROM  clientsexamination WHERE TIMESTAMP >='$date' GROUP BY NTIHCNO ORDER BY DATECREATED");
  ...
  echo "<td><a href=\"client_medical_hist.php?NTIHCNO=$res[NTIHCNO]\">Results</a>&nbsp;|  
    ...
    <?php echo $rowcount1;?>
       ...
       <th style="width:39%; text-align:left; border:0px;"><strong>No.&nbsp;clients&nbsp;served</strong>  </th>
       <th style="width:10%; text-align:left; border:0px;">  
       <b style="text-align:center; font-size:40px;font-size: 15px;border-radius: 11px;" class="button 5">
        <?php 
      include('client_medical_conn.php');
    ...
    <?php echo $rowcount2;?>
      ...
      var ddt = jose.split("__")[1];
        ...
        <th style="width:60%;border:0px;"> <input type="date"  name="DATECREATED" id="myDATECREATED" value="<?php echo date('d-m-y'); ?>"
        ...
        <th style="width:60%;border:0px;"> <select  name="VISTBY" id="cboOptions" onChange="showDiv('div',this)"
        required="required" style="width:100%; font-weight:normal; background-color:transparent;">
     ...
     <?php include('client_medical_dyn.js'); ?> 
      ...
      <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;border: 0px;" width="100%">
        ...
        <th style="width:60%;border:0px;"> <select  name="EXAMPICKERDESC" id="cboOptions" onChange="showDiv2('div',this)"
        required="required" style="width:100%; font-weight:normal; background-color:transparent;">
  ...
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border: 0px;text-align:left;" width="100%">
    <thead>  
            ...
            <td  style="border:0px;width:100%;">  <input type="radio" name="URGENCYTYPE" id="URGENCYTYPE" value="NORMAL" checked>
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;  border: 0px;text-align:left;" width="100%">
    ...
    <tr>  
      <?php include('client_medical_cd.js'); ?> 
        ...
        <th style="width:60%;border:0px;"> <select  name="COUNSELLINGDONE" id="cboOptions" onChange="showDiv3('div',this)"
        required="required" style="width:100%; font-weight:normal; background-color:transparent;">
    ...
    <tr>  
        ...
        <th style="width:60%;border:0px;"> <select  name="HCGSTATUS" id="cboOptions" onChange="showDiv4('div',this)"
        required="required" style="width:100%; font-weight:normal; background-color:transparent;">
    ...
    <tr>
     <th style="width:40%;border:0px;color:blue;">Add results?</th>
        <th style="width:60%;border:0px;"> <select  name="HCGRESULTS" id="cboOptions" onChange="showDiv5('div',this)"
         style="width:100%; font-weight:normal; background-color:transparent;">
    ...
    <tr>  
      <?php include('client_medical_rf.js'); ?> 
        ...
        <th style="width:60%;border:0px;"> <select  name="REFTUNER" id="cboOptions" onChange="showDiv6('div',this)"
        style="width:100%; font-weight:normal; background-color:transparent;">
    ...
    <tr> 
        ...
        <td style="width:60%;border:0px;"> <select name="SERVICEEXTENTION" id="SERVICEEXTENTION" required=""
        style="width:100%; font-weight:normal; background-color:transparent;">
                                              <option> </option> 
    ...
    <tr> 
        <?php include('client_medical_lr.js'); ?> 
            ...
            <td style="border:0px; width:58%;">  <select name="TROOM_INITIATION" id="cboOptions" onChange="showDiv8('div',this)" required="required"  
...
<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; text-align:left;border: 0px;" width="100%"> 
          <thead> 
          <tr>
          <td style="width:70%;border:0px;font-weight:bold;">Activate HCT urgency if HIV test is orderd</td> 
...
?> 
    ...
    <tr>  
        ...
        <td style="width:60%;border:0px;">  <input type="text" name="USERINITIAL" id="USERINITIAL" value="<?php echo $nameofuser; ?>"  
    ...
    <tr>  
        ...
        <td style="width:60%;border:0px;"> <Select id="SERVICEPROVIDER" name="SERVICEPROVIDER" required="required" 
        style="width:100%; font-weight:normal; background-color:transparent;">
                                              <option> </option>
...
<table class="table table-tabled table-bordered" style="background-color:transparent; margin-top:0px; ">
  ...
  <tr>
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;text-align:left;border: 0px;" width="100%">
    ...
    style= " font-size:15px;  border-radius:11px;"/> </center></td>
    </tr></thead></table>
    </div>    
 ...
 <center></a> 
  ...
  <td style="width:33.333333%;border:0px ; background-color:transparent;"> 
   <a data-toggle="tab" href="#tab3a">
          <center><img src="databaseicons/images.jpg"width="100" height="100" class=" " style=" height:30px; width:30px; background-color:transparent"> <br>
           Outreach&nbsp;
        <?php 
      include('client_medical_conn.php');
      $date = date("Y-m-d").' 00:00:00';
