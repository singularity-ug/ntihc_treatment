...
<div class="col-sm-2"> </div>  
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
    ...
    <div class="col-sm-12"> 
     <legend style="color:#000; font-size:11px; text-align:center; font-weight:bold; text-transform:uppercase;"> Callers by gender and geographical location  </legend>  
...
$sql = "SELECT DISTRICT, FISCALYEAR,   	 
											 MAX(CASE WHEN SEX = 1 THEN CID END) AS FEMALE,  
											 MAX(CASE WHEN SEX = 2 THEN CID END) AS MALE  
											 FROM tollfree GROUP BY DISTRICT, FISCALYEAR ORDER BY FISCALYEAR DESC";
...
<?php  
    ...
    $strQuery = "SELECT DISTRICT, FISCALYEAR,   	 
											 MAX(CASE WHEN SEX = 1 THEN CID END) AS FEMALE,  
											 MAX(CASE WHEN SEX = 2 THEN CID END) AS MALE  
											 FROM tollfree GROUP BY DISTRICT, FISCALYEAR ORDER BY FISCALYEAR DESC"; 
