...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <br> 
   <form action="med_gender_vs_agegroup_user_tracker_daily.php" method="get">
	...
	<tbody>
			...
			<?php
				...
				$result = $db->prepare("SELECT DATECREATED, SERVICEPROVIDER,
				                               ...
				                               WHERE DATECREATED BETWEEN :a AND :b AND INSVCSTATUS='TREATMENT ROOM' GROUP BY SERVICEPROVIDER ASC ");
