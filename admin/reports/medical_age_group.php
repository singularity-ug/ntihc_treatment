...
<div class="col-sm-10">
   ...
   <br> 
   <form action="medical_age_group.php" method="get">
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->prepare("SELECT sum(RECORDCOUNTER)  FROM clientsexamination WHERE AGE_GROUP = '10-14' AND DATECREATED BETWEEN :a AND :b");
...
<?php   
 $from_date = "$d1";
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER), AGE_GROUP,  
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "Medical service trend by age group",
