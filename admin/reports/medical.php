...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
    ...
    <a rel="facebox" title="" href="prescription.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i> Daily service</button> </a> 
   
    <a rel="facebox" title="" href="medical_user.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i> service performance</button> </a> 
   
    <a rel="facebox" title="" href="medical_export_performance.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i> Export user report</button> </a>   
   
   <a rel="facebox" title="" href="medical_problem.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i> Problem tracker</button> </a>  
    
   <a rel="facebox" title="" href="medical_data/index.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i> Update medical database</button> </a>  </td>  
       </tr>             
             </table></center>
     <br> 
   <form action="medical.php" method="get">
...
MEDICAL SERVICES PERFORMANCE REPORT BY PROBLEM CATEGORY BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
</div>
   Number of clients served by problem category and gender
  ...
  <tbody>
      ...
      <?php
        ...
        $d1=$_GET['d1'];
        $d2=$_GET['d2'];
        $result = $db->prepare("SELECT DATECREATED,MEDICALTOPIC,   
  CASE
  ...
  END AS age_range,
                         ...
                         FROM clientsexamination 
                                       WHERE DATECREATED BETWEEN :a AND :b GROUP BY MEDICALTOPIC ASC ");
      ...
      ?>
      <tr class="record"> 
      <td><?php echo $row['MEDICALTOPIC']; ?></td>
 ...
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER), MEDICALTOPIC,  
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "Service trend by medical topic",
