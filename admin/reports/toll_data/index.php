...
<?php
	$res = $MySQLiconn->query("SELECT * FROM tollfree ORDER BY DATECREATED asc");
	$count = $res->num_rows;
	...
	if($count > 0)
	{
		while($row=$res->fetch_array())
		{
			?>
			<tr>
			<td><input type="checkbox" name="chk[]" class="chk-box" value="<?php echo $row['CID']; ?>"  /></td>
			<td><?php echo $row['DATECREATED']; ?></td>
			<td><?php echo $row['PHONECONTACT']; ?></td>
			<td><?php echo $row['FIRSTNAME']; ?></td>
            <td><?php echo $row['SEX']; ?></td>
			<td><?php echo $row['AGE']; ?></td> 
			<td><?php echo $row['SCHOOLINGSTATUS']; ?></td>
			<td><?php echo $row['MARITALSTATUS']; ?></td> 
			<td><?php echo $row['EMPLOYMENTSTATUS']; ?></td> 
            <td><?php echo $row['DISTRICT']; ?></td>
			<td><?php echo $row['DIVISION']; ?></td>
			<td><?php echo $row['PLACEOFRESIDENCE']; ?></td>   
            <td><?php echo $row['LIVINGWITH']; ?></td> 
            <td><?php echo $row['HEAREDABOUTNTIHC']; ?></td>
			<td><?php echo $row['HOWDIDYOUKNOABOUTTHISNO']; ?></td> 
			</tr>
			<?php
		}
	}
