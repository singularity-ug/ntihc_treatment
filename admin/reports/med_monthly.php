...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
    ...
    <a rel="facebox" title="" href="med_monthly.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i>Monthly vists</button> </a>
      <a rel="facebox" title="" href="med_daily_export.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i>  <strong>Export data</strong></button> </a>   </center>  </td>   
			 </tr>             
            </table>
     <br> 
   <form action="med_monthly.php" method="get">
...
<div style="font-weight:bold; text-align:center;font-size:12px;margin-bottom: 15px;">
 <img src="../../assets/img/logsbig.PNG" width="100%" height="30%">
    
MONTHLY CLIENTS VISTS BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
</div>
    Monthly number of clients vists by age group
	...
	<tbody> 
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT DATECREATED, AGE_GROUP,  
  CASE
	...
	<thead>
		<tr>
			  ...
			  <?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->prepare("SELECT sum(RECORDCOUNTER)  FROM cmpatientsregistration WHERE FISCALMONTH = '07' AND DATECREATED BETWEEN :a AND :b");
             ...
             <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			   			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM cmpatientsregistration WHERE FISCALMONTH = '08' AND DATECREATED BETWEEN :c AND :d");
