  ...
  $(document).ready(function() {
     $('#example3').DataTable( {
	  "iDisplayLength": 20,
		...
		{extend :'excel',
		 title:' Clients lookup by age groups'
		},
		{extend :'pdf',
		 title:'Clients lookup by age groups '
		},
...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <td style="width:20%;background-color:#f44336;"><a rel="facebox" title="" href="caller_agegroups.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i>Clients lookup by Agegroups</button> </a>
   
   <td style="width:13.3333333%;background-color:#f44336;"><a rel="facebox" title="" href="../sys_dashboard.php"><button class="">
   <i class="icon-edit">  
...
<div style="font-weight:bold; text-align:center;font-size:14px;margin-bottom: 15px;">
 <img src="../../assets/img/logsbig.PNG" width="100%" height="30%">
     ...
     <p style="text-align:center;">Clients lookup by age groups</p>
      <table id="example3" class="table table-table-bordered" style="font-size:9px; width:100%;">
         ...
         <tr>   
                     ...
                     <th style="background-color:#ecf0f5; font-size:10px;">Sex code</th> 
                     <th style="background-color:#ecf0f5; font-size:10px;">Sch code</th> 
					 <th style="background-color:#ecf0f5; font-size:10px;">District</th>
                     <th style="background-color:#ecf0f5; font-size:10px;">Married</th>
					 <th style="background-color:#ecf0f5; font-size:10px;">Employed</th>  
...
$sql = "SELECT *,CASE
  ...
  END AS age_range, 
  COUNT(RECORDCOUNTER) FROM tollfree  GROUP BY PHONECONTACT,FIRSTNAME DESC";
