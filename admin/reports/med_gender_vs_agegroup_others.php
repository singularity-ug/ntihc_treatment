...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <br> 
   <form action="med_gender_vs_agegroup_others.php" method="get">
...
NUMBER OF CLIENTS FOR AS BY MEDICAL AILMENTS BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
</div>
    
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		<thead> 
		<tr> 
		<th>MEDICAL AILMENT</th>
 ...
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER), MEDICALTOPIC,  
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "Medical Ailments Tracker",
