...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
    </i>Export monthly data</button> </a>
    
      <a rel="facebox" title="" href="med_daily_reception2.php?d1=0&d2=0"><button class="">
   <i class="icon-edit"> 
    </i>Registration desk performance tracker</button> </a>
   ...
   <i class="icon-edit">  
     ...
     <br> 
   <form action="med_daily_reception2.php" method="get">
...
DAILY REGISTRATION DESK SERVICE REPORT BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
</div>
    ...
    <tr>
      ...
      <?php
        ...
        ?> 
                 ...
                 <th colspan="1" style="border-top:1px solid #999999;text-align:center;"> -- </th>
