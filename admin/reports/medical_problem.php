...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <br> 
   <form action="medical_problem.php" method="get">
...
<div style="font-weight:bold; text-align:center;font-size:11px;margin-bottom: 15px;">
 ...
 MEDICAL PROBLEM DESCRIPTION ANALYSIS BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
 </div>
 Number of clients registered with the above medical problems by gender and age group
 ...
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER), MEDICALPROBLEM,  
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "Medical problems analysis as by the above period",
