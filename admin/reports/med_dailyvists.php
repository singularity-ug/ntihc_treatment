...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
   </i>  <strong>Export</strong></button> </a>   
    <a rel="facebox" title="" href="reception/index.php"><button class="">
   <i class="icon-edit">  
     ...
     <br> 
   <form action="med_dailyvists.php" method="get">
...
DAILY CLIENTS VISTS BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
</div>
    Number of clients vists by age and gender
	...
	<thead>
		<tr>
			...
			<?php
             ...
             <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			   			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM cmpatientsregistration WHERE SEX = 'MALE' AND DATECREATED BETWEEN :c AND :d");
...
<?php   
 $from_date = "$d1";
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER),  
  CASE
  WHEN AGE1 BETWEEN 10 AND 14 THEN '10-14'
  WHEN AGE1 BETWEEN 15 AND 19 THEN '15-19'
  WHEN AGE1 BETWEEN 20 AND 24 THEN '20-24'
  ...
  END AS age_range,
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "Daily clients vist trend by Age group ",
