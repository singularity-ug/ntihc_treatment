...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <br> 
<form action="hct_user_tracker.php" method="get">
...
<?php   
 ...
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER), USERINITIAL,
											   ...
											   FROM hct_counselling_andtesting  WHERE DATECREATED >= '" . $from_date . "' AND DATECREATED <= '" . $to_date . "' 
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "HCT Service Provider Performance Tracker",
