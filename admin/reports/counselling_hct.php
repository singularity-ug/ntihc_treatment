...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <br> 
<form action="counselling_hct.php" method="get">
...
HCT CLIENTS ATTENDENCE REPORT BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
    </div> 
  ...
  END AS age_range,
											   ...
											   AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE' GROUP BY age_range ASC");
	...
	<thead>
		<tr>
			...
			<th colspan="1" style="border-top:1px solid #999999;text-align:center;"> 
				...
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE SCHOOLING = 'IS' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			   	<?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE SCHOOLING = 'OS' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE VISTTYPE = 'NEW' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			   	<?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE VISTTYPE = 'REVIST' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE FINALREACTIVITY = 'POSITIVE' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			   	<?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE FINALREACTIVITY = 'NEGATIVE' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
				...
				<th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			   	<?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE ARTCLINIC = 'REFERRED' AND DATECREATED BETWEEN :c AND :d
				AND TESTDESCRIPTION='HCT' AND TESTSTATUS ='POST TEST COUNSELLING DONE'");
				$resultia->bindParam(':c', $d1);
				$resultia->bindParam(':d', $d2);
				$resultia->execute();
