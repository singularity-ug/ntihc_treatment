...
<div class="col-sm-10">
   ...
   <a rel="facebox" title="" href="../../counsellingroom.php"><button class="">
   <i class="icon-edit">  
   </i> Back</button> </a> 
   
   <a rel="facebox" title="" href="hct.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i>View all</button> </a> 
      
 <a rel="facebox" title="" href="hct.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i>Tally&nbsp;tool</button> </a> 
     ...
     <br> 
   <form action="hct.php" method="get">
...
HCT PERFORMANCE REPORT BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
    </div>
    ...
    <tbody>
      ...
      <?php
        ...
        $d1=$_GET['d1'];
        $d2=$_GET['d2'];
        $result = $db->prepare("SELECT DATECREATED,  COUNSELORSNAME,
                         ...
                         FROM laboratory 
                                       ...
                                       AND TESTSTATUS ='POST TEST COUNSELLING DONE'
                                       AND REQUESTINGUNIT ='COUNSELLING SERVICES'
                                       GROUP BY   COUNSELORSNAME ASC ");
      ...
      <td><?php echo $row['DATECREATED']; ?></td> 
            <td><?php echo $row[' COUNSELORSNAME']; ?></td> 
  ...
  <thead>
    <tr>
      ...
      <?php
        ...
        $d1=$_GET['d1'];
        $d2=$_GET['d2'];
        $results = $db->prepare("SELECT sum(RECORDCOUNTER)  FROM laboratory WHERE 
        ...
        ?>
             ...
             <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
                  <?php 
        $resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE  
        ...
        ?> 
             ...
             <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
                  <?php 
        $resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE SEX = 'FEMALE' 
        ...
        ?> 
                 ...
                 <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
          <?php 
        $resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM laboratory WHERE DATECREATED BETWEEN :c AND :d ");
        $resultia->bindParam(':c', $d1);
        $resultia->bindParam(':d', $d2);
        $resultia->execute();
        for($i=0; $cxz = $resultia->fetch(); $i++){
...
<?php   
 ...
 $to_date = "$d2";
  $strQuery = "SELECT SUM(RECORDCOUNTER), USERINITIAL,
                         ...
                         FROM laboratory  WHERE DATECREATED >= '" . $from_date . "' AND DATECREATED <= '" . $to_date . "' 
