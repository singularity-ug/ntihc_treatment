...
<div class="col-sm-10">
   ...
   <i class="icon-edit">  
     ...
     <br> 
<form action="level4a.php" method="get">
...
<div style="font-weight:bold; text-align:center;font-size:12px;margin-bottom: 15px; font-weight:normal;">
 ...
 ATTENDECE TO SERVICES BY MONTH BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
 </div>  
	...
	<tbody> 
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT DATECREATED, INSVCSTATUS,  
				                               ...
				                               WHERE DATECREATED BETWEEN :a AND :b GROUP BY INSVCSTATUS ASC ");
			    ...
			    ?>
			<tr class="record"> 
			<td><?php echo $row['INSVCSTATUS']; ?></td>
