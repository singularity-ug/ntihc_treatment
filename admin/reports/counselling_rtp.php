...
<div class="col-sm-10">
      ...
      <center>
       <a rel="facebox" title="" href="../../counsellingroom.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
   </i>Back</button> </a>&nbsp;&nbsp;
   <a rel="facebox" title="" href="medical_rpt.php?d1=0&d2=0"><button class="">
   <i class="icon-edit">  
    </i>Go to reports module</button> </a>
   </center>  </td>   
			 </tr>             
            </table>
     <br> 
<form action="counselling_rtp.php" method="get">
...
HCT USER PERFORMANCE BETWEEN&nbsp;<?php echo $_GET['d1'] ?>&nbsp;AND&nbsp;<?php echo $_GET['d2'] ?> 
</div>
    ...
    <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px;	text-align:left;" width="100%">
		...
		<th colspan="1">SERVICE PROVIDER</th> 
	...
	<tbody>
			...
			<?php
				...
				$result = $db->prepare("SELECT DATECREATED, USERINITIAL,
				                               ...
				                               WHERE DATECREATED BETWEEN :a AND :b GROUP BY DATECREATED,USERINITIAL ASC ");
	...
	<thead>
		<tr>
			...
			<th colspan="1" style="border-top:1px solid #999999;text-align:center;"> 
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$results = $db->prepare("SELECT sum(RECORDCOUNTER)  FROM hct_counselling_andtesting WHERE 
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM hct_counselling_andtesting WHERE  
                ...
                <th colspan="1" style="border-top:1px solid #999999;text-align:center;">
			    <?php 
				$resultia = $db->prepare("SELECT sum(RECORDCOUNTER) FROM hct_counselling_andtesting WHERE SEX = 'FEMALE' 
