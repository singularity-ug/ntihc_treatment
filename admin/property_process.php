...
$DEPRECIATIONRATE = trim($_POST['DEPRECIATIONRATE']);
$SERVICEABLEDURATION = trim($_POST['SERVICEABLEDURATION']);
...
$sql = "INSERT INTO properties (PROPERTYDESCRIPTION,  
									 ...
									 CODIFICATIONSTATUS,
									 ENGRAVEDNUMBER,   
									 FUNCTIONALSTATUS, DEPRECIATIONSTATUS, DEPRECIATIONRATE, SERVICEABLEDURATION, HOLDTYPE)
                             VALUES ('$PROPERTYDESCRIPTION', 
									 ...
									 '$CODIFICATIONSTATUS',
									 '$ENGRAVEDNUMBER', 
									 '$FUNCTIONALSTATUS','$DEPRECIATIONSTATUS','$DEPRECIATIONRATE','$SERVICEABLEDURATION',        
							         '$HOLDTYPE')";

if (mysqli_query($conn, $sql)) {
    echo "New record created successfully";
	header("location:property_mgt.php");
	exit();
} else {
