...
function searchvehicle(q){
  if (q=='') {
    ...
    downloadUrlData("php/search_vehicle.php?query="+q, function(data){
...
window.location.href="http://localhost/kcca/datatable/materialsengineer.php?q="+url_path;
}
...
window.location.href="../implementationengineerelectrical.php?q="+url_path;
}
