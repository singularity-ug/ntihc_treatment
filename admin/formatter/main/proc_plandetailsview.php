...
<form id="form1" class="form-horizontal" action="proc_procplan_update.php" method="POST" style="height:auto; font-weight:normal;">  
   ...
   <td style="width:60%;"><input type="text" name="ITEMDESCRIPTION" id="ITEMDESCRIPTION"  value="<?php  echo $ITEMDESCRIPTION; ?>"  readonly=""
   style="width:100%; text-align:left;background-color:#fff;"></td>
  ...
  <table class="table table-striped" id="mytable1" style="font-weight:normal; ">
    ...
    <thead>
      <tr  class="  ">
         <td style="text-align:right; font-weight:bold;width:85%;">SUB TOTAL </td>
        <td style="width:15%;"><input type="text"  name="CODEDAMOUNT" id="CODEDAMOUNT" value="<?php echo $totals;?>" readonly="" 
        style="background-color:#fff;width:100%; font-size:14px; font-weight:bold;"></td> 
      </tr>
    </thead>   
  </table> 
      <center>  
        <a href="proc_plan_details.php" style="text-align:right;"> Close <span class="sr-only">(current)</span></a> 
        </center> 
            </form>
