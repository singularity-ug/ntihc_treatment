...
.progress{
  ...
  margin-bottom: 0px;
    ...
    <!-- Main content -->
     ...
     <form id="form1" class="form-horizontal" action="str_reqn_gneprocessor.php" method="POST" style="height:auto; font-weight:normal;">  
         <br>
...
<script>
   ...
   function addRow13(tableId){
    ...
    var s133 = '<input type="text" name="remdrt[]" id="remdrt'+rowCount+'" autocomplete="off"  required="required" '+
	 ...
	 var pd = '<input type="numeric"  onkeyup="dostg(this.id)" onchange="dostg(this.id)" name="pdx_'+rowCount+'" id="pdx_'+rowCount+'" required="required" '+
                                        'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:#fff;" />';
