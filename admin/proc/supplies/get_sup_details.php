...
.progress{
  ...
  margin-bottom: 0px;
     ...
     <div class="col-sm-12" style="background-color:#fff;margin-top: -9px; border:2px solid #ecf0f5;">  
     ...
     <table class="table-responsive" style="margin-top:4px;">
        ...
        <a href="proc_pdu_user.php" class="button5"> Close <span class="sr-only">(current)</span></a> 
