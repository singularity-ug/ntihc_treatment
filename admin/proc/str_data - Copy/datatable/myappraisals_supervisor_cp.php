...
<head>
  ...
  <script type="text/javascript">
    function getCompleted(dept){
      downloadUrlData("../sup_completed.php?q="+dept, function(data){
      document.getElementById('tbody1').innerHTML= data.responseText;
       $('#example').DataTable();
    });
    }

    function getPending(dept){
      downloadUrlData("../sup_pending.php?q="+dept, function(data){
      document.getElementById('tbody1').innerHTML= data.responseText;
       $('#example').DataTable();
    });
    }
...
<center>
 ...
 <input type="button" value="View Completed" id="<?php echo $dept;?>"  class="btn btn-success" onClick="getCompleted(this.id)">
 <input type="button" value="View Pending" name="<?php echo $dept;?>"  class="btn btn-danger" onClick="getPending(this.name)">
