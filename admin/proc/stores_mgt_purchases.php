        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
             ...
             <b style="color:#000;;">Recieved Purchases / Dontions by lpo number</b>
             ...
             $result = mysqli_query($mysqli, "SELECT SERVICEPROVIDER,LPONO,ORDERSERIALID,GOODSRECIEVEDDATE,INVOICENO,TOTALCOST,GOODSRECEIVABLETYPE,ITEMPRICE, SUM(ITEMPRICE)
			 FROM recievables 
			 WHERE STOCKTYPE='RECIEVABLES' GROUP BY ORDERSERIALID ORDER BY GOODSRECIEVEDDATE,ORDERSERIALID DESC");
             ...
             $sdtsrr = $res['LPONO']."***".$res['ORDERSERIALID'];
			  ...
			  echo "<td>".$res['SUM(ITEMPRICE)']."</td>"; 
			  echo "<td>".$res['GOODSRECEIVABLETYPE']."</td>";    
			   echo "<td><a href=\"lpo_gen_recievables.php?ORDERSERIALID=$res[ORDERSERIALID]\">View L P O</a> &nbsp; |&nbsp;   
			 <a href=\"str_goodsrn_update2.php?ORDERSERIALID=$res[ORDERSERIALID]\">Update G R N</a>   &nbsp; |&nbsp;   
			 <a href=\"str_goodsrn_print.php?ORDERSERIALID=$res[ORDERSERIALID]\">PRINT</a>  </td>";
             }
              ?>
             </tbody>
             </table>	
