...
.progress{
  ...
  margin-bottom: 0px;
   ...
   style="width:100%; text-align:left;background-color:#fff;"></td>
	...
	<td style="width:70%;"><input type="text" name="CORDATE" id="CORDATE"  value="<?php  echo $CORDATE; ?>" readonly="readonly"
                style="width:100%; text-align:left;background-color:#fff;"></td>
 ...
 <table class="table table-striped" style="background-color:#ffffff; margin-top:-13px; ">
   ...
   <tbody>
   <tr>
   <td style="width:30%;"><input type="text" name="CORNAME" id="CORNAME"  value="<?php  echo $CORNAME; ?> "  readonly="readonly"
   style="width:100%; text-align:left;background-color:#fff;"></td>
  ...
  <table class="table table-striped" style="background-color:#ffffff; margin-top:-13px; ">
   ...
   <tr>
    ...
    <td style="width:100%;"><input type="text" name="CORTITLE" id="CORTITLE"  value="<?php  echo $CORTITLE; ?> "  readonly="readonly"
    style="width:100%; text-align:left;background-color:#fff;"></td>
  ...
  <tr>
   ...
   <table class="table table-striped" style="background-color:#ffffff; margin-top:-17px; ">
   <thead>
   <tr>
   <th>Comment</th>
   </tr>
   ...
   <tbody>
   <tr>
	<td style="width:80%;"><input type="text" name="CORCOMMENT" id="CORCOMMENT"  value="<?php  echo $CORCOMMENT; ?>" readonly="readonly"
    style="width:100%; text-align:left;background-color:#fff;"></td>
