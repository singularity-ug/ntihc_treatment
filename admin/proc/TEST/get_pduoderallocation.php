...
.progress{
 ...
 <table class="table table-striped" style="background-color:#ffffff; margin-top:-10px; ">
   ...
   <tbody>
   <tr>  
	<td style="width:80%;"><select name="OFFICERACCOUNT" id="OFFICERACCOUNT"  class="button 5" required="required" style="width:100%; text-align:left;">
                  <option value="Undefined"> <option>
                   <?php   echo $stdd; ?> 
                  </select> </td> 
				  
	<td style="width:20%;background-color:#ecf0f5;">   <input type="submit" name="buttonsend" value="Update" style="height: 25px;"> </td> 		  
