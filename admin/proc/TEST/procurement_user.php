...
?>    
		  ...
		  <div class="progress">
             ...
             $result = mysqli_query($mysqli, "SELECT *,SUM(MARKETPRICE) FROM procreqn WHERE  CORACTION ='AUTHORISED' AND RFPFILENUMBER ='$pf'
                                              GROUP BY REQUISITIONID ORDER BY TIMESTAMP DESC");
...
<img src="../../assets/img/logsbig.PNG" width="100%" height="100%">
    ...
    <thead>
      <tr  class="  "> 
            ...
            <tr>
              ...
              <td><input type="text" name="FINANCIALYEAR" id="FINANCIALYEAR" required="required" placeholder="Like:  FY 2016/2017"
   ...
   <th style="width:12%; text-align:center;">AMOUNT</th>
     ...
     <br>
                                        ...
                                        <input type="hidden" name="SUBTOTAL" id="SUBTOTAL"  style="width:100%; text-align:right;"> 
...
<!-- AdminLTE for demo purposes -->
 ...
 <script>
    ...
    function  dostg(thisid){
	 ...
	 var v2 = parseFloat(document.getElementById("qty_"+val).value);
   ...
   function addRow13(tableId){
	 ...
	 var s11 = '<input type="text" onKeyUp="domee(this)" name="desc[]" id="desc'+rowCount+'" autocomplete="off"  required="required" '+
              ' style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; background-color:#fff" >';
			   	  
			  
	 var s22 = '<input type="text" name="uom[]" id="uom'+rowCount+'" autocomplete="off"  required="required" '+
              ' style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; background-color:#fff" >';	
			  	  
			   
	 var s33 = '<input type="text" onkeyup="dostg(this.id)" onchange="dostg(this.id)" name="qty[]" name1="qty_'+rowCount+'"  id="qty_'+rowCount+'" required="required" '+
                                        'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:#fff;" />';
 
 
	 var s44 = '<input type="text" onkeyup="dostg(this.id)" onchange="dostg(this.id)" name="escost[]" name1="escost_'+rowCount+'" id="escost_'+rowCount+'" required="required" '+
	           'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:#fff;" />';
			    
			  
	 var s55 = '<input type="text" onkeyup="dostg(this.id)" onchange="dostg(this.id)"  name="marktp[]" name1="marktp_'+rowCount+'" id="marktp_'+rowCount+'" readonly="readonly" '+
                                        'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:#fff;" />';
 ...
 function deleteRow13(tableID) {
	     ...
	     for(var i=1; i<rowCount; i++) {
		  ...
		  table.rows[x].cells[5].childNodes[0].name="marktp_"+x; 
          }
