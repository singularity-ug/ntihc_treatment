...
<div class="wrapper" style="background-color: #000;">
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
                                                 for($s=0;$s<$tot;$s++){ 
                                                  ...
                                                  input-md" style= "width:100%; background-color:#fcfdfe;text-align:left;"/></td>  
       ...
       <div id="res" style="border:0px;"> </div> 
              ...
              <table class="table" style="border:0px;">
              <tr>   
                <th style="width:100%;border:0px;background-color:#ecf0f5;"> <textarea name="STOCKOUTCOMMENT"  <?php echo $STOCKOUTCOMMENT; ?> 
				style="width:100%;" > 
				</textarea> </th>  
			 </tr>             
            </table>
