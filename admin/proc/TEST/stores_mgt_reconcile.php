        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
             ...
             <b style="color:#000;;"> Reconciliation of incoming and issued stock by item description</b>
             ...
             $result = mysqli_query($mysqli, "   
																  ...
																  SELECT * FROM `recievables` 
			                                                      LEFT JOIN `items` ON recievables.DESCRIPTION=items.DESCRIPTION 
																  LEFT JOIN `outgoingorders` ON recievables.DESCRIPTION=outgoingorders.DESCRIPTION 
																  GROUP BY recievables.DESCRIPTION DESC");
				       
             while($res = mysqli_fetch_array($result)) {
              $sdtsrr = $res['DESCRIPTION'];
              echo "<tr>";  
