...
<?php 
 ...
 $sql  = "SELECT * FROM procreqn  WHERE `REQUISITIONID` = '$id' ";
  ...
  while($row=$res->fetch_assoc()){
	 ...
	 $CONFTITLE=$row['CONFTITLE'];
     $CONFNAME=$row['CONFNAME'];
     $CONFDATE=$row['CONFDATE'];
     $CONFCOMMENT=$row['CONFCOMMENT']; 
	 $CONFEXTENSION=$row['CONFEXTENSION']; 
...
.progress{
  ...
  margin-bottom: 0px;
   ...
   <tbody>
   <tr>
   <td style="width:30%;"><input type="text" name="JOBNUMBER" id="JOBNUMBER"  value="<?php  echo $JOBNUMBER; ?> "  readonly="readonly" 
   style="width:100%; text-align:left;background-color:#fff;"></td> 
				
	<td style="width:70%;"><input type="text" name="CONFDATE" id="CONFDATE"  value="<?php  echo $CONFDATE; ?>" readonly="readonly" 
                style="width:100%; text-align:left;background-color:#fff;"></td>  
 ...
 <table class="table table-striped" style="background-color:#ffffff; margin-top:13px; ">
   ...
   <tbody>
   <tr>
   <td style="width:30%;"><input type="text" name="CONFNAME" id="CONFNAME"  value="<?php  echo $CONFNAME; ?> "  readonly="readonly" 
   style="width:100%; text-align:left;background-color:#fff;"></td>   
  ...
  <table class="table table-striped" style="background-color:#ffffff; margin-top:-13px; ">
   ...
   <tr> 
    ...
    <td style="width:100%;"><input type="text" name="CONFTITLE" id="CONFTITLE"  value="<?php  echo $CONFTITLE; ?> "  readonly="readonly" 
    style="width:100%; text-align:left;background-color:#fff;"></td>
  ...
  <table class="table table-striped" style="background-color:#ffffff; margin-top:-14px; ">
   <thead>
   <tr> 
   <th>Email-address</th> 
   </tr>
   ...
   <tbody>
   <tr> 
	<td style="width:80%;"><input type="text" name="CONFEXTENSION" id="CONFEXTENSION"  value="<?php  echo $CONFEXTENSION; ?>" readonly="readonly" 
    style="width:100%; text-align:left;background-color:#fff;"></td> 
  ...
  <tr>
   ...
   <tbody>
   <tr> 
	<td style="width:80%;"><input type="text" name="CONFCOMMENT" id="CONFCOMMENT"  value="<?php  echo $CONFCOMMENT; ?>" readonly="readonly" 
    style="width:100%; text-align:left;background-color:#fff;"></td> 
