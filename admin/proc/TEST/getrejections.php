...
.progress{
  ...
  margin-bottom: 0px;
   ...
   style="width:100%; text-align:left;background-color:#fff;"></td> 
	...
	<td style="width:70%;"><input type="text" name="AONAME" id="AONAME"  value="<?php  echo $AONAME; ?>" readonly="readonly" 
                style="width:100%; text-align:left;background-color:#fff;"></td>  
  ...
  <table class="table table-striped" style="background-color:#ffffff; margin-top:-13px; ">
   ...
   <tr> 
    ...
    <td style="width:100%;"><input type="text" name="AOTITLE" id="AOTITLE"  value="<?php  echo $AOTITLE; ?> "  readonly="readonly" 
    style="width:100%; text-align:left;background-color:#fff;"></td>
