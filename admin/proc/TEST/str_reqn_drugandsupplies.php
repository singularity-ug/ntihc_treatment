    ...
    <nav class="navbar navbar-static-top"> 
        ...
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="str_goodsrecievenote.php.php" class="button 5" > Refresh<span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="stores_module.php" class="button 5" > Home<span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="str_goodsrecievenote.php" class="button 5" > Standard<span class="sr-only">(current)</span></a></li>
            <li class="active"><a href="str_reqn_general.php" class="button 5" > General<span class="sr-only">(current)</span></a></li>
          </ul>
  ...
  <!-- Full Width Column -->
   <section class="invoice">
      ...
      <div class="row">
        ...
        <center> <p style="color:#000; font-weight:bold;font-size:14px; background-color:#fff; margin-top:-18px; font-family:lcd;"> REQUISITION FOR DRUGS AND SUPPLIES</p> </center> 
        ...
        <table class="table-responsive" style="margin-top:-10px;"> 
            <table class="table"  style="border:0px;">
              <tr> 
                ...
                <td style="width:14.75%;border:0px;"><input type="date"id="DATECREATED" name="DATECREATED"  value="<?php echo date('y-m-d'); ?>"      
			  ...
			  <th style="width:13.25%; text-align:left;border:0px;">Requesting unit</th>
                <td style="width:16.75%;border:0px;"><select name="REQUESTINGUNIT" id="REQUESTINGUNIT" required="required"
            ...
            <table class="table" style="border:0px;">
			  ...
			  <th style="width:13.25%; text-align:left;border:0px;">Facility name</th>
                ...
                <td style="width:14.75%"><input name="ORDERTYPE" type="radio" id="ORDERTYPE" value="FACILITY" >
   ...
   <th style="width:30%;background-color: #f9fafb;">DESCRIPTION </th> 
   <th style="width:5%;background-color: #f9fafb; text-align:center;">QTY IN STOCK</th> 
    <th style="width:5%;background-color: #f9fafb;text-align:center;">QTY NEEDED </th>
   <th style="width:15%;background-color: #f9fafb;text-align:center;">UNIT OF MEASURE </th>
   <th style="width:5%;background-color: #f9fafb;text-align:center;">QTY ISSUED</th>
   <th style="width:5%;background-color: #f9fafb;">UNIT </th>
   <th style="width:7%;background-color: #f9fafb;">STOCK BAL</th>
   <th style="width:7%;background-color: #f9fafb;">BATCH NO.</th>
   <th style="width:7%;background-color: #f9fafb;text-align:center;">EXPIRY</th>    
   <th style="width:7%;background-color: #f9fafb;text-align:center;">UNIT VALUE</th>
   <th style="width:7%;background-color: #f9fafb;text-align:center;">AMOUNT</th> 
            ...
            <table class="table"  style="border:0px;">
              <tr> 
               <th style="width:71%; text-align:left; border:0px;"> </th>
                 <th style="width:13.25%; text-align:left;">ORDER VALUATION</th>
                <td style="width:14.75%"><input type="numeric" name="ORDERVALUE" id="ORDERVALUE"  
        ...
        <table class="table-responsive" style="margin-top:0px;"> 
            <table class="table"  style="border:0px;">
              <tr>  
                ...
                <td style="width:15%;border:0px;"><input type="text"id="REQBY" name="REQBY" value=" <?php echo $desc; ?> "    
				style="width:100%; text-align:right;background-color:#fff;height: 21px;"></td> 
            ...
            <table class="table"  style="border:0px;">
              <tr>  
                ...
                <td style="width:15%;border:0px;"><input type="text"id="REQBYNAME" name="REQBYNAME" value=" <?php echo $nameofuser; ?> "    
				style="width:100%; text-align:right;background-color:#fff;height: 21px;"></td> 
                 <th style="width:1%; text-align:left;border:0px;"> </th>
            ...
            <table class="table"  style="border:0px;">
              <tr>  
                ...
                <td style="width:15%;border:0px;"><input type="date"id="REQBYDATE" name="REQBYDATE" value="<?php echo date('y-m-d'); ?>"       
				style="width:100%; text-align:right;background-color:#fff;height: 21px;"></td> 
                 <th style="width:1%; text-align:left;border:0px;"> </th>
                   
               <th style="width:10%; text-align:left;border:0px;">Date</th>
                <td style="width:15%;border:0px;"><input type="date"id="AUTBYDATE" name="AUTBYDATE"       
				style="width:100%; text-align:right;background-color:#f9fafb;height: 21px;"></td> 
                 <th style="width:1%; text-align:left;border:0px;"> </th>
                 
                  <th style="width:9%; text-align:left;border:0px;">Date</th>
                <td style="width:15%;border:0px;"><input type="date"id="APPBYDATE" name="APPBYDATE"       
				style="width:100%; text-align:right;background-color:#f9fafb;height: 21px;"></td> 
                 <th style="width:1%; text-align:left;border:0px;"> </th>
                 
                  <th style="width:9%; text-align:left;border:0px;">Date</th>
                <td style="width:15%;border:0px;"><input type="date"id="ISSBYDATE" name="ISSBYDATE"     
				style="width:100%; text-align:right;background-color:#f9fafb;height: 21px;"></td>  
			 </tr>             
            </table>
