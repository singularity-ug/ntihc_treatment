	  ...
	  <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav"> 
            <li class="active"><a href="client_management.php"  > Clients mgt<span class="sr-only">(current)</span></a></li>
            <li><a href="medical/waiting_room.php" class=" "> Waiting room<span class="sr-only">(current)</span></a></li>
            <li><a href="admin/service_delivery/medical_tool_user.php" class=" "> Tally tool<span class="sr-only">(current)</span></a></li> 
          </ul>
...
$result = mysqli_query($mysqli, "SELECT * FROM  clientsexamination WHERE TIMESTAMP >='$date' GROUP BY NTIHCNO ORDER BY DATECREATED");
	...
	$dtsget = $res['NTIHCNO']."***".$res['DATECREATED']."***".$res['DATECREATED'];
		...
		<span class="glyphicon glyphicon-cog"> </span></a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a id="5__'.$dtsget.'" href="medical/medical_data.php?q='.$res['NTIHCNO'].'__'.$res['DATECREATED'].'" data-toggle="tooltip" title="Start service"
