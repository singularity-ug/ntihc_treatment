...
?> 
   ...
   <form action="running_proc_plan_report.php" method="get">
<center><strong>
From : <select style="width: 223px; padding:2px;" name="d1" class="tcal" value="" /> 
               <option></option>
               <?php   echo $stss; ?> 
              </select>

To: <select style="width: 223px; padding:2px;" name="d2" class="tcal" value="" />
                <option></option>
               <?php   echo $stss; ?> 
              </select>
...
Procurement Plan from&nbsp;<?php echo $_GET['d1'] ?>&nbsp;to&nbsp;<?php echo $_GET['d2'] ?>&nbsp;  
</div>
	...
	<tbody>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT * FROM procplanning WHERE FINANCIALPERIOD BETWEEN :a AND :b ORDER by id DESC ");
