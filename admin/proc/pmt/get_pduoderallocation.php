...
.progress{
 ...
 <table class="table table-striped" style="background-color:#ffffff; margin-top:-23px; ">
   ...
   <tbody>
   <tr>  
	<td style="width:50%;"><input type="text" name="OFFICERALLOCATED" id="OFFICERALLOCATED"  value="<?php  echo $OFFICERALLOCATED; ?>" required="required" 
 ...
 <table class="table table-striped" style="background-color:#ffffff; margin-top:-23px; ">
   ...
   <tbody>
   <tr>  
	<td style="width:50%;"><textarea name="ALLOCATIONCOMMENT" id="ALLOCATIONCOMMENT"  value="<?php  echo $ALLOCATIONCOMMENT; ?>" required="required" 
 ...
 <table class="table table-striped" style="background-color:#ffffff; margin-top:-10px; ">
   <thead>
   <tr>  
   <th>Select officer's account</th>
   <th> </th>
   </tr>
   </thead>
   <tbody>
   <tr>  
	<td style="width:70%;"><select name="OFFICERACCOUNT" id="OFFICERACCOUNT"  class="button5" required="required" style="width:100%; color:#FFF; text-align:left;">
                  <option value="Undefined"> <option>
                   <?php   echo $stdd; ?> 
                  </select> </td> 
				  
	<td style="width:30%;background-color:#fff;">   <input type="submit" name="buttonsend" value="Update" style="height: 25px;">
     <a  href="proc_pdu.php"<button type="button" class="btn btn-default">Close</button </a></td> 		  
