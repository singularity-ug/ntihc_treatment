...
.progress{
  ...
  margin-bottom: 0px;
     ...
     <form class="form-horizontal" action="update_supplier.php" method="POST" style="height:auto; font-weight:normal; background-color:#fff;">  
     ...
     <table class="table-responsive" style="margin-top:4px;">
        ...
        <a href="suppliers_mgt.php"> Close <span class="sr-only">(current)</span></a> 
