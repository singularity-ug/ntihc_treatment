...
<div class="wrapper">
 ...
 <section class="invoice">
      ...
      <div class="row">
        ...
        <center> <p style="color:#000; font-weight:bold;font-size:12px; background-color:#fff;"> <b>REQUEST FOR QUOTATION</b> </p> </center> 
	 ...
	 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 12px; border:0px;	text-align:left;border: 0px;" width="100%">
		...
		<tr> 
                ...
                <th style="width:14%;border:0px;">Request Date</th>
                <td style="width:19.4%;border:0px;"> <?php echo "" . date("Y/m/d") . "";  ?> </td>
              </tr>
              <tr>
			    <th style="width:66.6%; border:0px;"> </th>
                <th style="width:14%;border:0px;">RFQ Serial No.</th>
                <td style="width:19.4%;border:0px;">  <?php  echo $REQUISITIONID; ?> </td>
              </tr> 
  ...
  <p style="font-size:15px; font-weight:bold">We are pleased to confirm our purchase of the following items</p>
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px; border:0px; text-align:left;border: 0px;" width="100%">
		<thead> 
		<tr>    
   <th style="width:5%;font-size: 11px;">ITEM</th>   
   <th style="width:60%;font-size: 11px;">DESCRIPTION</th>
   <th style="width:25%;font-size: 11px;">UNIT OF MEASURE</th>
   <th style="width:10%;font-size: 11px; text-align:center;">QUANTITY</th>   
      </tr>
      </thead>
             <tbody >
		...
		<tr> 
			    <th style="width:50%;border:0px;"> </th>
                <th style="width:7%;border:0px;">Sign</th>
                <td style="width:43%;border:0px;"><input type="text" name=" "  style="width:100%; text-align:center;border:0px;"></td>
              </tr>
              <tr>
			    <th style="width:50%;border:0px;"> </th>
                <th style="width:7%;border:0px;"> For:</th>
                <td style="width:43%;border:0px;"> <input type="text" name=" " value="Naguru Teenage Information and Health Center" style="width:100%;border:0px;"</th>
              </tr> 
            </table>
