...
<div class="wrapper">
 ...
 <section class="invoice">
      ...
      PART 1: REQUEST BY USER DEPARTMENT FOR APPROVAL OF PROCUREMENT METHOD</p>
    ...
    <thead>
      <tr  class="  "> 
            ...
            <tbody>
            <tr>
              <td><select name="PDECODE" value="<?php  echo $PDECODE; ?>"  readonly=" readonly" 
    ...
    <tbody>
      <tr>
        <th style="width:25%;"><input type="text"  name="PROCUREMENTPLANREF" id="PROCUREMENTPLANREF" value="<?php  echo $PROCUREMENTPLANREF; ?>" readonly="readonly" 
             ...
             <tbody >
                                                <?php  $tot = count($desc); $s=0;
                                                 for($s=0;$s<$tot;$s++){ ?>
                                                  ...
                                                  <td> <input  name="escost[]" readonly="" type="numeric" value="<?php echo $escost[$s]; ?>" class="form-control input-md" 
  ...
  <div class="table-responsive" style="margin-top:-20px;"> 
            <table class="table">
              <tr> 
                 <th style="width:88.25%; text-align:right;">ESTIMATED TOTAL COST</th>
                <td style="width:11.75%"><input type="numeric" name="SUBTOTAL" id="SUBTOTAL"  value="<?php  echo $SUBTOTAL; ?>" readonly="readonly"
            ...
            <table class="table" style="border:0px;">
              <tr>
			    <th style="width:10%;border:0px;">(1) </th>
				<th style="width:23.3333333%;border:0px;"> <b> Request for procurement<b> </th>
                <th style="width:33.3333333%; border:0px;"> </th> 
				 <th style="width:10%;border:0px;"> (2) </th>
                <td style="width:23.3333333%;border:0px;"> <b>Confirmation of request<b> </td>
              </tr>
              <tr>
				...
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff; border:0px;"> </th>
                <th style="width:33.3333333%; border:0px;"> </th>
				 <th style="width:10%;font-weight:normal;">NAME </th>
			  ...
			  <tr>
				...
				readonly="readonly"    style="width:100%; font-weight:normal; background-color:#fff;border:0px;"></td>
              </tr>
			  <tr>
  ...
  <div class="table-responsive">
            <table class="table" style="border:0px;">
              <tr>
				...
				<th style="width:23.3333333%;border:0px;"> <b> Confirmation of funding and approval to procurement<b> </th>
                <th style="width:33.3333333%; border:0px;"> </th>  
    ...
    <tbody>
      <tr>    
              ...
              <td><input type="text" name="THRESHOLDREASON" id="THRESHOLDREASON" readonly="readonly"  value="<?php  echo $THRESHOLDREASON; ?>"  
			  style="width:100%; text-align:left;background-color:#fff;"> </td>

              <td><input type="text" name="OFFICERALLOCATED" id="OFFICERALLOCATED" readonly="readonly" value="<?php  echo $OFFICERALLOCATED; ?>"  
			  style="width:100%; text-align:left;background-color:#fff;"></td>
