 ...
 <section class="invoice">
      ...
      <div class="row">
        ...
        <img src="../../../assets/img/logsbig.PNG" width="100%" height="30%">
          <center> <p style="color:#000; font-weight:bold;font-size:10px; background-color:#fff; margin-top:-8px; font-family:lcd;">
         PAYMENT FORM</p> </center> 
         ...
         <br>
            ...
            <table class="table"  style="border:0px;">
              <tr> 
                ...
                <td style="width:80%;border:0px;"><input type="date"id="PLANDETAILS"  name="PLANDETAILS"  value="<?php  echo $PLANDETAILS; ?>" readonly="readonly" 
