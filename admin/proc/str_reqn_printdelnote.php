...
function myFunction() {
    window.print();
		...
		<tr> 
               ...
               <td style="width:16.75%;border:0px;"> 
                ...
                <input type="text" name="" id="" value=" <?php echo "" . date("Y.m.d") . ""; ?>  "   
		...
		<tr> 
               ...
               <td style="width:16.75%;border:0px;"> 
                ...
                <td style="width:14.75%;border:0px;"> 
                <input type="text" name="ORDERSERIALID" id="ORDERSERIALID"  value="<?php  echo $ORDERSERIALID; ?>"  
		...
		<tr>   
                ...
                <td style="width:89.7777777777%;border:0px;">  <?php  echo $FACILITYNANE; ?> 
			 </tr>             
            </table>      
              <br>
            
      <p style="font-weight:normal;">Please receive the following goods</p>
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
		...
		<thead> 
		<tr>
                <th style="width:10.33333333%; text-align:left;border:0px;">Delivered by</th>
                ...
                <td style="width:23%;border:0px;"> </td>  
  ...
  <button onClick="myFunction()" >Print &nbsp;<?php  echo $ORDERSERIALID; ?></button>  
   </center>
