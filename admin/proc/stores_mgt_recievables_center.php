 ...
 <?php
  ...
  ?>
    ...
    <section class="content-header"> 
     <font style=" font:bold 24px 'Aleo'; text-shadow:1px 1px 5px #000; color:#fff;"><center>Stores | batch tracker	</center></font>
    </section>
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
             ...
             <div class="box box-primary" style="border:0px;">
               ...
               <b style="color:#000;;">Reconciliation of incoming and issued stock by item description and batch number</b></a>  </a> </div>
             ...
             $result = mysqli_query($mysqli, "SELECT *
			                                  FROM recievables  WHERE 
											  ORDERTYPE = 'DELIVERED' 
											  AND DELIVERYSTATUS ='DELIVERED' 
											  AND STOCKTYPE='RECIEVABLES' 
											  ORDER BY  GOODSRECIEVEDDATE DESC");
             ...
             $sdtsrr = $res['LPONO']."***".$res['ORDERSERIALID'];
			  ...
			  echo "<td>".$res['QUANTITYISSUED']."</td>"; 
			   echo "<td>".$res['BATCHNO']."</td>"; 
			  echo "<td>".$res['BALANCEINSTOCK']."</td>";     
