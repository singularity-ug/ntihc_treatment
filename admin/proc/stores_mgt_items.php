  ...
  <div class="content-wrapper" style="background-color: #dddddd;"> 
    ...
    <section class="content"> 
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
             ...
             <b style="color:#000;;">Items / supplies descriptions</b>
         
                  <div class="table-responsive mailbox-messages">   
         
               
               <div class=""  id="getdropix" >  </div>
                <script>

          function getdropix(jose){
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'str_get_itemdetails.php?q='+odno,
       ...
       <table id="example3" class="table table-table-bordered" style="font-weight:normal; font-size:9px; width:100%;">
             ...
             $result = mysqli_query($mysqli, "SELECT * FROM items WHERE DISCONTINUE = 'DISABLED' ORDER BY CATEGORY DESC");
             ...
             $dts = $res['id']."***".$res['DESCRIPTION']."***".$res['CATEGORY'];
			  ...
			  echo '<td> 
              <a id="2__'.$dts.'" href="javascript:void(0)" onclick="newitem(this.id)" data-toggle="tooltip" title="Add new"
			  ...
			  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
              <a id="40__'.$dts.'" href="javascript:void(0)" onclick="getdropix(this.id)" data-toggle="tooltip" title="Details"
       ...
       <div class="col-sm-12">
                     <div class="modal" id="outxzz" tabindex="-1"    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color:#FFF;" >
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myModalLabel"> Update item description</h4>
                                        </div>
                                        <div class="modal-body">
      ...
      <div class="col-sm-12">
                     <div class="modal" id="getdropw" tabindex="-1"    role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header" style="background-color:#FFF;" >
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
