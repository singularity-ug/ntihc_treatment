...
function myFunction() {
    window.print();
        ...
        STORE REQUISITION FOR DRUGS AND SUPPLIES
        </p> </center> 
   
       <form class="form-horizontal" action="str_reqn_updateorder_processor2.php" method="POST"  style="height:auto; font-weight:normal; ">  
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
                                                 for($s=0;$s<$tot;$s++){ 
                                                  ...
                                                  <input name="FUCKERCOUNTER[]" type="hidden" value="<?php echo $variance[$s]; ?>" >
