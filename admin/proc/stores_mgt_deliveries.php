        ...
        <div class="col-xs-12">
          <div class="box box-primary">
            ...
            <div class="box-body">
             ...
             <b style="color:#000;;"> Delivery notes for goods issued to facilities</b>
             ...
             $result = mysqli_query($mysqli, "SELECT * FROM outgoingorders WHERE ORDERTYPE = 'FACILITY' AND STOCKISSUANCESTATUS = 'ISSUED' 
