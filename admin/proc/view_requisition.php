...
<img src="../../assets/img/logsbig.PNG" width="100%" height="100%">
  ...
  <div class="table-responsive" style="margin-top:-20px;"> 
            ...
            <table class="table" style="border:0px;">
			  ...
			  <tr>
				...
				<th style="width:23.3333333%">  <input type="date" class="form-control" id="RFPDATE" name="RFPDATE" readonly value="<?php  echo $RFPDATE; ?>"
				readonly="readonly"    style="width:100%; font-weight:normal; background-color:#fff;"></th>
                <th style="width:33.3333333%; border:0px;"> </th>
				 <th style="width:10%;font-weight:normal;">DATE </th>
                <td style="width:23.3333333%"><input type="date" class="form-control" id="CORDATE" readonly="readonly" name="CORDATE" value="<?php  echo $CORDATE; ?>"
				readonly="readonly" style="width:100%; font-weight:normal; background-color:#fff;"></td>
              </tr>
            </table>
  ...
  <div class="table-responsive">
            <table class="table" style="border:0px;">
			  ...
			  <tr>
			    <th style="width:10%;font-weight:normal;">DATE </th>
				<th style="width:23.3333333%">  <input type="date" class="form-control" id="AODATE"  name="AODATE" value="<?php  echo $AODATE; ?>"
				readonly="readonly"    style="width:100%; font-weight:normal; background-color:#fff;"></th>
                <th style="width:33.3333333%; border:0px;"> </th>  
                <td style="width:33.3333333%;border:0px;"> </th>  
              </tr>
