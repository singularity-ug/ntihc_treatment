...
function myFunction() {
    window.print();
        ...
        <form id="form1" class="form-horizontal" action="str_updatedeliveries2.php" method="POST" style="height:auto; font-weight:normal;">  
        <br>
 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
                                                 for($s=0;$s<$tot;$s++){ 
                                                  ...
                                                  class="form-control input-md" style= "width:100%; background-color:#fff;;"/></td>
                                                   ...
                                                   <input  name="test[]" type="hidden" value="<?php  echo $test[$s]; ?>">
                                                   
                                                  <td> <input  name1="QTYINSTOCK[]" name="fqx[]" required="" type="text" value="<?php  echo $fqx[$s]; ?>"  
                                                  class="form-control input-md" readonly=""
                                                   style= "width:100%; background-color:#fff; text-align:center;"/></td> 
                                                     ...
                                                     required="" class="form-control   input-md" style= "width:100%; background-color:#fff;text-align:center;"/></td> 
                                                     
                                                   <input name="FUCKERCOUNTER[]" type="hidden" value="<?php echo $qtyrecieved[$s]; ?>" >
                                                   
                                                   <input name="BALANCEINSTOCK[]" type="hidden" value="<?php echo $bal[$s]; ?>" > 
                                                   
                                                  <td> <input name1="STOCKBAL[]" name="variance[]" type="numeric" value="<?php echo $variance[$s]; ?>" class="form-control 
                                                  ...
                                                  <td> <input  name="expdet[]" type="numeric" value="<?php echo $expdet[$s]; ?>" required="" class="form-control 
                                                  input-md" style= "width:100%; background-color:#fff;"/></td> 
                                                  
                                                  <td> <input  name="remdrt[]" type="numeric" value="<?php echo $remdrt[$s]; ?>" required="" class="form-control 
                                                  input-md" style= "width:100%; background-color:#fff;"/></td> 
                                                  ...
                                                  input-md" style= "width:100%; background-color:#fff;text-align:right;"/></td>  
                                                    ...
                                                    <td> <input   name1="AMOUNT[]" name="qtyx[]" type="numeric" value="<?php echo $qtyx[$s]; ?>"  readonly="" class="form-control 
                                                  input-md" style= "width:100%; background-color:#fff;text-align:right;"/></td> 
...
$(document).ready(function() { 
      ...
      <table class="table"  style="border:0px;">
            ...
            <table class="table" style="border:0px;">
              <tr>   
				...
				style="width:100%;" > 
				<?php  echo $DELIVERYCOMMENT; ?></textarea> </th>  
			 </tr>             
            </table>
      ...
      <center> <input type="submit" name="buttonsend" id="button" value="Update" />
       &nbsp; &nbsp;  
 
  <button onClick="myFunction()" >Print </button>  &nbsp; &nbsp; 
  
      <a href="stores_mgt_purchases.php"> <span class="glyphicon glyphicon-log-in"></span> Back </a></center>
