     ...
     <table class="table-responsive" style="margin-top:4px;">
            ...
            <table class="table" style="border:0px;">
              ...
              <th style="width:80%;border:2px solid #a9abae;background-color:#F9F9F9;">
               <textarea id="PROJECTPURPOSE" name="PROJECTPURPOSE" placeholder="Applies to projects" 
				required="required" style="width:100%; font-weight:normal; background-color:#F9F9F9; height:22px;"></textarea> </th>    
              </tr>
			  </table> 
            ...
            <table class="table" style="border:0px;">
              <tr> 
				...
				&nbsp &nbsp &nbsp
				<a href="proc_pdu_user.php"> Close <span class="sr-only">(current)</span></a>  </th>   
                </tr>
			  </table>     
              </div>
			  </div>  
