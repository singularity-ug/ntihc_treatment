...
$result = mysqli_query($mysqli, "SELECT * FROM receiptinvoices WHERE DOCTYPE ='Invoice' AND id=$id");
...
<br>
    ...
    <thead>
      <tr  class="  ">
          <td style="border-bottom-color:white; width:33.333333333%;"><B>Recieved with thanks from</B></td>
        <td style="border-bottom-color:white; width:66.666666666%;">  <input type="text" name="ATTENTIONTO" id="ATTENTIONTO" value="<?php  echo $ATTENTIONTO; ?>" style="background-color:#fff; width:100%;"></td>
      </tr>
      <tr>
        <td style="border-bottom-color:white; width:33.333333333%;"><b>The sum of shillings</b></td>
        <td style="border-bottom-color:white; width:66.666666666%;"><input type="text"  name="AMOUNTINWORDS" id="AMOUNTINWORDS" value="<?php  echo $AMOUNTINWORDS; ?>" style="background-color:#fff; width:100%;">  </td>
      </tr>
      <tr>
        <td style="border-bottom-color:white; width:33.333333333%;"><b>Being payment for</b></td>
        <td style="border-bottom-color:white; width:66.666666666%;"><input type="text" name="PARTICULARS"  id="PARTICULARS"  value="<?php  echo $PARTICULARS; ?>"
