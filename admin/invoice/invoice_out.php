   ...
   <table class="table table-bordered">
    ...
    <tbody>
      <tr>
         <tr>
         <th>Approved by</th>
        <td><input type="text" name="IMPAPPROVERNAME" id="IMPAPPROVERNAME"  value="<?php  echo $IMPAPPROVERNAME; ?>" readonly=""  style="width:100%; text-align:left;"></td>
        <td><input type="text" name="IMPAPPROVERTITTLE" id="IMPAPPROVERTITTLE" value="<?php  echo $IMPAPPROVERTITTLE; ?>" readonly=""  style="width:100%; text-align:center;"></td>
    ...
    <tr>
     ...
     <tr>
        ...
        <td><input type="text" name="IMPAYTITTLE" id="IMPAYTITTLE" value="<?php  echo $IMPAYTITTLE; ?>"  style="width:100%; text-align:center;"></td>
        <td><input type="text" name="" id="" style="width:100%; text-align:left;"></td>
        <td><input type="date" name="RECIEVEDDATE" id="RECIEVEDDATE" value="<?php  echo $RECIEVEDDATE; ?>"  style="width:100%; text-align:center;"></td>
     </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" class="form-control" id="RECIEVEDDATE" name="RECIEVEDDATE"   value="<?php  echo $RECIEVEDDATE; ?>" style="width:100%; text-align:center;">
        <td><input type="text" class="form-control" id="RECIEVEDDATE" name="RECIEVEDDATE"   value="<?php  echo $RECIEVEDDATE; ?>" style="width:100%; text-align:center;">
        <td><input type="date" class="form-control" id="RECIEVEDDATE" name="RECIEVEDDATE"   value="<?php  echo $RECIEVEDDATE; ?>" style="width:100%; text-align:center;">
