            ...
            <table class="table">
              <tr> 
			    <th style="width:20%; background-color:#660099;color:#fff;font-size:15px;">DISPOSE THIS ITEM </th>
                 ...
                 <th style="width:5%;border:2px solid #a9abae;"> <input type="text" name="id" value=" <?php  echo $id; ?>" style="width:100%; border:0px;"/>  </th> 
                <th style="width:35%;border:2px solid #a9abae;"><input type="text" name="PROPERTYDESCRIPTION" id="PROPERTYDESCRIPTION"
                value=" <?php echo $PROPERTYDESCRIPTION; ?>"  style="width:100%; border:0px;" /></th>  
                  
                <input type="hidden" name=" VERIFICATIONSTATUS" id=" VERIFICATIONSTATUS" value="YES" /> 
                  
                <th style="width:15%;border:2px solid #a9abae;">  <input type="text" name="ENGRAVEDNUMBER" id="ENGRAVEDNUMBER"
                value="<?php echo $ENGRAVEDNUMBER; ?> "  style="width:100%; border:0px;" />  </th>  
