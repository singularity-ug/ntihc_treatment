   ...
   <form class="form-horizontal" action="updateassets.php" method="POST" style="height:auto; font-weight:normal;">    
     ...
     <table class="table-responsive" style="margin-top:-10px;">
      ...
      <table class="table-responsive" style="margin-top:-19px;border:0px;"> 
         ...
         <td style="width:5%;border:0px; background-color:#f9f9f9;">  <center> <input type="submit" name="update" value="Update"> </center></td>  
              
        <td style="width:5%;border:0px; background-color:#f9f9f9;">  <center>  
