...
<?php
      ...
      <div class="user-panel">
        ...
        <li class="active treeview">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li role="presentation"><a role="menuitem" tabindex="-1" href="budget_config.php">All budgets </a></li>  
  ...
  <div class="content-wrapper">
    ...
    <tbody>
        ...
        <option> </option>
       <option value="Best practice ASRHR services"> Best practice ASRHR services</option>
        <option value="Scale up ASRH"> Scale up ASRH</option>
        <option value="Promote ASRHR in Uganda"> Promote ASRHR in Uganda</option>
