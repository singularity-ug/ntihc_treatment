      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
       ...
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
           ...
           <li class="active"><a href="supervisor.php" class="" >Supervisor<span class="sr-only">(current)</span></a></li>  
            <li class="active"><a href="myreviews.php" class="" > My reviews<span class="sr-only">(current)</span></a></li>  
            <li class="active"><a href="manager.php" class="" > Manager <span class="sr-only">(current)</span></a></li>  
  ...
  <!-- Content Wrapper. Contains page content --> 
    ...
    <section class="content-header">  
      ...
      <div class="col-sm-12">
          ...
          <font style=" font-weight:bold; color:#000; font-size:11px;"><center>MY APPROVED STAFF TIMESHEET RECORDS </center></font>
          <br>
...
$result = mysqli_query($mysqli, "SELECT * FROM timesheet WHERE FORWARDTO = '$rm' AND CONFIRMATIONSTATUS = 'REVIEWED' AND APPROVALSTATUS = 'APPROVED' ORDER BY id DESC");
	...
	$dts = $res['IDNUMBER']."***".$res['id']."***".$res['EMPLOYEENAME'];
	    ...
	    echo '<td> 
               &nbsp;&nbsp; &nbsp;  &nbsp;  &nbsp; 
			   <a id="3__'.$dts.'" href="javascript:void(0)"  onclick="getrejectiontwo(this.id)" data-toggle="tooltip" title="Review" 
	...
	?>
        ...
        <div class=""  id="getrejectiontwo" >  </div>
		  ...
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'get_timesheetdetails_view.php?q='+odno,
