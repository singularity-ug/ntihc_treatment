  ...
  <!-- Content Wrapper. Contains page content --> 
    ...
    <section class="content-header">  
      ...
      <div class="col-sm-12">
          ...
          <font style=" font-weight:bold; color:#000; font-size:11px;"><center>MY REVIEWED STAFF TIMESHEET HISTORY</center></font>
          <br>
...
$result = mysqli_query($mysqli, "SELECT * FROM timesheet WHERE SUPACCOUNT = '$rm' AND CONFIRMATIONSTATUS = 'REVIEWED' ORDER BY id DESC");
