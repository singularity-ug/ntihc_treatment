  ...
  <!-- Content Wrapper. Contains page content --> 
    ...
    <section class="content-header">  
      ...
      <div class="col-sm-12">
          ...
          <font style=" font-weight:bold; color:#000; font-size:11px;"><center>STAFF TIMESHEET RECORDS DUE FOR APPROVAL</center></font>
          <br>
...
$result = mysqli_query($mysqli, "SELECT * FROM timesheet WHERE FORWARDTO = '$rm' AND CONFIRMATIONSTATUS = 'REVIEWED' AND APPROVALSTATUS = 'WAITING' ORDER BY id DESC");
	...
	$dts = $res['IDNUMBER']."***".$res['id']."***".$res['EMPLOYEENAME'];
	    ...
	    echo '<td> 
               &nbsp;&nbsp; &nbsp;  
			   <a id="3__'.$dts.'" href="javascript:void(0)"  onclick="get_approvals(this.id)" data-toggle="tooltip" title="Review" 
	...
	?>
        ...
        <div class=""  id="get_approvals" >  </div>
                <script>

          function get_approvals(jose){
		  var odno = ((jose.split("__")[1]).split("***"))[1];
                $.ajax({
                       type    : 'POST',
                       url     : 'get_approvals.php?q='+odno,
                       success : function(data){
                                $('#get_approvals').html(data);
								$("#outxus").modal("show");
                                 }
               });
               }
