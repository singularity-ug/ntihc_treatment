            ...
            <div class="inner"> 
             ...
             <div class="btn-group">
                  ...
                  <ul class="dropdown-menu pull-left" role="menu"> 
                    ...
                    <li class="divider"></li>
                    <li><a href="proc/proc_pdu_user.php">PDU User</a></li>
                  </ul>
                </div>
        </div>
          </div>
                ...
                <div class="panel box box-primary">
                  ...
                  <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="box-body">
                     ...
                     <div class="col-lg-4"> 
                     <a class="button1" href=<button class="small-box-footer" data-toggle="modal"  data-target="#notificationModal"></button>Imprest requests 
