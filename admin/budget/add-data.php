...
function pop(dat){
  ...
  $("#detcod"+num).val(data[2]); 
  $("#bline"+num).val(data[3]); 
  $("#bcod"+num).val(data[4]);
  $("#bcosd"+num).val(data[5]); 
  $("#bpro"+num).val(data[6]);
  $("#bproc"+num).val(data[7]);  
...
if(isset($_POST['btn-gen-form']))
{
	...
	for($i=1; $i<=$_POST["no_of_rec"]; $i++)
	{
        ...
        <input type="hidden" name="perix<?php echo $i; ?>" id="perix<?php echo $i; ?>" value="<?php   echo $stdd2; ?>" />
    ...
    <td><input type="numeric" onkeyUp = "calcTotal(this)" name="ucoss<?php echo $i; ?>" id="ucoss<?php echo $i; ?>" required="required" placeholder="unit_cost" 
    class='form-control' /></td> 
     ...
     <td><input type="text" name="ttc<?php echo $i; ?>" id="ttc<?php echo $i; ?>"  readonly="readonly" class='form-control' /></td>
      ...
      <input type="hidden" name="detcod<?php echo $i; ?>" id="detcod<?php echo $i; ?>" />     
