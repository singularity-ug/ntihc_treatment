  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       <li class="header">DATA TALLYING TOOL</li>
           
        
        <li><a href="medical_tool_user.php"><i class="fa fa-circle-o text-red"></i>Medical tally tool<span></span></a></li>
        <li><a href="anc_tool_user.php"><i class="fa fa-circle-o text-red"></i>ANC tally tool<span></span></a></li>
...
<div class="wrapper">
 ...
 <center><form class="form-inline"  action="medical_tool_user.php" method="post">
  ...
  <table class="table table-bordered" style="font-size:8px; font-weight:normal;">
    <thead>
      <tr  class="" style="background-color:#fff;font-weight:normal;">
        <th style="width:16%;font-size:10px;">DATE</th>
        ...
        <th style="width:5%;text-align:center;font-size:10px;">SEXUAL HEALTH</th>
		<th style="width:5%;text-align:center;font-size:10px;">SGBV</th>
		<th style="width:5%;text-align:center;font-size:10px;">TOTAL CLIENTS</th>
		<th style="width:5%;text-align:center;font-size:10px;">HCG NEGATIVE</th>
        <th style="width:5%;text-align:center;font-size:10px;">HCG POSITIVE</th>
		<th style="width:5%;text-align:center;font-size:10px;">TOTAL CLIENTS</th>
		<th style="width:5%;text-align:center;font-size:10px;">WANTED PREG</th>
        <th style="width:5%;text-align:center;font-size:10px;">UN.WANTED PREG</th>
		<th style="width:5%;text-align:center;font-size:10px;">TOTAL CLIENTS</th>
      </tr>
    <?php 
