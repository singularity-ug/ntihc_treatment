  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
         ...
         <li><a href="#"><i class="fa fa-circle-o text-blue"></i> Budget</a></li>
...
?> </span></a>
        ...
        <div class="col-lg-2 col-xs-4">
         ...
         <center> <img src="../database icons/budget.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner">
             <a href=<button class="small-box-footer" data-toggle="modal"  data-target="#notificationModal"></button>Petty cash <i class=" ">
            </i></a> 
        ...
        <!-- ./col -->  
         ...
         <center> <img src="../database icons/admin.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
            <a href=<button class="small-box-footer" data-toggle="modal"  data-target="#notificationModal"></button>Medical <i class="fa fa-arrow-circle-right"></i></a> 
            <div class="pull-right box-tools">
                <!-- button with a dropdown -->
             <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
       ...
       <div class="col-lg-2 col-xs-4">
         ...
         <center> <img src="../assets/sysicons/queue-512.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
             <a href="home_hr.php" class="small-box-footer">HR-Mgt <i class="fa fa-arrow-circle-right"></i></a>  
              <div class="pull-right box-tools">
                <!-- button with a dropdown -->
             <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
      ...
      <div class="col-lg-2 col-xs-4">
          ...
          <div class="inner"> 
          <a href="home_ftl.php" class="small-box-footer">Fleet mgt <i class=" "></i></a> 
           <div class="pull-right box-tools">
                <!-- button with a dropdown -->
           <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
        ...
        <div class="col-lg-2 col-xs-4"> 
         ...
         <center> <img src="../database icons/employee.jpg"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
             <a href="procurement.php" class="small-box-footer">procure <i class=" "></i></a>  
             <div class="pull-right box-tools">
                <!-- button with a dropdown -->
             <div class="btn-group">
                  <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
        ...
        <!-- ./col -->
         ...
         <center> <img src="../database icons/press-nozbe.png"width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5;" ></center>
            <div class="inner"> 
             <a href=<button class="small-box-footer" data-toggle="modal"  data-target="#notificationModal"></button> </i> Assets 
                 <i class=""></i></a>
              <div class="pull-right box-tools">
                <!-- button with a dropdown -->
             <div class="btn-group">
       ...
       <!-- /.col -->
          ...
          <div class="box box-solid bg-grey-gradient" style="background-color:#ecf0f5;">
            <div class="box-header">
              ...
              <h3 class="box-title" style="color:#000000;">Quick config</h3>
              <!-- tools box -->
              <div class="pull-right box-tools">
                <!-- button with a dropdown -->
                <div class="btn-group">
...
<div class="col-sm-2"> </div>
 ...
 <div class="col-lg-4">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017  Naguru Teenage Information and Health Center. All rights
    reserved.</strong>
  </footer>
