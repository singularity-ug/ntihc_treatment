      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="procurement.php"><i class="fa fa-circle-o"></i> PDU</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="procurement.php"><i class="fa fa-circle-o"></i> Stores requisition</a></li>
            <li><a href="procurement.php"><i class="fa fa-circle-o"></i> General stores reqn</a></li> 
          </ul>
        </li>
        <li>
