...
<?php 
 ...
 $sql  = "SELECT * FROM imprest  WHERE AUTHACTION ='AUTHORISED' AND APPROACTION ='APPROVED' AND IDNUMBER = '$pf' AND CASHOUT ='PAID' AND ORDERNO = '$id' ";
...
<head>
  ...
  <title>Ntihc <b>imm system</b>| cash payment voucher</title>
...
<center> <legend style="color:#000; font-weight:bold; font-size:12px;">CASH PAYMENT VOUCHER </legend> </center> 
  ...
  <br>
   ...
   <table class="table table-bordered">
    ...
    <tr>
        <th>Recieved by</th>
        <td><input type="text"  class="form-control" name="RECIEVEDBY"id="RECIEVEDBY" 
 value="<?php  echo $RECIEVEDBY; ?> " style="width:100%; text-align:left;">
        </td>
