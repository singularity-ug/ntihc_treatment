      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
       ...
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="appraisal.php" class="" >New appraisal<span class="sr-only">(current)</span></a></li> 
...
<P></P>
 <table class="table table-tabled" id="mytable2" style="font-weight:normal; ">
    <thead>
      <tr>
      <th>*</th>
     ...
     <input type="button" onClick="deleteRow17('mytable2')" value="(Delete)" />
     ...
     <br>   <br>   <BR>                                      
             ...
             <p>Summary of rating / scores for B.1</p>
               ...
               <table class="table">
              <tr> 
                <th style="width:33.33333333%; text-align:center;"> Appraisee's section </th>
				<th style="width:33.33333333%;text-align:center;"> Appraiser section </th>  
             ...
             <table class="table-responsive" style="margin-top:-25px;">
              ...
              <tr> 
				...
				<th style="width:18.33333333%;;"> <input type="text" id="NOOFBIOCHILDREN" name="NOOFBIOCHILDREN"
				 style="width:100%; font-weight:normal; background-color:#fff;"> </th> 
...
<p>The appraisee should only be rated in areas that are relevant to his/her job. The maximum points per attribute and/or quality are ten (10). Under each attribute, the 10 points should be allocated in a manner that shows the areas of strengths and weaknesses of the appraisee. Ten (10) is the maximum per attribute and one (1) lowest. Please indicate the relevant points in the boxes provided, thereafter add up the points, and indicate the total. The score out of 20 will be got by; dividing the total score by the total maximum score for all attributes rated. Then multiply the result by 20.
    ...
    <center> <input type="submit" name="buttonsend" id="button" value="Proceed to section B" /></center>          
               <br><br>
               
             
                 
				 <input type="hidden" id="APPRAISEEACCOUNT" name="APPRAISEEACCOUNT">  
...
<script>
  ...
  function addRow16(tableId){
	 ...
	 var  s6ff = '<input type="date" name="FR[]" id="FR'+rowCount+'" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:left;" >';
 ...
 <script>
   function calcsubtt(tableId){
         ...
         var rowCount = table.rows.length;
		  var sum = 0;
		   for(var x=1; x<rowCount; x++) { //0
		  // alert(table.rows[x].cells[2].childNodes[1].value);
		     sum    =sum+ parseFloat(table.rows[x].cells[7].childNodes[0].value);
		   }
		   document.getElementById("SUBTOTAL").value = ''+sum;
  ...
  function addRow17(tableId){
     ...
     var  AA1 = '<input type="text" onKeyUp="domee(this)" name="AA[]" id="AA'+rowCount+'" required="required" '+ 
	             'style= "margin-left:0px'+ 'background-color:#fff; width:100%;">';
				 
	 var  AA2 = '<input type="text" name="BB[]" id="BB'+rowCount+'"  required="required" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:left;" >';			 
 
 		 
	 var  AA3 = '<input type="text" name="CC[]" id="CC'+rowCount+'"  required="required" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:center;" >';

    var  AA4 = '<input type="text" name="DD[]" id="DD'+rowCount+'"  required="required" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:left;" >';
				 
	var  AA5 = '<input type="text" name="EE[]" id="EE'+rowCount+'" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:center;" >';
				 
	var  AA6 = '<input type="text" name="FF[]" id="FF'+rowCount+'" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:left;" >';			 			 
    
     var  AA7 = '<input type="text" name="GG[]" id="GG'+rowCount+'" onkeyup="calcsubtt(\'mytable2\')" '+
                 'style= " margin-left:0px; width:100%; background-color:#fff;text-align:center;" >';
  ...
  function deleteRow17(tableID) {
	     ...
	     for(var i=1; i<rowCount; i++) { //0
          ...
          rowCount = table.rows.length;
          for(var x=1; x<rowCount; x++){
		  table.rows[x].cells[1].childNodes[0].id="AA"+x;
		  table.rows[x].cells[2].childNodes[0].id="BB"+x; 
		  table.rows[x].cells[3].childNodes[0].id="CC"+x;
		  table.rows[x].cells[4].childNodes[0].id="DD"+x;
		  table.rows[x].cells[5].childNodes[0].id="EE"+x; 
		  table.rows[x].cells[6].childNodes[0].id="FF"+x;
		  table.rows[x].cells[7].childNodes[0].id="GG"+x;
          }
