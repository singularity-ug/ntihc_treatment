...
function myFunction() {
    window.print();
     ...
     <form class="form-horizontal" action="staff_contactsprocess.php" method="POST" style="height:auto; font-weight:normal; background-color:#fff;"> 
...
<option value="Zimbabwe">Zimbabwe</option>
            ...
            <table class="table" style="border:0px;">
              <tr> 
				<th style="width:40%;border:0px ;"> Email addres(1) </th>  
                ...
                <div class="panel box box-danger">
                  <div class="box-header with-border" style="text-align:center; font-size:15px;">
                    <h4 class="box-title" style="text-align:center; font-size:15px;">
