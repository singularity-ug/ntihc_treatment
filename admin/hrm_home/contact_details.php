...
<option value="Zimbabwe">Zimbabwe</option>
            ...
            <table class="table" style="border:0px;">
              <tr> 
				<th style="width:40%;border:0px ;"> Email addres(2) </th>  
            ...
            <table class="table" style="border:0px;">
              <tr> 
				<th style="width:40%;border:0px ;"> NTIHC e-mail addres </th>  
                <th style="width:60%;border:0px ;"> <input type="text"name="EMAIL2"  id="EMAIL2" value="<?php  echo $EMAIL2; ?>"
                 required="required" class="form-control" style="width:100%;background-color:#fff;"> 
                  </th>  
              </tr>
			  </table> 
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="active"><a href="#tab_1-1" data-toggle="tab">Address</a></li>
              <li><a href="#tab_2-2" data-toggle="tab">Spouse and children</a></li>
              <li><a href="#tab_3-2" data-toggle="tab">Bank / Defects</a></li>
              <li><a href="#tab_4-2" data-toggle="tab">Parent contacts</a></li>
              <li><a href="#tab_5-2" data-toggle="tab">Alternate next of kin</a></li>
              <li class="dropdown">
   ...
   <thead>
   <tr>
   <th>Full Names of Spouse (Husband or Wife if applicable)</th>
   ...
   <tbody>
   <tr>
   <td style="width:60%;"><input type="text" name="FULLNAMEOFSPOUSE"  id="FULLNAMEOFSPOUSE" value="<?php  echo $FULLNAMEOFSPOUSE; ?>"  
   style="width:100%; text-align:left;background-color:#fff;"></td>
   
   <td style="width:20%;"><input type="numeric" name="NUMBEROFCHILDREN"  id="NUMBEROFCHILDREN" value="<?php  echo $NUMBEROFCHILDREN; ?>"  
                style="width:100%; text-align:left;background-color:#fff; text-align:center;"></td> 
                
    <td style="width:20%;">  <a href=<button class="small-box-footer" data-toggle="modal" data-target="#childrenx" </button>
                                <b style="text-align:center;">ADD NEW CHILD</b>  </a> </td>         
   </tr>
  <tr>
 </tbody>
 </table> 
 ...
 $sql  = "SELECT * FROM employeechildren  WHERE `Serial` = '$id'";
  ...
  ?>
   ...
   <th>SEX</th> 
      ...
      <tbody>
 <?php  $tot = count($maax); $s=0; $totals =0;
                                                 for($s=0;$s<$tot;$s++){
                                                             $totals += intval($mcc[$s]);?>
                                                            <tr > 
                                                  <td> <?php  echo $maax[$s]; ?> </td>
                     
                                                  <td>  <?php  echo $maa[$s]; ?> </td>

                                                  <td>  <?php  echo $mbb[$s]; ?> </td>

                                                  <td>  <?php echo $mcc[$s]; ?> </td> 
           ...
           <P> Account Number</P>
            ...
            <table class="table" style="border:0px;">
              <tr>  
                <th style="width:100%;border:0px ;"> <input type="text" name="ACCOUNTNUMBER"  id="ACCOUNTNUMBER" value="<?php  echo $ACCOUNTNUMBER; ?>"
                 class="form-control" style="width:100%;background-color:#fff;"> 
                  </th>  
              </tr>
			  </table> 
           ...
           <div class="col-sm-12" style="margin-top:-15px;">
             <table class="table-responsive" style="margin-top:0px;"> Physical Defects  / relevant information regarding your health
              <table class="table" style="border:0px;">
              <tr>  
              ...
              <table class="table-responsive" style="margin-top:0px;">Any other relevant information regarding your health  
              <table class="table" style="border:0px;">
              <tr>  
            ...
            <table class="table" style="border:0px;">
             ...
             <br>
              <p style="text-align:center; font-size:11px;margin-top: -23px;">CONTACT OF NEXT OF KIN</p>
            ...
            <table class="table" style="border:0px;">
              ...
              <P>I, <B style="font-size:10px;"> <?php echo $nameofuser; ?></B>, do hereby declare that the above information is true and correct</P>
      ...
      <a href="home_hrmgt.php"> <span class="glyphicon glyphicon-log-in"></span> Close</a></center>
