    ...
    window.print();
       ...
       <div class="col-sm-2">
        ...
        <div class="col-sm-8">
                  ...
                  <!-- Info boxes --> <div class="panel-body">
                <img src="../../assets/img/logsbig.PNG" width="100%" height="100%"> </div>
...
<option value="Zimbabwe">Zimbabwe</option>
   ...
   <tbody>
   <tr>
   <td style="width:80%;"><input type="text" name="FULLNAMEOFSPOUSE"  id="FULLNAMEOFSPOUSE" value="<?php  echo $FULLNAMEOFSPOUSE; ?>"  
