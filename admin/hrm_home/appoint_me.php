     ...
     <input type="hidden"  id="id" name="id"  value="<?php  echo $id; ?>"  /> 
            ...
            <div class="box-body">
              ...
              <tr> 
                ...
                <th style="width:30%;border:0px ;"> <select  name="MRMS"  id="MRMS"  
                 ...
                 <th style="width:30%;border:0px ;"> <select  name="MADABSIR"  id="MADABSIR"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">   
                 <option>Sir</option>
                 <option>Madam</option>
                 </select>
              ...
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <input type="text"   name="THROUGHDATE"  id="THROUGHDATE"  
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <input type="date" id="APPOINTMENTSTARTDATE" name="APPOINTMENTSTARTDATE"   
                 required="required" class="form-control" style="width:100%;background-color:#fff;">  </th>  
              </tr>
			  </table>  
            </div>
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <select name="DUTYSTATION"  id="DUTYSTATION"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;"> 
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <input type="date" name="APPOINTMENTENDDATE" id="APPOINTMENTENDDATE"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">  </th>  
              </tr>
			  </table> 
           </div>
           ...
           <div class="col-sm-6">
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <input type="text" id="REPORTSTO" name="REPORTSTO"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">   </th>  
              </tr>
			  </table> 
           </div>
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <select  id="POSITIONCLASSIFICATION" name="POSITIONCLASSIFICATION"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">   
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <select id="DEPARTMENT" name="DEPARTMENT"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">  
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <select name="EXPECTEDWORKHOURS"  id="EXPECTEDWORKHOURS"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">  
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:25%;border:0px ;"> <input type="text" name="GROSSSALARY"  id="GROSSSALARY"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;"> 
                  </th> 
                <th style="width:15%;border:0px ;">Currency </th>    
                <th style="width:20%;border:0px ;"> <select name="CURRENCY"  id="CURRENCY"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;"> 
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:79%;border:0px ;"> <input type="text" name="AMOUNTINWORDS"  id="AMOUNTINWORDS"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;"> 
                  </th>  
              </tr>
			  </table> 
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <select name="CONTRACTTYPE"  id="CONTRACTTYPE"  
                 required="required" class="form-control" style="width:100%;background-color:#fff;">  
            ...
            <table class="table" style="border:0px;">
              <tr> 
                ...
                <th style="width:60%;border:0px ;"> <select name="ENTITYREFEREEPOSITION"  id="ENTITYREFEREEPOSITION"   
                 required="required" class="form-control" style="width:100%;background-color:#fff;">  
                 ...
                 <input type="hidden"name="APPRAISALSTATUS"  id="APPRAISALSTATUS" value="Pending" />  
                 <input type="hidden"name="APPOINTMENTGENERATIONDATE"  id="APPOINTMENTGENERATIONDATE" value="<?php echo date('Y-m-d'); ?>" /> 
                 <input type="hidden"name="APPRAISALELIGIBILITY"  id="APPRAISALELIGIBILITY" value="Active" /> 
             ...
             <table id="exacontapps" class="table table-table table-tabled" style="font-weight:normal; font-size:9px; width:100%;">
                  ...
                  <th style="font-size:10px;">GENERATED.DATE </th> 
                  <th style="font-size:10px;">EMPLOYEE NAME</th>
                  <th style="font-size:10px;">CONTRACT PERIOD</th> 
                  <th style="font-size:10px;">JOB STATUS</th>  
        ...
        <tbody>
             ...
             $result = mysqli_query($mysqli, "SELECT * FROM staffcontacts WHERE  APPOINTMENTGENERATIONDATE >='$date' 
			                                                              AND SUBMISSIONLEVEL ='Completed' AND JOBSTATUS ='Appointed' ORDER BY id DESC");
             ...
             $dtsxapp = $res['id']."***".$res['Serial'];
              ...
              echo "<tr>"; 
			  echo "<td>".$res['id']."</td>";
			  echo "<td>".$res['APPOINTMENTGENERATIONDATE']."</td>";
			  echo "<td>".$res['FIRSTNAME']." ".$res['LASTNAME']." ".$res['OTHERNAME']." </td>";
			  echo "<td>".$res['APPOINTMENTEFFECTIVEDATE']." - ".$res['THROUGHDATE']."</td>";
			  echo "<td>".$res['JOBSTATUS']."</td>"; 
			  echo "<td><a href=\"hrm_home/appointment_letter.php?Serial=$res[Serial]\">Get letter</a>  </td>";		 
	            }
               ?>
             </tbody>
             </table>
