...
<p style="text-align:center; font-size:12px; font-weight:bold ;">ADD INTERVIEW RESULTS</p> 
 ...
 <tr>
    ...
    <span><img src="delete.png" onClick="delete_records();" alt="delete" />delete</span>
     ...
     <a href="add-data.php" style="margin-top: -49px;" class="btn btn-danger"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Home</a>
      <a href="new_applicants.php" style="margin-top: -49px;" class="btn btn-success"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Applicants</a>
     <h5 style="font-weight:bold;"> Select and click edit button to add interview results</h5>
    </td>
	</tr> 
...
<th>##</th> 
   <th>FIRST NAME</th>
    <th>LAST NAME</th>
	<th>PHONE CONTACT</th> 
              <th>INTERVIEW LEVEL 1</th>
              <th>ITV DATE</th>
              <th>PASSMARK</th>
              <th>SCORE</th>
              <th>STATUS</th> 
              <th>INTERVIEW LEVEL 2</th>
              <th>DATE</th>
              <th>PASSMK</th>
              <th>SCORE</th>
              <th>AVG</th>
...
<?php
	$res = $MySQLiconn->query("SELECT * FROM vetting_screening WHERE COMMENT ='ELIGIBLE' AND SHORTLISTSTATUS ='SHORTLISTED' ORDER BY id DESC");
	$count = $res->num_rows;  
	...
	if($count > 0)
	{
		while($row=$res->fetch_array())   
		{
			...
			<td><?php echo $row['ITVLEVEL1DESC']; ?></td>
            <td><?php echo $row['ITVL1DATE']; ?></td> 
			<td><?php echo $row['ITVLEVEL1PASSMARK']; ?></td>
			<td><?php echo $row['ITVLEVEL1SCORE']; ?></td> 
            <td><?php echo $row['ITVLEVEL1STATUS']; ?></td> 
			<td><?php echo $row['ITVLEVEL2DESC']; ?></td> 
            <td><?php echo $row['ITVL2DATE']; ?></td>
            <td><?php echo $row['ITVLEVEL2PASSMARK']; ?></td>
			<td><?php echo $row['ITVLEVEL2SCORE']; ?></td>
