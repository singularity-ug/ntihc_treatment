      ...
      <div class="row">
        <div class="col-xs-12">
         ...
         <div class="col-lg-6 col-xs-6">
          ...
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfo"></button></i>All pending confirmations <i class=" "></i><p></p>
...
?>  
   ...
   <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfo"></button></i>Budget.desk (waiting)<i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
           <?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
if ($result = mysqli_query($link, "SELECT REQUISITIONID FROM procreqn WHERE  CORACTION ='AUTHORISED'  AND CONFSTATUS ='WAITING'  GROUP BY REQUISITIONID")) {        
    /* determine number of rows result set */
    $row_cnt = mysqli_num_rows($result);
...
?>     
        ...
        <!-- ./col -->
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfo"></button></i>Pending approvals <i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          	<?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
if ($result = mysqli_query($link, "SELECT REQUISITIONID FROM procreqn WHERE  CORACTION ='AUTHORISED' 
 AND CONFSTATUS ='CONFIRMED' AND AOACTION = 'WAITING' GROUP BY REQUISITIONID")) {        
    /* determine number of rows result set */
    $row_cnt = mysqli_num_rows($result);
...
?>    
   ...
   <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfo"></button></i>Final review (approved)<i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          <?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
if ($result = mysqli_query($link, "SELECT REQUISITIONID FROM procreqn WHERE  CORACTION ='AUTHORISED' 
 AND CONFSTATUS ='CONFIRMED' AND AOACTION = 'APPROVED' AND PROCUREMENTSTATUS = 'WAITING' GROUP BY REQUISITIONID")) {        
    /* determine number of rows result set */
    $row_cnt = mysqli_num_rows($result);
...
?>    
        ...
        <!-- ./col -->
         ...
         <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfo"></button></i>Incoming orders(PDU)<i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          <?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
if ($result = mysqli_query($link, "SELECT REQUISITIONID FROM procreqn WHERE  CORACTION ='AUTHORISED' 
AND CONFSTATUS ='CONFIRMED' AND AOACTION = 'APPROVED' AND PROCUREMENTSTATUS = 'RECEIVED' AND ORDERSTATUS = 'WAITING' GROUP BY REQUISITIONID")) {        
    /* determine number of rows result set */
    $row_cnt = mysqli_num_rows($result);
...
?> 
        ...
        <!-- ./col -->
         ...
         <div class="col-lg-6 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfo"></button></i>Progressing orders(PDU) <i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          	<?php
$link = mysqli_connect("localhost", "root", "toor2", "procurement");
...
?>    
        ...
        <!-- ./col -->
             ...
             <div class="box box-primary" style="border:0px;">
               ...
               <b style="color:#000;;">Pending procurement requisitions tracker</b></a>  </a> </div>
...
function getIndicator($str123){
	...
	if($str123==''){ 		 return '<td style="background-color:#000;">'.$str123.'</td>';  	 }
	else
	{
		  $str1234=array();
          $str1234=explode('_',$tempstr);
		  $cnt = count( $str1234);
       	if($str1234[$cnt-1]==''){   	 return '<td style="background-color:#fcf9f9;">'.$str123.'</td>';    	 }
...
$sql = "SELECT * FROM procreqn WHERE  PROCUREMENTSTATUS ='WAITING' 
                                               GROUP BY REQUISITIONID ORDER BY TIMESTAMP DESC";
 ...
 while($row=$res->fetch_assoc()){
	 ...
	 echo '<tr>'. 
                 '<td>'.$row["TIMESTAMP"].'</td>'.
				 getIndicator($row["RFPUSERNAME"]).  
				 getIndicator($row["INITIATORDEPT"]). 
				 ...
				 getIndicator($row["CONFDATE"]). 
                 '<td>'.$row["PROCUREMENTSTATUS"].'</td></tr>';
