 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
                                                 for($s=0;$s<$tot;$s++){ 
                                                  ...
                                                  <td> <input  name="dnx[]" readonly="" type="text" value="<?php  echo $dnx[$s]; ?>" 
                                                   style= "width:100%; background-color:#fff;;font-size:10px;"/></td>
                                                   
                                                  <td> <input  name="fqx[]" readonly="" type="text" value="<?php  echo $fqx[$s]; ?>"  
                                                   style= "width:100%; background-color:#fff; text-align:center; font-size:10px;"/></td> 
                                                    
                                                   
                                                     <td> <input  name="tmx[]" type="numeric" value="<?php echo $tmx[$s]; ?>" required="" 
                                                      style= "width:100%; background-color:#fff;text-align:center;font-size:10px;"/></td>  
                                                  
                                                  <td> <input  name="pdx[]" type="numeric" value="<?php echo $pdx[$s]; ?>"  readonly=""  
                                                  style= "width:100%; background-color:#fff;"/></td> 
                                                  
                                                   <td> <input  name="qtyx[]" type="text" value="<?php echo $qtyx[$s]; ?>"  required="" 
                                                   style= "width:100%; background-color:#fff;font-size:10px; "/></td> 
                                                  
                                                   <td> <input  name="ord[]" readonly="" type="text" value="<?php echo $ord[$s]; ?>" 
                                                   style= "width:100%; background-color:#FFF;text-align:right;font-size:10px;"/></td>  
                                                    
                                                    <td> <input  name="dri[]" type="numeric" value="<?php echo $dri[$s]; ?>"  readonly=""  
                                                   style= "width:100%; background-color:#FFF;text-align:right;font-size:10px;"/></td> 
