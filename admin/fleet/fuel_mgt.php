  ...
  <header class="main-header">
    <nav class="navbar navbar-static-top"> 
       <div class="navbar-header">
          <a href="../admin_dashboard.php" class="navbar-brand"><b>Dashboard</b> </a>
    ...
    <div class="panel panel-default">
                            ...
                            <div id="carousel-example" class="carousel slide" data-ride="carousel" style="border: 5px solid #000;">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <img src="imgf/Slider02.png" width="614" height="240"  alt="" class="img-u image-responsive" />
                                   </div>
                                    <div class="item">
                                     <img src="imgf/Slider03.png" width="614" height="240" alt="" class="img-u image-responsive" /> 
                                    </div>
                                    <div class="item">
                                     <img src="imgf/Slider04.png" width="614" height="240"alt="" class="img-u image-responsive" />
                                    </div>
                                </div>
                                <!--INDICATORS-->
