 ...
 <?php  $tot = count($dnx); $s=0; $totals =0;
                                                 for($s=0;$s<$tot;$s++){ 
                                                  ...
                                                  <td> <input  name1="APPRAISEESCOREA[]" name="fqx[]" type="text" value="<?php echo $fqx[$s]; ?> " 
                                                     readonly="" class="form-control" style= "width:100%; background-color:#fff;text-align:center;"/></td> 
                                                  ...
                                                  class="form-control" style= "width:100%; background-color:#fff;text-align:left;"/></td> 
                                                   ...
                                                   <td> <input  class="qty" name1="qty[]" name="variance[]" required="" type="text" value="<?php echo $variance[$s]; ?>" 
                                                   class="form-control" style= "width:100%; background-color:#fff;text-align:center;"/></td>  
                                                    
                                                    <td> <input name="ddf[]" type="text" value="<?php echo $ddf[$s]; ?>"  required=""
                                                    class="form-control" style= "width:100%; background-color:#fff;"/></td> 
...
<p>The appraisee should only be rated in areas that are relevant to his/her job. The maximum points per attribute and/or quality are ten (10). Under each attribute, the 10 points should be allocated in a manner that shows the areas of strengths and weaknesses of the appraisee. Ten (10) is the maximum per attribute and one (1) lowest. Please indicate the relevant points in the boxes provided, thereafter add up the points, and indicate the total. The score out of 20 will be got by; dividing the total score by the total maximum score for all attributes rated. Then multiply the result by 20.
   ...
   <th style="width: ;background-color: #fff;">Agreed Score</th> 
    ...
    <td> <input class="qty" name1="qty1[]" name="APPZASCOREESCB" type="text" required=""  value="<?php echo $arow['APPZASCOREESCB']; ?>"
    style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSECB" type="text" required="" 
    ...
    <td> <input class="qty" name1="qty2[]" name="APPZASCOREESCB2" type="text"  required=""  value="<?php echo $arow['APPZASCOREESCB2']; ?>"
    style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSECB2" type="text" required="" 
    ...
    <td> <input class="qty" name1="qty3[]" name="APPZASCOREESCB3" type="text" required="" value="<?php echo $arow['APPZASCOREESCB3']; ?>"
    style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC3" type="text" required=""  
    ...
    <td> <textarea  name="JUSTIFICATIONSECB4" type="text" required=""  style= "width:100%; background-color:#fff;height: 453px; "/>
	<?php echo $arow['JUSTIFICATIONSECB4']; ?></textarea></td> 
    
    <td> <input class="qty" name1="qty4[]" name="APPZASCOREESCB4" type="text"  required="" value="<?php echo $arow['APPZASCOREESCB4']; ?>" 
	style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC4" type="text"  required="" style= "width:100%; background-color:#fff;height: 453px;"/>
    ...
    <td> <textarea  name="JUSTIFICATIONSECB5" type="text" required=""  style= "width:100%; background-color:#fff;height: 214px; "/>
	<?php echo $arow['JUSTIFICATIONSECB5']; ?></textarea></td> 
    
    <td> <input class="qty" name1="qty5[]" name="APPZASCOREESCB5" type="text" required="" value="<?php echo $arow['APPZASCOREESCB5']; ?>"
	style= "width:100%; background-color:#fff; text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC5" type="text" required="" style= "width:100%; background-color:#fff; height: 214px;"/>
...
deadline with little time for adequate proof reading and revisions.
    ...
    <td> <textarea  name="JUSTIFICATIONSECB6" type="text"  required="" style= "width:100%; background-color:#fff;height: 334px; "/>
	<?php echo $arow['JUSTIFICATIONSECB6']; ?></textarea></td> 
    
    <td> <input class="qty" name1="qty6[]" name="APPZASCOREESCB6" type="text" required="" value="<?php echo $arow['APPZASCOREESCB6']; ?>"
	style= "width:100%; background-color:#fff;text-align:center; "/> </td>
        
    <td> <textarea name="APPZACOMMENTSEC6" type="text"  class="form-control" required="" style= "width:100%; background-color:#fff;height: 334px;"/>
	...
	required="" style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC7" type="text"  required=""
 ...
 <BR>
      <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		...
		<tr>   
             ...
             <br> 
         <center> <input type="submit" name="buttonsend" id="button" value="Send" /></center>   
             <br> 
