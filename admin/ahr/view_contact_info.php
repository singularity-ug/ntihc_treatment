    ...
    window.print();
       ...
       <div class="col-sm-1">
        ...
        <div class="col-sm-10">
                ...
                <img src="../../assets/img/logsbig.PNG" width="100%" height="100%" style="height:90px;"> </div>
                <center> <p style="color:#000; font-weight:bold;font-size:11px;"> <b>STAFF CONTACT FORM</b> </p> </center> 
...
<option value="Zimbabwe">Zimbabwe</option>
		...
		<tr>  
              ...
              <br>
              <P><b>I,</b> <B style="font-size:11px;"> <?php echo $nameofuser; ?></B>, 
      ...
      <a href="dashboard.php"> <span class="glyphicon glyphicon-log-in"></span> Close</a></center>
