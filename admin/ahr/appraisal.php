...
<?php 
 ...
 while($row=$res->fetch_assoc()){
	 ...
	 $FIRSTNAME  = $row['FIRSTNAME']; $LASTNAME  = $row['LASTNAME']; $OTHERNAME  = $row['OTHERNAME'];
    ...
    <section class="content-header">  
      ...
      <div class="col-sm-12">
          ...
          <br>
             ...
             <input type="hidden" name="APPOINTMENTSTARTDATE"  id="APPOINTMENTSTARTDATE"  value=" <?php  echo $APPOINTMENTSTARTDATE; ?> " >
               ...
               <tr>
                ...
                value=" <?php  echo $nameofuser; ?> " readonly="" style="width:100%; font-weight:normal; background-color:#fff;"> </th> 
...
?> 
              ...
              <tr> 
				...
				<th style="width:30%;border:0px;"> <select id="FIRSTLVSUPERVISOR" name="FIRSTLVSUPERVISOR"
              ...
              <tr> 
				...
				<th style="width:30%;border:0px;"> <select id="SECONDLVSUPERVISOR" name="SECONDLVSUPERVISOR"
				required=" " style="width:100%; font-weight:normal; background-color:#fff;">
                <option></option>
                  ddd     = "<?php   echo $stdd; ?>"; 
                 </select>
              ...
              <tr> 
                ...
                value="<?php  echo $APPRAISALMONTH; ?> <?php  echo $APPRAISALMONTHYEAR; ?>" 
				required=" "  style="width:100%; font-weight:normal; background-color:#fff;"> </th> 
              </tr>
			  </table>
               ...
               <tr> 
				...
				<th style="width:30%;border:0px;"> <input type="text" id="APPRAISALDATE" name="APPRAISALDATE" value="<?php echo date('Y-m-d'); ?>"
				required=" " style="width:100%; font-weight:normal; background-color:#fff;"> </th> 
                </tr>
			    </table>
              
   <input type="hidden" name="APPRAISEEACCOUNT"  id="APPRAISEEACCOUNT" value="<?php  echo $rm; ?>" readonly="">   
   <input type="hidden" name="APPRAISALSUBMISSIONDEADLINE"  id="APPRAISALSUBMISSIONDEADLINE" value="<?php  echo $APPRAISALSUBMISSIONDEADLINE; ?>" >  
   <input type="hidden" id="id" name="id" value="<?php  echo $id; ?>">  
   <input type="hidden" id="DATECREATED" name="DATECREATED" value="<?php echo date('Y-m-d'); ?>" >  
   <input type="hidden" name="APPRAISALFINANCIALPERIOD"  id="APPRAISALFINANCIALPERIOD" value="<?php  echo $APPRAISALFINANCIALPERIOD; ?>" readonly=""> 
  ...
  <p style=" font-weight:bold; color:#000; font-size:11px;">SECTION A: TO BE COMPLETED BY THE APPRAISEE</p>
       ...
       <table class="table-responsive" style="margin-top:0px;">
              ...
              <tr> 
                ...
                <input type="radio" id="MARITALSTATUS" name="MARITALSTATUS" value="MARRIED" checked>
                <label>Married</label> 
                 <input type="radio" id="MARITALSTATUS" name="MARITALSTATUS" value="SINGLE">
                <label>Single</label> 
                <input type="radio" id="MARITALSTATUS" name="MARITALSTATUS" value="WIDOWED">
                <label>Widowed</label> 
                 <input type="radio" id="MARITALSTATUS" name="MARITALSTATUS" value="DIVORCED">
              ...
              <tr> 
				...
				<th style="width:50%;border:0px;">  
                 <input type="radio" id="username" name="EMPLOYMENTTERMS" value="PROBATION">
                <label>Probation</label> 
                <input type="radio" id="username" name="EMPLOYMENTTERMS" value="CONTRACT">
                <label>Contract</label> 
                 <input type="radio" id="username" name="EMPLOYMENTTERMS" value="PERMANENT">
                <label>Temporary</label>  
                <input type="radio" id="username" name="EMPLOYMENTTERMS" value="SUPPORT STAFF" checked>
		...
		<thead> 
		<tr>   
				<th style="width:40%;;"> <input type="text" id="ACADEMICAWARD" name="ACADEMICAWARD"
				 style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
                  
				<th style="width:30%;"> <input type="text" id="INSTITUTION" name="INSTITUTION"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                 
				<th style="width:15%;"> <input type="date" id="FROMDATE" name="FROMDATE"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                  
                  <th style="width:15%;"> <input type="date" id="TODATE" name="TODATE"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
              </tr>
			  </table> 
		...
		<thead> 
		<tr>   
				<th style="width:40%;;"> <input type="text" id="ACADEMICAWARD1" name="ACADEMICAWARD1"
				 style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
                  
				<th style="width:30%;"> <input type="text" id="INSTITUTION1" name="INSTITUTION1"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                 
				<th style="width:15%;"> <input type="date" id="FROMDATE1" name="FROMDATE1"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                  
                  <th style="width:15%;"> <input type="date" id="TODATE1" name="TODATE1"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
              </tr>
			  </table> 
              <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		<thead> 
		<tr>   
				<th style="width:40%;;"> <input type="text" id="ACADEMICAWARD2" name="ACADEMICAWARD2"
				 style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
                  
				<th style="width:30%;"> <input type="text" id="INSTITUTION2" name="INSTITUTION2"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                 
				<th style="width:15%;"> <input type="date" id="FROMDATE2" name="FROMDATE2"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                  
                  <th style="width:15%;"> <input type="date" id="TODATE2" name="TODATE2"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
              </tr>
			  </table>  
               <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		<thead> 
		<tr>   
				<th style="width:40%;;"> <input type="text" id="ACADEMICAWARD3" name="ACADEMICAWARD3"
				 style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
                  
				<th style="width:30%;"> <input type="text" id="INSTITUTION3" name="INSTITUTION3"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                 
				<th style="width:15%;"> <input type="date" id="FROMDATE3" name="FROMDATE3"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                  
                  <th style="width:15%;"> <input type="date" id="TODATE3" name="TODATE3"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
              </tr>
			  </table>  
  <br><br> 
...
<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
 ...
 <table class="table table-tabled" id="dataTable1" style="font-weight:normal; ">
    <thead>
      <tr>
      <th>*</th>
       <th style="width:25%;">Core responsibilities/performance objectives </th> 
       <th style="width:27%; text-align:center;">Activities</th>  
       <th style="width:5%; text-align:center;">Appraisee score out of 10</th>
       <th style="width:28%; text-align:center;"><b>Justification</b>&nbsp(Give details of performance rating as against 
                                                  core duties /objectives/targets in quantifiable sums. E.g number of Deliverables seen.</th>  
       <th style="width:5%; text-align:center;">Appraiser's score</th>  
       <th style="width:5%; text-align:center;">Appraiser's comments</th>
       <th style="width:5%; text-align:center;">Agreed score</th>  
     ...
     <br>   <br>   <BR>                                      
             ...
             <p>Summary of rating / scores for B.1</p>
        <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		<thead> 
		<tr> 
		...
		<tr>  
				...
				<th style="width:18.33333333%;;"> <input type="text" id="TTSCOREA" name="TTSCOREA" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
                 
                 <th style="width:15%;">b) Total score by appraisee </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREB" name="TTSCOREB" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                
                <th style="width:15%;">c) Total agreed score </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREAGREED" name="TTSCOREAGREED" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
              </tr>
			  </table>   
		...
		<tr> 
				...
				<th style="width:18.33333333%;"> <input type="text" id="APPZIDATEA" name="APPZIDATEA" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
                 
                 <th style="width:15%;">Date </th>
				<th style="width:18.33333333%;"> <input type="text" id="APPZADATEA" name="APPZADATEA" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
		...
		<tr> 
                ...
                <th style="width:15%;">Date </th>
				<th style="width:18.33333333%;"> <input type="text" id="DIALOGUEDATEA" name="DIALOGUEDATEA" readonly=""
			  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
...
<p>The appraisee should only be rated in areas that are relevant to his/her job. The maximum points per attribute and/or quality are ten (10). Under each attribute, the 10 points should be allocated in a manner that shows the areas of strengths and weaknesses of the appraisee. Ten (10) is the maximum per attribute and one (1) lowest. Please indicate the relevant points in the boxes provided, thereafter add up the points, and indicate the total. The score out of 20 will be got by; dividing the total score by the total maximum score for all attributes rated. Then multiply the result by 20.
 ...
 <br><br>
          ...
          <input type="hidden" id="APPRAISALKEY" name="APPRAISALKEY" value="<?php echo uniqid();?>">
   ...
   <th style="width: ;background-color: #fff;">Agreed Score</th> 
    ...
    <td> <input name1="APPZISCOREESCB[]" name="APPZISCOREESCB" type="text" required="" style= "width:100%; background-color:#fff; text-align:center; "/></td> 
     
    <td> <textarea  name="JUSTIFICATIONSECB" type="text" required=""  style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty[]" name="APPZASCOREESCB" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSECB" type="text" readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input  name1="AGREEDSCORESECB[]" name="AGREEDSCORESECB" type="numeric"   value="0" readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center; "/>    </td> 
    ...
    <td> <input name1="APPZISCOREESCB2[]" name="APPZISCOREESCB2" type="text"   required="" style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    
    <td> <textarea  name="JUSTIFICATIONSECB2" type="text"  required=""  style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty2[]" name="APPZASCOREESCB2" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSECB2" type="text" readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input  name1="AGREEDSCORESECB2[]" name="AGREEDSCORESECB2" type="numeric"  value="0" readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center;"/>    </td> 
    ...
    <td> <input name1="APPZISCOREESCB3[]" name="APPZISCOREESCB3" type="text" required="" style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    <td> <textarea  name="JUSTIFICATIONSECB3" type="text" required="" style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty3[]" name="APPZASCOREESCB3" type="text"   readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC3" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input  name1="AGREEDSCORESECB3[]" name="AGREEDSCORESECB3" type="numeric"   value="0"  readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center;"/>    </td>  
    ...
    <td> <input name1="APPZISCOREESCB4[]" name="APPZISCOREESCB4" type="text"  required="" style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    
    <td> <textarea  name="JUSTIFICATIONSECB4" type="text" required=""  style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty4[]" name="APPZASCOREESCB4" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC4" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input  name1="AGREEDSCORESECB4[]" name="AGREEDSCORESECB4" type="numeric"  value="0" readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center;"/>    </td>  
    ...
    <td> <input name1="APPZISCOREESCB5[]" name="APPZISCOREESCB5" type="text" required=""  style= "width:100%; background-color:#fff; text-align:center; "/></td> 
     
    <td> <textarea  name="JUSTIFICATIONSECB5" type="text" required=""  style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty5[]" name="APPZASCOREESCB5" type="text" readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC5" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input  name1="AGREEDSCORESECB5[]" name="AGREEDSCORESECB5" type="numeric" value="0" readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center;"/>    </td> 
...
deadline with little time for adequate proof reading and revisions.
    ...
    <td> <input name1="APPZISCOREESCB6[]" name="APPZISCOREESCB6" type="text"  required="" style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    
    <td> <textarea  name="JUSTIFICATIONSECB6" type="text"  required="" style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty6[]" name="APPZASCOREESCB6" type="text" readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/> </td>
        
    <td> <textarea name="APPZACOMMENTSEC6" type="text"  class="form-control" readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input  name1="AGREEDSCORESECB6[]" name="AGREEDSCORESECB6" type="numeric"  value="0" readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center;"/>    </td>    
    ...
    <td> <input name1="APPZISCOREESCB7[]" name="APPZISCOREESCB7" type="text" required="" style= "width:100%; background-color:#fff; text-align:center; "/></td> 
     
    <td> <textarea  name="JUSTIFICATIONSECB7" type="text" required="" style= "width:100%; background-color:#fff;height: 18px; "/></textarea></td> 
    
    <td> <input class="qty" name1="qty7[]" name="APPZASCOREESCB7" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC7" type="text"  readonly="" style= "width:100%; background-color:#fcfcfc;height: 18px;"/></textarea></td>  
     
    <td> <input type="numeric" name1="AGREEDSCORESECB7[]" name="AGREEDSCORESECB7" value="0"  readonly="" style= "width:100%; background-color:#fcfcfc; text-align:center;"/>    </td>    
     ...
     <td>   </td>
     <div id="grand">
     <td><input type="numeric" name="ORDERVALUE" name1="gran" id="gran"  readonly="" style="width:100%; text-align:center;background-color:#fcfcfc; font-weight:bold;"></td>   
     </div>                                                 
    </tr>  
    </tbody> </table>  
     ...
     <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		...
		<tr>  
                <th style="width:15%;">a) Total score by appraisee </th>
				<th style="width:18.33333333%;;"> <input type="text" id="TTSCOREAQ" name="TTSCOREAQ" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
                 
                 <th style="width:15%;">b) Total score by appraisee </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREBQ" name="TTSCOREBQ" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                
                <th style="width:15%;">c) Total agreed score </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREAGREEDQ" name="TTSCOREAGREEDQ" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
              </tr>
			  </table>   
		...
		<tr> 
                <th style="width:15%;">Date</th>
				<th style="width:18.33333333%;"> <input type="text" id="APPZIDATEAQ" name="APPZIDATEAQ" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
                 
                 <th style="width:15%;">Date </th>
				<th style="width:18.33333333%;"> <input type="text" id="APPZADATEAQ" name="APPZADATEAQ" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
		...
		<tr> 
                ...
                <th style="width:15%;">Date </th>
				<th style="width:18.33333333%;"> <input type="text" id="DIALOGUEDATEAQ" name="DIALOGUEDATEAQ" readonly=""
			  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
       ...
       <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		...
		<tr>  
                <th style="width:15%;">a) Total score by appraisee </th>
				<th style="width:18.33333333%;;"> <input type="text" id="TTSCOREAW" name="TTSCOREAW" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
                 
                 <th style="width:15%;">b) Total score by appraisee </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREBW" name="TTSCOREBW" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                
                <th style="width:15%;">c) Total agreed score </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREAGREEDW" name="TTSCOREAGREEDW" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
              </tr>
			  </table>   
		...
		<tr> 
                <th style="width:15%;">Date</th>
				<th style="width:18.33333333%;"> <input type="text" id="APPZIDATEAW" name="APPZIDATEAW" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
                 
                 <th style="width:15%;">Date </th>
				<th style="width:18.33333333%;"> <input type="text" id="APPZADATEAW" name="APPZADATEAW" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
		...
		<tr> 
                ...
                <th style="width:15%;">Date </th>
				<th style="width:18.33333333%;"> <input type="text" id="DIALOGUEDATEAW" name="DIALOGUEDATEAW" readonly=""
			  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
   ...
   (USE AND ATTACH ADDITIONAL PAPER IF YOUR SECTION C 2 IS TO EXCEED 1 PAGE)
     ...
     <td style="width:20%;border:0px;"> <input type="date" name="DIALOGUEDATEONE" readonly = "" style="width:100%; background-color:#fcfcfc;"> </td>  
	 </tr>  </table>
     ...
     <input type="radio" name="" value="YES" class="flat-green" disabled >
     <label>YES</label>
     <input type="radio" name="" value="NO" class="flat-red" disabled >
     <label>NO</label>
     </td>  
	 </tr>  </table>        
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
     ...
     <textarea name="DIALOGUEDISATISFACTIONIFNO" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>    
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="DIALOGUESATISFACTIONIFYES" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table> 
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="PERFORMANCEMETRICS" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table> 
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="AREASTHATNEEDIMPROVEMENT" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table> 
    ...
    C.1.7 What contribution has the appraisee made beyond the normal requirements of his/her job?
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="EXCEPTIONALCONTRIBUTION" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>   
    ...
    C.1.9    Indicate the appraisee’s potential for development in his/her career with  NTIHC
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="POTENTIALFORDEVELOPMENT" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="DIALOGUEACTION" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="MANAGERIALACTIONFORIMPROVEMENT" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
		...
		<tr>  
				...
				<th style="width:18.33333333%;;"> <input type="text" id="APPRAISERNAME" name="APPRAISERNAME" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th> 
				...
				<th style="width:18.33333333%;"> <input type="text" id="APPRAISERDIALOGUEDATE" name="APPRAISERDIALOGUEDATE" readonly=""
				  style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
              </tr>
			  </table>    
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="FACILITATINGFACORS" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="CONSTRAININGFACORS" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="SUPPORTAREAS" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="MEASURESREQUIRED" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>   
 ...
 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="CONTRIBUTIONBEYONDNORMAL" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>   
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="EXPECTATIONSFROMENTITY" readonly = "" style="width:100%; background-color:#fcfcfc;" ></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <td style="width:20%;border:0px;"> 
     <input type="radio" name="" value="DISAGREE"  checked>
     <label>DISAGREE</label>
     <input type="radio" name="" value="AGREE" >
     <label>AGREE</label>
     </td>  
	 </tr>  </table>   
 ...
 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
  ...
  C.2.9   Specific actions or improvements that I have agreed with the appraiser to enhance my effectiveness in the next appraisal review period.
     ...
     <input type="text" name="AGREEDACTIONFORIMPROVEMENT1`" placeholder="1" readonly="" style="width:100%; text-align:left;background-color:#fcfcfc;" > 
     <input type="text" name="AGREEDACTIONFORIMPROVEMENT2`" placeholder="2" readonly="" style="width:100%; text-align:left;background-color:#fcfcfc;" >
     </td>  
	 </tr>  </table>  
  ...
  <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		...
		<tr>  
				...
				<th style="width:18.33333333%;;"> <input type="text" id="APPRAISEENAME" name="APPRAISEENAME" readonly=""
				 style="width:100%; font-weight:normal; background-color:#fcfcfc; border: 1px;"> </th> 
     ...
     <input type="radio" name="" value="CONFIRMED" >
     <label>CONFIRM</label>
     <input type="radio" name="" value="REJECTED">
     <label>REJECT</label>
     </td>  
	 </tr>  </table> 
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <input type="text" name="SPECIFYOTHERACTIONS" readonly="" style="width:100%; background-color:#f1f1f1"  > 
     </td>  
	 </tr>  </table> 
      ...
      <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		...
		<tr>  
		      ...
		      <tr>    
				...
				<th style="width:40%;"> <input type="text" id="FIRSTLEVELSUPNAME" name="FIRSTLEVELSUPNAME" readonly=""
				style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                   
                <th style="width:20%;">   </th> 
                 
                <th style="width:20%;"> <input type="text" id="FIRSTLEVELSUPDATE" name="FIRSTLEVELSUPDATE" readonly""
				style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                </tr>
			    </table>   
		      ...
		      <tr>    
				...
				<th style="width:40%;"> <input type="text" id="SECONDLEVELSUPNAME" name="SECONDLEVELSUPNAME" readonly =""
				style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                   
                <th style="width:20%;">   </th> 
                 
                <th style="width:20%;"> <input type="text" id="SECONDLEVELSUPDATE" name="SECONDLEVELSUPDATE" readonly=""
				style="width:100%; font-weight:normal; background-color:#fcfcfc;border: 1px;"> </th>  
                </tr>
			    </table>    
...
<BR>    
 ...
 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
     ...
     <tr> 
     <th style="width:1000%; text-align:left; border:0px;">  
     <textarea name="PDCOMMENT"  readonly="" style="width:100%; background-color:#fcfcfc;" > </textarea> 
     </td>  
	 </tr>  </table> 
 ...
 <BR>
      <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
       ...
       <input  type="hidden" name="equity7" name1="equity7[]"/> 
         <br> <br> <br> 
         <center> <input type="submit" name="buttonsend" id="button" value="Save appraisal" /></center>   
...
<script>
   ...
   function addRow13(tableId){
     ...
     var s12 = '<input type="text" onKeyUp="domeeitem(this)" name="dpp[]" id="dpp'+rowCount+'" autocomplete="off"  required="required" '+
              ' style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; background-color:#fff" >';
     ...
     var s13 = '<input type="text" onKeyUp="domeeitem(this)" name="dcm[]" id="dcm'+rowCount+'" autocomplete="off"  required="required" '+
              ' style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; background-color:#fff" >';
 
	 var tm = '<input type="text" onkeyup="dostg(this.id)" onchange="dostg(this.id)" name="variance[]" id="variance_'+rowCount+'" readonly="readonly" '+
	           'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:#fcfcfc;" />';
			    
	 var s14 = '<input type="text" onKeyUp="domeeitem(this)" name="ddf[]" id="ddf'+rowCount+'" autocomplete="off"  readonly="readonly" '+
              ' style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; background-color:#f1f1f1" >';
		    
	 var qty = '<input type="numeric" name="qtyx[]" id="qtyx_'+rowCount+'"  readonly="readonly" '+
                                        'style= "margin-left: 0px;margin-top: 5px;height:20px; width:100%; text-align:center; background-color:#fcfcfc;" />';
 ...
 function deleteRow13(tableID) {
	     ...
	     for(var i=1; i<rowCount; i++) {
		  ...
		  table.rows[x].cells[2].childNodes[0].id="dpp_"+x; 
		  table.rows[x].cells[3].childNodes[0].id="fqx_"+x;    
		  table.rows[x].cells[4].childNodes[0].name="dcm_"+x; 
		  table.rows[x].cells[5].childNodes[0].id="variance_"+x; 
		  table.rows[x].cells[6].childNodes[0].id="ddf_"+x;    
