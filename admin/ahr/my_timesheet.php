      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
       ...
       <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
          <ul class="nav navbar-nav">
           <li class="active"><a href="../timesheet/index.php" class="" >My timesheet<span class="sr-only">(current)</span></a></li>  
            <li class="active"><a href="../timesheet/supervisor.php" class="" >Supervisor<span class="sr-only">(current)</span></a></li>  
            <li class="active"><a href="../timesheet/myreviews.php" class="" > My reviews<span class="sr-only">(current)</span></a></li>   
          </ul>
      </div>
      <!-- Navbar Right Menu -->
  ...
  <!-- Content Wrapper. Contains page content --> 
    ...
    <section class="content-header">  
      ...
      <div class="col-sm-12">
          ...
          <font style=" font-weight:bold; color:#000; font-size:11px;"><center>STAFF TIMESHEET</center></font>
          <br>
