 ...
 <div class="col-sm-1">
   <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                      <div class="div-square">
                            <a href="my_appraisal.php" >
  <i class="fa fa-rocket fa-5x" style="color:#00a65a;font-size: 30px;"></i>
                      <h4 style="font-size:14px;">Home </h4>
                      </a>
                      </div> 
                  </div>
 </div>
              
         <div class="col-sm-10" style="height:100%; border: 1px #f8f1f1 solid;border-radius: 4px;">
     
          <img src="../hrm_home/img/logsbigxt.PNG"  width="100%" height="100%" style="height:90px;">   
          ...
          <br>
             ...
             <input type="hidden" name="APPRAISALKEY"  id="APPRAISALKEY"  value=" <?php  echo $APPRAISALKEY; ?> " > 
              ...
              <tr> 
				...
				readonly=" " style="width:100%; font-weight:normal; background-color:#fff;">  
...
This section is a summary of the Employee’s Assessment of their performance.  The Employee shall be expected to identify the core responsibilities as per their job descriptions/pre-determined agreed objectives and targets, and to score themselves against a scale of 1 to 10, with 1 being the lowest and 10 being the highest score, in reference to the above performance level categories.  The Appraiser will then appraise the employee performance and indicate the scores in the column for the appraiser. The Appraiser and Appraise will then have a dialogue meeting to discuss the performance, the performance and arrive at an agreed score to be filled in the column for agreed score.</P>
       ...
       <p style=" font-weight:bold; color:#000; font-size:12px;"> 
	   Each score must be justified and supported with explanations and details of the actual activities undertaken.</p>
       ...
       <th style=" text-align:center;">Agreed score</th>       
								...
								<tbody>
									<?php
										...
										$total1=0;
										$total2=0;
										$total00=0; $total11=0; $total22=0;  
										$s=mysqli_query($conn,"select * from appraisal_b WHERE `APPRAISALKEY` = '$id'");
										while($srow=mysqli_fetch_array($s)){
											?>
											<tr>
                                            
												 <td><?php echo $srow['CORERESPONSIBILITY']; ?></td>
                                                
												  <td><?php echo $srow['ACTIVITY']; ?></td> 
                                                 
                                                  <td style="text-align:center;">
													<?php 
														$sub=$srow['APPRAISEESCOREA'];
												  ...
												  <td>
												  <?php echo $srow['JUSTIFICATION']; ?></td> 
												 
												<td style="text-align:center;">
													<?php 
														$sub=$srow['APPRAISERCOREA'];
														echo number_format($sub,1);
														$total1+=$sub;
													?>
												</td> 
												 ...
												 <td><?php echo $srow['APPRAISERSCOMMENT']; ?></td>  
												   
												
												 <td style="text-align:center;">
													<?php 
														$sub=$srow['AGREEDSCOREA'];
														echo number_format($sub,1);
														$total2+=$sub;
													?>
												</td>  
									...
									<tr>
                                        ...
                                        <td><strong> <center><?php echo number_format($total,1); ?></center> </strong></td>
										
										<td colspan="1" align="center"> </td>
										
										<td><strong> <center><?php echo number_format($total1,1); ?></center> </strong></td>
										 
										<td colspan="1" align="center"> </td>
										
										<td><strong> <center><?php echo number_format($total2,1); ?></center> </strong></td>
									</tr> 
								</tbody>
							</table>
         ...
         <p style=" font-weight:bold; color:#000; font-size:12px;">   
        Summary of rating / scores for B.1 </p>   
		...
		<tr>  
				...
				<th style="width:18.33333333%;;"> <input type="text" id="TTSCOREA" name="TTSCOREA" readonly="" value="<?php echo number_format($total,1); ?>"
				 style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th> 
                 
                 <th style="width:15%;">b) Total score by appraisee </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREB" name="TTSCOREB" readonly="" value="<?php echo number_format($total1,1); ?>"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                
                <th style="width:15%;">c) Total agreed score </th>
				<th style="width:18.33333333%;"> <input type="text" id="TTSCOREAGREED" name="TTSCOREAGREED" readonly="" value="<?php echo number_format($total2,1); ?>"
				  style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
              </tr>
			  </table>   
...
<p style="font-weight:bold;">Analysis and assessment of critical attributes readonly to perform the activities</p>
<p>The appraisee should only be rated in areas that are relevant to his/her job. The maximum points per attribute and/or quality are ten (10). Under each attribute, the 10 points should be allocated in a manner that shows the areas of strengths and weaknesses of the appraisee. Ten (10) is the maximum per attribute and one (1) lowest. Please indicate the relevant points in the boxes provided, thereafter add up the points, and indicate the total. The score out of 20 will be got by; dividing the total score by the total maximum score for all attributes rated. Then multiply the result by 20.
     ...
     <p style="font-weight:bold;"> Rating by the Appraisee and the Appraiser/ Supervisor</P>
   ...
   <th style="width: ;background-color: #fff;">Agreed Score</th> 
    ...
    <td> <input name1="APPZISCOREESCB[]" name="APPZISCOREESCB" type="text" readonly ="" value="<?php echo $arow['APPZISCOREESCB']; ?>"
    style= "width:100%; background-color:#fff; text-align:center; "/></td> 
     
    <td> <textarea  name="JUSTIFICATIONSECB" type="text" readonly="" 
    style= "width:100%; background-color:#fff;height:153px; "/> <?php echo $arow['JUSTIFICATIONSECB']; ?></textarea></td> 
    
    <td> <input class="qty" name1="qty1[]" name="APPZASCOREESCB" type="text" readonly=""  value="<?php echo $arow['APPZASCOREESCB']; ?>"
    style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSECB" type="text" readonly="" 
    style= "width:100%; background-color:#fff;height: 153px;"/> <?php echo $arow['APPZACOMMENTSECB']; ?></textarea></td>  
    ...
    <td> <input name1="APPZISCOREESCB2[]" name="APPZISCOREESCB2" type="text" readonly=""  value="<?php echo $arow['APPZISCOREESCB2']; ?>"
    style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    
    <td> <textarea  name="JUSTIFICATIONSECB2" type="text"  readonly=""   
    style= "width:100%; background-color:#fff;height: 249px; "/> <?php echo $arow['JUSTIFICATIONSECB2']; ?> </textarea></td> 
    ...
    style= "width:100%; background-color:#fff; height: 249px;"/>  <?php echo $arow['APPZACOMMENTSECB2']; ?> </textarea></td>  
    ...
    <td> <input name1="APPZISCOREESCB3[]" name="APPZISCOREESCB3" type="text" readonly="" value="<?php echo $arow['APPZISCOREESCB3']; ?>"
    style= "width:100%; background-color:#fff; text-align:center; "/></td>
      
    <td> <textarea  name="JUSTIFICATIONSECB3" type="text" readonly="" 
    style= "width:100%; background-color:#fff;height: 538px; "/> <?php echo $arow['JUSTIFICATIONSECB3']; ?> </textarea></td> 
    ...
    style= "width:100%; background-color:#fff;height: 538px;"/> <?php echo $arow['APPZACOMMENTSEC3']; ?> </textarea></td>  
    ...
    <td> <input name1="APPZISCOREESCB4[]" name="APPZISCOREESCB4" type="text"  readonly="" value="<?php echo $arow['APPZISCOREESCB4']; ?>" 
	style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    
    <td> <textarea  name="JUSTIFICATIONSECB4" type="text" readonly=""  style= "width:100%; background-color:#fff;height: 453px; "/>
    ...
    <td> <textarea name="APPZACOMMENTSEC4" type="text"  readonly="" style= "width:100%; background-color:#fff;height: 453px;"/>
    ...
    <td>  
     ...
     <li>Knows decisions to make at his/her level and identifies information readonly to take appropriate decision. </li>
    ...
    <td> <input name1="APPZISCOREESCB5[]" name="APPZISCOREESCB5" type="text" readonly=""  value="<?php echo $arow['APPZISCOREESCB5']; ?>"
	style= "width:100%; background-color:#fff; text-align:center; "/></td> 
     
    <td> <textarea  name="JUSTIFICATIONSECB5" type="text" readonly=""  style= "width:100%; background-color:#fff;height: 214px; "/>
    ...
    <td> <textarea name="APPZACOMMENTSEC5" type="text" readonly="" style= "width:100%; background-color:#fff; height: 214px;"/>
...
deadline with little time for adequate proof reading and revisions.
    ...
    <td> <input name1="APPZISCOREESCB6[]" name="APPZISCOREESCB6" type="text"  readonly="" value="<?php echo $arow['APPZISCOREESCB6']; ?>"
	style= "width:100%; background-color:#fff; text-align:center; "/></td>  
    
    <td> <textarea  name="JUSTIFICATIONSECB6" type="text"  readonly="" style= "width:100%; background-color:#fff;height: 334px; "/>
    ...
    <td> <textarea name="APPZACOMMENTSEC6" type="text"  class="form-control" readonly="" style= "width:100%; background-color:#fff;height: 334px;"/>
    ...
    <td> <input name1="APPZISCOREESCB7[]" name="APPZISCOREESCB7" type="text" readonly="" value="<?php echo $arow['APPZISCOREESCB7']; ?>"
	style= "width:100%; background-color:#fff; text-align:center; "/></td> 
     
    <td> <textarea  name="JUSTIFICATIONSECB7" type="text" readonly=""  
	 style= "width:100%; background-color:#fff;height: 118px; "/><?php echo $arow['JUSTIFICATIONSECB7']; ?> </textarea></td> 
    
    <td> <input class="qty" name1="qty7[]" name="APPZASCOREESCB7" type="text"  value="<?php echo $arow['APPZASCOREESCB7']; ?>"
	readonly="" style= "width:100%; background-color:#fff;text-align:center; "/>
    </td>
        
    <td> <textarea name="APPZACOMMENTSEC7" type="text"  readonly=""
	style= "width:100%; background-color:#fff;height: 118px;"/><?php echo $arow['APPZACOMMENTSEC7']; ?> </textarea></td>  
	...
	style= "width:100%; background-color:#fff; text-align:center;"/>    </td>    
	 ...
	 style="width:100%; text-align:center;background-color:#fff; font-weight:bold;"></td>   
     </div>                                                 
     </tr>  
     </tbody> </table>  
   ...
   <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
     ...
     <textarea name="DIALOGUEREASONFORDISAGREE" readonly = "" style="width:100%; background-color:#fff;" > <?php echo $arow['DIALOGUEREASONFORDISAGREE']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>    
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="DIALOGUESATISFACTIONIFYES" readonly = "" style="width:100%; background-color:#fff;" > <?php echo $arow['DIALOGUESATISFACTIONIFYES']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table> 
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="PERFORMANCEMETRICS" readonly = "" style="width:100%; background-color:#fff;" > <?php echo $arow['PERFORMANCEMETRICS']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table> 
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="AREASTHATNEEDIMPROVEMENT" readonly = "" style="width:100%; background-color:#fff;" > <?php echo $arow['AREASTHATNEEDIMPROVEMENT']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table> 
    ...
    C.1.7 What contribution has the appraisee made beyond the normal requirements of his/her job?
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="EXCEPTIONALCONTRIBUTION" readonly = "" style="width:100%; background-color:#fff;" > <?php echo $arow['EXCEPTIONALCONTRIBUTION']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>   
    ...
    C.1.9    Indicate the appraisee’s potential for development in his/her career with  NTIHC
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="POTENTIALFORDEVELOPMENT" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['POTENTIALFORDEVELOPMENT']; ?></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="DIALOGUEACTION" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['DIALOGUEACTION']; ?></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="MANAGERIALACTIONFORIMPROVEMENT" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['MANAGERIALACTIONFORIMPROVEMENT']; ?></textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="FACILITATINGFACORS" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['FACILITATINGFACORS']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="CONSTRAININGFACORS" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['CONSTRAININGFACORS']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="SUPPORTAREAS" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['SUPPORTAREAS']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="MEASURESREQUIRED" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['MEASURESREQUIRED']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>   
 ...
 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="CONTRIBUTIONBEYONDNORMAL" readonly = "" style="width:100%; background-color:#fff;" ><?php echo $arow['CONTRIBUTIONBEYONDNORMAL']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>   
     ...
     <tr>  
     <td style="width:100%;border:0px;"> 
     <textarea name="EXPECTATIONSFROMENTITY" readonly = "" style="width:100%; background-color:#fff;" > <?php echo $arow['EXPECTATIONSFROMENTITY']; ?>
	 </textarea>  
     </td>  
	 </tr>  </table>
 ...
 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
  ...
  C.2.9   Specific actions or improvements that I have agreed with the appraiser to enhance my effectiveness in the next appraisal review period.
     ...
     <input type="text" name="AGREEDACTIONFORIMPROVEMENT1`" placeholder="1" readonly="" value="<?php echo $arow['AGREEDACTIONFORIMPROVEMENT1']; ?>" style="width:100%; text-align:left;background-color:#fff;" > 
     <input type="text" name="AGREEDACTIONFORIMPROVEMENT2`" placeholder="2" readonly="" value="<?php echo $arow['AGREEDACTIONFORIMPROVEMENT2']; ?>" style="width:100%; text-align:left;background-color:#fff;" >
     </td>  
	 </tr>  </table>  
		...
		<tr>  
		      ...
		      <tr>    
                ...
                <th style="width:20%;"> <input type="text" id="NEXTPERFORMANCEOBJECTIVE1" name="NEXTPERFORMANCEOBJECTIVE1" readonly=""
				 value="<?php echo $arow['NEXTPERFORMANCEOBJECTIVE1']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"></th> 
                    
				<th style="width:35%;"> <input type="text" id="NEXTACTIVITY1" name="NEXTACTIVITY1" readonly=""
				 value="<?php echo $arow['NEXTACTIVITY1']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                   
                <th style="width:20%;"> <input type="text" id="NEXTTARGET1" name="NEXTTARGET1" readonly=""
				 value="<?php echo $arow['NEXTTARGET1']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;">  </th> 
                 
                <th style="width:20%;"> <input type="text" id="NEXTTIMEFRAME1" name="NEXTTIMEFRAME1" readonly=""
				 value="<?php echo $arow['NEXTTIMEFRAME1']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                </tr>
			    </table>   
		      ...
		      <tr>    
				...
				value="<?php echo $arow['NEXTPERFORMANCEOBJECTIVE2']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"></th> 
                    
				<th style="width:35%;"> <input type="text" id="NEXTACTIVITY2" name="NEXTACTIVITY2" readonly
				value="<?php echo $arow['NEXTACTIVITY2']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                   
                <th style="width:20%;"> <input type="text" id="NEXTTARGET2" name="NEXTTARGET2" readonly
				value="<?php echo $arow['NEXTTARGET2']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;">  </th> 
                 
                <th style="width:20%;"> <input type="text" id="NEXTTIMEFRAME2" name="NEXTTIMEFRAME2" readonly
				value="<?php echo $arow['NEXTTIMEFRAME2']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                </tr>
			    </table>       
...
<BR>    
 ...
 <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
     ...
     <tr> 
     <th style="width:1000%; text-align:left; border:0px;">  
     <textarea name="PDCOMMENT"  readonly="" style="width:100%; background-color:#fff;" > <?php echo $arow['PDCOMMENT']; ?> </textarea> 
     </td>  
	 </tr>  </table> 
      ...
      <table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 11px;border: 0px;	text-align:left;" width="100%">
		...
		<tr>   
		      ...
		      <tr>     
				...
				value="<?php echo $arow['PROGDIRECTORNAME']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                   
                <th style="width:20%;background-color:#fff;">   </th> 
                 
                <th style="width:20%;"> <input type="text" id="PDAPPROVALDATE" name="PDAPPROVALDATE" readonly
				value="<?php echo $arow['PDAPPROVALDATE']; ?>" style="width:100%; font-weight:normal; background-color:#fff;border: 1px;"> </th>  
                </tr>
			    </table>    
	   ...
	   <input  type="hidden" name="equity1" name1="equity1[]"/>
...
$(document).ready(function() { 
        ...
        $("input[name1='qty[]']").each(function (index) {
			...
			var qty1 = $("input[name1='qty1[]']").eq(index).val(); 
			...
			var equity1 = parseInt(APPZISCOREESCB) + parseInt(qty1);
			...
			var AGREEDSCORESECB  = parseInt(equity1) / parseInt(dice);
