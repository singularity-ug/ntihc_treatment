...
<body class="hold-transition skin-blue sidebar-mini" style="background-color:transparent;">  
    ...
    <tr>  
      ...
      <a href="#tab_1-1" data-toggle="tab" style="background-color:transparent;">
          <center><img src="../../database icons/guests.jpg"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969; height:50px; width:50px;"> 
      ...
      <a href="#tab_2-2" data-toggle="tab">
           <img src="../../database icons/icon-resources-staffing.png"width="100" height="100" class="img-circle" style="border: 3px solid #6c6969;height:50px; width:50px;" > 
           HCT&nbsp;history&nbsp;&nbsp; </a> </td>  
           </tbody>
           </table>
       </div> 
