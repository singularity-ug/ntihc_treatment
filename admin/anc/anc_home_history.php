  ...
  <div class="content-wrapper" style="background-color: #dddddd; height:auto;"> 
    ...
    <section class="content"> 
       ...
       <img src="../../assets/img/logsbig.PNG" width="100%" height="30%" style="height:90px;">
             <p style="text-transform:uppercase; font-weight:bold; text-align:center; font-family:algeria; font-size:18px;">antenatal care</p>
...
$date = date("Y-m-d").' 00:00:00'; 
$result = mysqli_query($mysqli, "SELECT * FROM  cmpatientsregistration WHERE SERVICETYPE ='PREGNANCY RELATED SERVICES' 
  AND INSVCSTATUS ='ANC SERVICES'
	...
	$dts = $res['RID']."***".$res['NTIHCNO']."***".$res['AGE1']."***".$res['AGE_GROUP'];
		...
		echo '<td>
		&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;
              <a id="390__'.$dts.'" href="javascript:void(0)" onclick="medix(this.id)" data-toggle="tooltip" title="Others"
              <span class="glyphicon glyphicon-share"> </span></a> </td>';
