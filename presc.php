...
while( $row1    = $result1->fetch_assoc()){
  ...
  <td>
   <input type="text" name="DRUGNAME"  value="'.$row['DRUGNAME'].'"  id="" required="required" 
    style= " width:100%; background-color:#fff;"/>
  </td>
  
 <td>
 <input type="numeric" name="FREQUENCY" value="'.$row['FREQUENCY'].'"  required="required" 
  style= "width:100%; background-color:#fff; text-align:center;"/> 
  </td>
  
   <td><input type="numeric" value="'.$row['TIMES'].'" name="TIMES" id=""  required="required" 
  style= "width:100%; background-color:#fff; text-align:center;"/> 
  </td>
  
  <td><input type="numeric" value="'.$row['PERIOD'].'" name="PERIOD" id="" required="required"
   style= "width:100%; background-color:#fff; text-align:center;"/> 
  </td>
  
  <td><input type="numeric"  value="'.$row['QTYPRESCRIBED'].'" name="QTYPRESCRIBED" required="required"
  style= "width:100%; background-color:#fff; text-align:center;"/> 
  </td>
   
 <td><input type="double"   value="'.$unit.'" name="UNITRATE" id="" required="required"
 style= "width:100%; background-color:#fff;"/>
</td>
</tr>';
            ...
            <table class="table" style="border:0px;">
              <tr> 
               ...
               <center> <input type="submit" name="button" id="button" value="Dispense"/>
                <a href="client_dispenser.php" style="border: 1px solid #000; padding: 2px;border-radius: 3px; font-weight:bold;"> New <span class="sr-only">(current)</span></a> 
               </center>
