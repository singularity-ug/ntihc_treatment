   ...
   function post()
{
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="dashboard.php">Dashboard</a></li>
                                     <li><a href="fleetmgr.php" style="border: 2px solid #000; padding: 10.5px; color: #000000;"><i class="icon-lock icon-white"></i>Home</a></li>
                                     <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#newReg20 " style="border: 2px solid #000; padding: 10.5px; color: #000000;background-color:#fb455f;"> </button> <i class="icon-lock icon-white"></i>Admin</a></li>
                                    
                                    <li class='dropdown '>
                                        <a href="" class="dropdown-toggle" data-toggle="dropdown" style="border:2px solid #000; padding: 10.5px; 2px solid #000;color:#000;">
                                            Quick edit<b class="caret"></b>  </a>
                                        <ul class="dropdown-menu"> 
                                        <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#notificationModal" style="color: #000;border: 2px solid #000; text-align:left;"> </button> <i class="icon-lock icon-white"></i>Transport booking</a></li>
 ...
 <li><a href="fleetmgr.php" style="border: 2px solid #000; padding: 10.5px; color: #000000;"><i class="icon-lock icon-white"></i>Driver contacts</a></li>
 <li><a href="fleetmgr.php" style="border: 2px solid #000; padding: 10.5px; color: #000000;"><i class="icon-lock icon-white"></i>Appraisal form</a></li>
<li><a href="fleetmgr.php" style="border: 2px solid #000; padding: 10.5px; color: #000000;"><i class="icon-lock icon-white"></i>Assets allocation</a></li>  
</div>
             ...
             NAGURU TEENAGE INFORMATION AND HEALTH CENTRE   </h3>
                    ...
                    <div id="content">
                    <div class="outer">
                    <div class="inner bg-light lter6" style="height:auto; background-color:#fff;">
 ...
 <div class="col-sm-6" > 
	 ...
	 <a href="#"><img src="assets/sysicons/imaggges.jpg" width="80" height="140" alt="Marcel Newman" class="img-circle" >
				 <!-- /thumbnail -->
	 ...
	 <a href="#"><img src="assets/sysicons/iconfuelimages.jpg" width="80" height="140" alt="Marcel Newman" class="img-circle" >
				 <!-- /thumbnail -->
     ...
     <div class="dash-unit">  
      ...
      <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#newReg2 " style="color: #000000;border: 2px solid #000;width: 150px; margin-top: -21px; background-color:#f4cb55;text-align:left;"> </button> <i class="icon-lock icon-white"></i>Fuel request tracker</a></li> 
     ...
     <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#newReg4 " style="color: #000000;width: 150px;border: 2px solid #000;margin-top: -21px; text-align:left;background-color:#8bcf3f;"> </button> <i class="icon-lock icon-white"></i>Due service reminder</a></li>
      <p style="text-align:center; font-weight:bold; font-size:34px; color:#fff;margin-top: -6px;">0</p>
      
      <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#newReg5 " style="margin-top:-36pxx;width: 150px;color: #000000;border: 2px solid #000; text-align:left; margin-top: -6px;"> </button> <i class="icon-lock icon-white"></i>Fleet hire tracker</a></li> 
      
      <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#newReg6 " style="width: 150px;color: #000000;border: 2px solid #000; text-align:left;  margin-top: -6px;"> </button> <i class="icon-lock icon-white"></i>Drivers contracts</a></li> 
      ...
      <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#newReg8 " style="background-color:#f4cb55;width: 150px;color: #000000;border: 2px solid #000; text-align:center;"> </button> <i class="icon-lock icon-white"></i>Contact fleet admin</a></li> 
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
    ...
    <!------/ end modals------> 
     ...
     <div class="col-lg-12">
                        <div class="modal fade" id="newReg20" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="container"> 
          ...
          <p class="lead text-muted">Please contact system admin!</p>
