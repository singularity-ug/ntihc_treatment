...
<html><head>
    ...
    <script type="text/javascript" src=" js/admin.js"></script>
     <script type="text/javascript" src="assets/js/gen_validatorv31.js"></script>
  ...
  <body>
        ...
        <div class="navbar-header">
          ...
          <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
             <img src="assets/img/ntihclog2.png" width="40" height="50" style="margin-left: 210px; margin-top: -11px;">
    ...
    <div class="container" style="height:1050px;">
      ...
      <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit"> 
                ...
                <h1>PDU</h1> 
				<div class="thumbnail"> 
					<img src="database icons/employee.jpg" width="140" height="200" alt="Marcel Newman" class="img-circle">
				</div><!-- /thumbnail --> 
				<br>
					<div class="info-user">  
                   <a href="pdu.php"><i class="li_settings fs1"></i> </a> 
					</div>
				       </div></div>
      ...
      <!-- DONUT CHART BLOCK -->
        <div class="col-sm-3 col-lg-3">
      		<div class="dash-unit">
                ...
                <h1>Budget desk</h1> 
				<div class="thumbnail"> 
				 <img src="database icons/press-nozbe.png" width="140" height="200" alt="Marcel Newman" class="img-circle">
				</div><!-- /thumbnail --> 
				<br>
					<div class="info-user">  
      ...
      <!-- DONUT CHART BLOCK -->
        <div class="col-sm-3 col-lg-3">
	        ...
	        <hr>
                <h1>Stores</h1> 
				<div class="thumbnail"> 
					<img src="database icons/Nepal+facing+site_Procurement+Icon.png" width="140" height="200" alt="Marcel Newman" class="img-circle">
				</div><!-- /thumbnail --> 
				<br>
					<div class="info-user">  
                   <a href="store_admin.php"><i class="li_settings fs1"></i> </a> 
				</div><!-- /thumbnail --> 
					<div class="info-user">  
					</div>
			</div> </div> 
      ...
      <div class="row" style="width: 1140px; margin-left:0px;"> 
      		<div class="dash-unit"> 
      			<div class="text">
      			<h2 class="demoHeaders">Procurement</h2> 
<div id="tabs">
	<ul>
   ...
   <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3" style="width:531px; margin-left:-38px; height:250px"> 
      		<div class="half-unit" style="height: 280px; margin-top: -13px;"/> 
...
<fieldset >
<legend style="width: 495px;"> Search</legend>

<div class='container'>
    <input type='text' name='q' id='q'  maxlength="250" class="form-control" style="width: 481px;" />
    <input type='submit' name='Submit' value='Search' />
            ...
            <!-- DONUT CHART BLOCK -->    
      		<div class="dash-unit" style="height:409px; margin-top: -13px;">  
                    <hr>  
      <form method="post" action="post_messanger.php" style="margin-left: -4px; width:494px;">
 
<table class='table table-bordered' style="margin-left: 8px;">
<td><h1>Post a message</h1></td>
</tr>
<td><div class="input-group">
                <span class="input-group-addon" style="width: 124px;background-color:#DDDDDD;">Send to</span>
                <select class="form-control" id="Sendto" input name="Sendto" required="required" style="height:28px; width: 205px;"/>
...
<td><button type="submit" name="btn-gen-form" style="height: 34px; color: #fff; background-color: #449d44; border-color: #398439;" class="btn btn-primary"><i class="glyphicon glyphicon-plus"></i> &nbsp; Submit</button>
 ...
 <!-- close  --> 
  ...
  <!-- USER PROFILE BLOCK -->
        <div class="col-sm-3 col-lg-3" style="width:636px; margin-left:-28px;">
      		<div class="dash-unit" style="height: 589px; margin-top: -225px; width:636px;"/>  
            
 <h1>Here are the results ...!</h1>                
 <div id='resultcontainer' style="margin-top:-469px;">

<div class='iframe_container'>
<iframe name='frame_result1' width='630px' height='516px' frameborder='0'></iframe>
</div>
<div class='iframe_container'>
<iframe name='frame_result2' width='630px' height='516px' frameborder='0'></iframe>
</div>
