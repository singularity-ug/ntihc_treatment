...
<li><a href="tollfree_action.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Callers by action taken</a></li> 
            ...
            <div id="div-5" class="accordion-body collapse in body"> 
              ...
              <div class="col-sm-12" style="border:2px solid #f4f4f4;">    
 <br>
...
<div class="col-sm-2"> </div>  
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
          ...
          <center> <legend style="color:#000; font-size:12px; text-align:left;"> NUMBER OF CALLS BY MONTH </legend> </center> 
...
// Push the data into the array
        ...
        $columnChart = new FusionCharts("column2D", "myFirstChart" , 1254, 310, "chart-1", "json", $jsonEncodedData);
