                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class='dropdown '>
                                     ...
                                     <li><a href=<button class="btn btn-warning" data-toggle="modal"  data-target="#uiModal2" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8;text-align:left;"> </button> <i class="icon-lock icon-white"></i>Fuel cards</a></li> 
                                    </div>
 ...
 <div class="col-sm-6" >
	 ...
	 <a href="#"><img src="assets/sysicons/insuranceimages.jpg" width="80" height="140" alt="Marcel Newman" class="img-circle" >
      ...
      <div class="progress progress-striped active">
		<div class="progress-bar progress-bar-imms01" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
		Approved fuel order due for downloading / Issuance<span class="sr-only">60% Complete</span>
		</div>
	    </div>
...
$sql = "SELECT * FROM fuellogs ORDER BY id ";

 $res = $conn->query($sql);
$x=1;
 while($row=$res->fetch_assoc()){
 $vx = $row['REGISTRATIONNO']."__".$row['PRODUCT']."__".$row['LUBRICANT']."__".$row['LITRE']."__".$row['PURPOSEOFCONSUMPTION']."__".$row['DRIVER']."__"
 .$row['CREATEDDATE']."__".$row['DEPARTRMENT_FR']."__".$row['INITIATEDBY']."__".$row['AUTHORISERNAME']."__".$row['APPROVEDDATE1']."__".$row['APPROVERRNAME']."__".$row['APPROVERCOMMENT']."__".$row['id'];
  echo'<tr>'.
       '<td>'.$x.'</td>'. 
...
$x=$x+1;
 ...
 <div class="progress progress-striped active">
		<div class="progress-bar progress-bar-imms01" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 100%;">
		Notifications<span class="sr-only">60% Complete</span>
		</div>
	    </div>
        
      <div id="reviews" class="carousel slide" data-ride="carousel">

                                    <div class="carousel-inner" style="background-color: #f0f0f0;">
                                        <div class="item active" >

                                            <div class="col-sm-10 col-md-offset-1" >
                                            
                                            <h4><i class=""><img src="assets/sysicons/dialog-warning-2400px.png" width="50" height="60"></i>Fuel cards below target level<i class=""></i></h4> 
                                            
                                            <p style="color:#000000; text-align:center; font-weight:bold; font-size:36px; margin-top:-35px;">0 </p>
                                                <div class="user-img pull-right"> 
                                                  
                                                </div>
                                                <h5 class="pull-right"><button class="btn btn-warning" data-toggle="modal" data-target="#replenishFuel"> 
                                                <strong class="c-black">Replenish</strong></h5></button>
                                            </div>
                                        </div>
                                        
                                        <div class="item">
                                            <div class="col-sm-10 col-md-offset-1"> 
                                                <h4><i class=" "><img src="assets/sysicons/dialog-warning-2400px.png" width="50" height="60"></i>Service due reminders <i class=" "></i></h4>
                                                 <p style="color:#000000; text-align:center; font-weight:bold; font-size:36px; margin-top:-35px;">0 </p>
                                                 <div class="user-img pull-right"> 
                                                </div>
                                                <h5 class="pull-right"><strong class="c-black">click here</strong></h5>
                                            </div> 
                                        </div>
                                        ...
                                        <div class="item">
                                            <div class="col-sm-10 col-md-offset-1">
                                                ...
                                                <h4><i class=" "><img src="assets/sysicons/4wd.png" width="50" height="60"></i>Transport book orders<i class=" "></i></h4>
                                                 <p style="color:#000000; text-align:center; font-weight:bold; font-size:36px; margin-top:-35px;">0 </p>
                        ...
                        <div class="col-sm-4" >
                            <ul class="nav nav-tabs" >
                                <li class="active"><a href="#home" data-toggle="tab">Issue fuel</a>
                                </li>
                                <li><a href="#profile" data-toggle="tab">History</a>
                                </li>
                                <li><a href="#messages" data-toggle="tab">Fuel analysis</a>
                                </li>
                                <li><a href="#settings" data-toggle="tab">Contact admin</a>
                                </li>
                            </ul>
                        ...
                        <div class="modal fade" id="uiModal3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="H3"> Add vehicle</h4>
                                        </div>
                                        <div class="modal-body">
...
<script>
  ...
  $("#LUBRICANT").val(dsx[3]);
  $("#LITRE").val(dsx[4]);
  $("#PURPOSEOFCONSUMPTION").val(dsx[5]);
  $("#DRIVER").val(dsx[6]);
  $("#CREATEDDATE").val(dsx[7]);
  $("#DEPARTRMENT_FR").val(dsx[8]);
  $("#INITIATEDBY").val(dsx[9]);
  $("#AUTHORISERNAME").val(dsx[10]);
  $("#APPROVEDDATE1").val(dsx[11]);
