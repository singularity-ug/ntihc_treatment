...
?>   
   ...
   <table class="table table-bordered ">
    <thead> 
        <tr>
        <td style="width: 15%;">Updated by </td>
        <td style="width: 35%;">  <input type="text" class="form-control"  name="REGISTEREDBY"  id="REGISTEREDBY" readonly="" 
          value="<?php echo $nameofuser; ?>" /> </td>

        <td style="width: 15%;">Registered by </td>
        <td style="width: 35%;"> <?php echo $REGISTEREDBY; ?>  </td>
