...
style="background:url(../assets/img/pattern/Light-Gret-Wallpaper-Downloads.jpg);">  
...
?>     
  ...
  <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-grey-gradient"  style="border-radius: 11px;border-top: 2px solid #ecf0f5;border-left: 1px solid #ecf0f5;
          border-right: 4px solid #ecf0f5;">
          <a href=hr_mgt/<button class="" data-toggle="modal"  data-target="#contactinfs"></button></i>&nbsp;&nbsp;Expiry alerts <i class=" "></i><p></p>
         <center> <p class="button 5" style="border: 6px solid #ecf0f5; width:50%; height:50%; color:#000; text-align:center; font-weight:bold; font-size:20px;">
          0 
          <p/></center></a> 
          </div></div>  
  ...
  <a href="drugs_mgr.php">
       <center><img src="../database icons/reset6.jpg" width="100" height="100" class="img-circle" style="border: 6px solid #ecf0f5; height:100px; width:100px;"> 
      </center>    </a> 
        </div>  
  </div>      
                 <!-- /. ROW  -->   
 ...
 <img src="../assets/img/logsbig.PNG" width="100%" height="100%"> 
  ...
  <tr>
   ...
   <tr> 
	...
	<td style="width:50%;border:2px solid #ecf0f5;"><input type="text" name="UOM " id="UOM" 
    style="width:100%; text-align:left;background-color:#ecf0f5;"></td> 
   ...
   <tbody>
   <tr> 
	<td style="width:50%;border:2px solid #ecf0f5;"><input type="numeric" name="OPENINGSTOCK_QTY" id="OPENINGSTOCK_QTY"  value="0" 
    style="width:100%; text-align:left;background-color:#ecf0f5;">  </td>  
	
	<td style="width:50%;"><input type="numeric" name="UNIT_UOM " id="UNIT_UOM"  
    style="width:100%; text-align:left;background-color:#ecf0f5;"></td> 
   ...
   <tr> 
	<td style="width:50%;border:2px solid #ecf0f5;"><input type="numeric" name="UNITPRICE" id="UNITPRICE"   
    style="width:100%; text-align:left;background-color:#ecf0f5;">  </td>  
