                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="">NTIHC LABORATORY MODULE</a></li> 
                                    <li class='dropdown '>
...
<hr>
<div class="text-left" >
                     <div class="aside001" style= ' margin-left: 0px;margin-top:0px; width:100%; background:#dddddd;'>
...
<hr> 
	    ...
	    <div class="box"> 
                 <header>
  	  	         <h5>PENDING LAB REQUESTS</h5>
  	             </header>

		        <div class="aside2" id="aside222" style="color:white; text-align:left; font-size:12px; border:double;">
...
$xx=0;
          ...
          echo "<th>ACTION</th>";
            ...
            while($row = mysqli_fetch_array($result)){
                echo "<tr>"; 
				 ...
				 echo "<td>" . $row['USERINITIAL'] . "</td>";
              echo '<td><input style="height:20px; background-color:#ffcb00;" type="button" id="'. $row['NTIHCNO'] . '" value=">>>>" onclick="sendToService(this)" ></td>';
                echo "</tr>";
            }
            echo "</table>";
            // Close result set
	...
	<div class="col-lg-4">
	     <div class="box">
	         <div class="body" style="height: 500px; width:185%; background-color:#EEEEEE;">
                 <header>
                 <h5>Voluntary Testing</h5>
                 </header><br />
                 <form name="form1" method="post" action="../php/Client_registration_process.php">

   <div class="aside001" style= ' margin-left: 0px;margin-top:0px; width:100%; background:#FFCB00;'>
          ...
          <p>
            ...
            <input type="button" value="Remove" onClick="deleteRow('dataTable1')"  />
              ...
              <th> <label for="NTIHCNO" class="label">NTIHC NO.</label>          </th>
              <th><label for="HIV" class="label">HIV</label>             </th>
              <th> <label for="SYPHILLIS" class="label">SYPHILLIS</label>  </th>
               <th> <label for="HPV" class="label">HPV</label>  </th>
              <th><label for="CATEGORY" class="label">CATEGORY</label>                </th>
              <th><label for="SUBMIT" class="label">SAVE</label>           </th>
           </tr>
                    </thead>
                     <tbody id="tablebody" style="width:800px;">
                       <tr id="0_rowdata" >
                       ...
                       <td>
                        <input type="text" name="NTIHCNO" id="NTIHC NO." required="required" style= 'margin-left: 0px;margin-top: 5px;height:20px; width:100px; background-color:#FFFFAA;'/>
                       </td>
                      <td><select name="HIV" id="HIV" required="required" style= 'margin-left:-13px; margin-top: 5px;height:20px; width:100px; background-color:#FFF;'/>
                              <option value="-1"></option>
                              <option>NEGATIVE</option>
                              <option>POSITIVE</option>
                         </select>
                     </td>
                     <td><select name="SYPHILLIS" id="SYPHILLIS" required="required" style= 'margin-left: -17px;margin-top: 5px;height:20px; width:100px; background-color:#FFF;'/>
                              <option value="-1"></option>
                              <option>NEGATIVE</option>
                              <option>POSITIVE</option>
                        </select>
                     </td>
                     <td><select name="HPV" id="HPV" required="required" style= 'margin-left:-16px;margin-top: 5px;height:20px; width:100px; background-color:#FFF;'/>
                              <option value="-1"></option>
                              <option>NEGATIVE</option>
                              <option>POSITIVE</option>
                        </select>
                     ...
                     <td>
                       <select name="category" id="category" required="required" style= 'margin-left:-13px; margin-top: 5px;height:20px; width:100px; background-color:#FFF;'/>
               ...
               <td>
                     <div class="clear"></div>
                       <input class="submit" type="button" onClick="getvalues2(this);" value="Send" style= "margin-left: 0px;margin-top: 1px;height:22px; width:50px;" />
                <div class="clear"></div>
              </td>
            </tr>
             </tbody>
             ...
             function getvalues2(elem){
              ...
              var  ntihc = rowid.cells[1].childNodes[1].value;
             	...
             	var	 stool = rowid.cells[5].childNodes[1].value;
alert(""+ntihc+" : "+spec+" : "+heam+" : "+mal+" : "+stool);
       postAjax('lab_voluntary_insert.php', { p1: ntihc, p2: spec,p3:heam,p4:mal,p5:stool, p10:0 },
