...
<link rel="stylesheet" href=" assets/plugins/switch/static/stylesheets/bootstrap-switch.css" />
  ...
  <script type="text/javascript" src="assets/fusion/js/fusioncharts.js"></script>
       <script src="assets/fusion/js/fusioncharts.js"></script>
        <script src="assets/fusion/js/fusioncharts.charts.js"></script>
        <script src="assets/fusion/js/themes/fusioncharts.theme.zune.js"></script>
                ...
                <!-- Brand and toggle get grouped for better mobile display -->
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse" >
                                ...
                                <ul class="nav navbar-nav">
                                      ...
                                      <li><a href="tollfree_reports.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; text-align:left;"><i class="icon-lock icon-white"></i>Home</a></li>
                                    <li class='dropdown '>
...
<li><a href="tollfree_action.php" style="border: 2px solid #f4f4f4; padding: 10.5px; color: #000000; background-color:#f8f8f8; text-align:left;">  <i class="icon-lock icon-white"></i>Callers by action taken</a></li>  
 ...
 <div class="col-sm-6" style="border:2px solid #f4f4f4;">   
...
<div class="col-sm-2"> </div>  
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
    ...
    <div class="col-sm-12"> 
     <legend style="color:#000; font-size:11px; text-align:center; font-weight:bold; text-transform:uppercase;"> Number of young people calling on toll-free by age group and gender </legend>  
...
$sql = "SELECT FISCALYEAR,  CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' 
                         WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' 
						 WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' 
						 WHEN AGE >= 25 THEN '25 +' END AS agegroup, 
											 
											 MAX(CASE WHEN SEX = 1 THEN CID END) AS FEMALE,  
											 MAX(CASE WHEN SEX = 2 THEN CID END) AS MALE  
											 FROM tollfree GROUP BY agegroup, FISCALYEAR ORDER BY FISCALYEAR DESC";
...
<?php  
    ...
    $strQuery = "SELECT FISCALYEAR,  CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' 
                         WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' 
						 WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' 
						 WHEN AGE >= 25 THEN '25 +' END AS agegroup, 
...
<div class="row">
  <div class="col-lg-12">
	...
	<h5> . </small></h5>
     ...
     <div class="col-sm-12" > 
    <center> <legend style="color:#000; font-size:12px; text-align:left;"> MONTHLY CALLERS BY FISCAL YEAR </legend> </center> 
      
    <div id="work" style="width:100%;">
    <table id="example10" class="table table-striped table-bordered"  style="font-size:90%; " cellspacing="0" width="100%">
...
$sql = "SELECT FISCALYEAR,  
											 ...
											 FROM tollfree GROUP BY FISCALYEAR  ORDER BY FISCALYEAR DESC";
...
require('php/configtollfree.php');
$sql = "SELECT FISCALMONTH, FISCALYEAR, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' WHEN AGE >= 25 THEN '25 +' END AS agegroup, count(age) AS total FROM tollfree GROUP BY FISCALMONTH, FISCALYEAR, agegroup";
...
<div class="col-sm-2"> </div>
 ...
 <br> <br><br> <br> <br> <br> <br> <br>
          ...
          <center> <legend style="color:#000; font-weight:bold;font-size:12px;"> TOLLFREE REPORT </legend> </center>
          <form class="form-horizontal" style="height:auto;">
          <p style="font-weight:bold;font-size:12px;">1. Number of young people calling on toll-free by age group and gender</p>
...
require('php/configtollfree.php');
$sql = "SELECT SEX, CASE WHEN AGE BETWEEN 10 AND 14 THEN '10 to 14' WHEN AGE BETWEEN 15 and 19 THEN '15 to 19' WHEN AGE BETWEEN 20 and 24 THEN '20 to 24' WHEN AGE >= 25 THEN '25 +' END AS agegroup, count(age) AS total FROM tollfree GROUP BY SEX, agegroup";
