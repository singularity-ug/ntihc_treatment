...
function dome(){
  ...
  <body style="background-color:#fff;">
    ...
    <div class="container" style="height:auto;"/>
     ...
     <!--PAGE CONTENT -->
        <div id="content">
                ...
                <div class="col-lg-12">
                    <h1 class="page-header">Toll free</h1>
                </div> 
            ...
            <form class="form-horizontal" method="post" action="tollfree_process.php"> 
                ...
                <br>
                <!-- /.form-group -->
            <fieldset class="row1" style="margin-top: -7px;">
            <legend>Basic demography</legend>
           
                <div class="form-group">
    <label class="control-label col-lg-4">Sex</label> 
    <div class="col-lg-8">
        <select class="form-control" id="SEX" input name="SEX"  required="required">
    ...
    <div class="col-lg-8">
        <select class="form-control" id="AGE" input name="AGE" required="required">
            <option value="_1"> </option>
    ...
    <div class="col-lg-8">
        <select class="form-control" id="SCHOOLINGSTATUS" name="SCHOOLINGSTATUS"  required="required">
            <option value="_1"> </option>
    ...
    <!-- /.form-group --> 
        ...
        <div id="div-1" class="body">
            ...
            <!-- /.form-group -->
       <fieldset class="row1">
            <legend>Other demography</legend>     
            
     <div class="form-group">
    <label class="control-label col-lg-4">District</label> 
    <div class="col-lg-8">
        <select class="form-control" id="DISTRICT" input name="DISTRICT" required="required" required="required">
            <option value="_1"> </option>
    ...
    <div class="form-group">
                             <label>How did you hear about NTIHC</label>
                               <select class="form-control" id="HEAREDABOUTNTIHC" input name="HEAREDABOUTNTIHC" required="required">
                                <option value="_1"> </option>
                                 <option>PEERS</option>
           ...
           <div class="form-group">
                        ...
                        <select class="form-control" id="HOWDIDYOUKNOABOUTTHISNO" input name="HOWDIDYOUKNOABOUTTHISNO" required="required">
                                <option value="_1"> </option>
                                 <option>PEERS</option>
								<option>PARENTS/GUARDIAN</option>
                                <option>HEALTH WORKER</option>
               ...
               <div class="form-group">
                        ...
                        <input type="text" name="USERINITIAL"  id="USERINITIAL" readonly placeholder="Provider's initial" class="form-control">  
                                        </div>    
                <!-- /.form-group -->
                <div class="form-group">
                    <label class="control-label col-lg-4">Call frequency.</label> 
                    <div class="col-lg-8">
   ...
   <div class="col-lg-15"> 
        <div id="div-1" class="body">
            <form class="form-horizontal">
   <fieldset class="row1">
            <legend>Auto caller search</legend>  

     <div class="col-lg-12" id="res"> </div>
   ...
   <fieldset class="row1"> 
            <legend>Process call details</legend>   
                ...
                <!-- /.form-group --> 
                    ...
                    <div class="col-lg-13">
                        <textarea id="text4" name="DESCRIPTION" id="DESCRIPTION" class="form-control"></textarea>
                    </div>
                </div>
                <br>
  ...
  <table class="table table-striped" id="mytable" style=" color:#000000;">
    <thead>
      <tr>
        <th>*</th>
        <th>Problem</th>
  ...
  <br> 
      		...
      		<div class="" style="  margin-left: 0px; margin-top: 132px;"/>
                    <hr>
    ...
    <!-- /.form-group -->  
     ...
     <div class="form-group">
             ...
             <div class="form-group">
                        ...
                        <select class="form-control"  id="SPECIFYSERVICEREFERREDFOR" input name="SPECIFYSERVICEREFERREDFOR">
                                <option value="_1"> </option>
...
<option> VAGINAL DISCHARGE</option>
             ...
             <div class="form-group">
                   ...
                   <input type="submit" name="button" id="button" value="Save and new" class="btn btn-success">  
  ...
  function addRow12(tableId){
     ...
     var s1 = '<select name="PROBLEMCATEGORY" id="p_'+rowCount+'" required="required" '+
              ' style= "margin-left:0px; background-color:#fff" >'+
     ...
     var select  =  '<select name="TOPIC" required="required"  id="c_'+rowCount+'"'+
                    'style= "margin-left: 0px; background-color:#fff;" >'+
             		    '<option value="-1"> </option>'+
