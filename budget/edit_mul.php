...
for($i=0; $i<$chkcount; $i++)
{
	...
	while($row=$res->fetch_array())
	{
		...
		<input type="text" name="fy[]" value="<?php echo $row['financial_yr'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="bd[]" value="<?php echo $row['budget_details'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="ca[]" value="<?php echo $row['category'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="co[]" value="<?php echo $row['code'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="bu[]" value="<?php echo $row['budget_line'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="un[]" value="<?php echo $row['unit_type'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="qu[]" value="<?php echo $row['quantity'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="ucos[]" value="<?php echo $row['unit_cost'];?>" class="form-control" />
        </td>
        <td>
		<input type="text" name="qtu[]" value="<?php echo $row['qty_unittype'];?>" class="form-control" />
         </td>
        <td>
		<input type="text" name="qto[]" value="<?php echo $row['qty_outstanding'];?>" class="form-control" />
         </td>
        <td>
		<input type="text" name="fqone[]" value="<?php echo $row['1stqtr_estimate'];?>" class="form-control" />
         </td>
        <td>
...
<a href="index.php" class="btn btn-large btn-info"><i class="glyphicon glyphicon-plus"></i> &nbsp; Add Records</a>
<br>
</td>
</tr>
</table>
