                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="">INCOME AND EXPENDITURE BUDGET</a></li>
                                    <li class='dropdown '>
...
<?php
	...
	if($count > 0)
	{
		while($row=$res->fetch_array())
		{
			...
			<td><?php echo $row['budget_details']; ?></td>
			...
			<td><?php echo $row['qty_unittype']; ?></td>
			<td><?php echo $row['totalcost']; ?></td>
			<td><?php echo $row['qty_outstanding']; ?></td>
			<td><?php echo $row['1stqtr_estimate']; ?></td>

			<td><?php echo $row['2ndqtr_estimate']; ?></td>
			<td><?php echo $row['3rdqtr_estimate']; ?></td>
			<td><?php echo (intval($row['1stqtr_estimate']) +intval($row['2ndqtr_estimate'])+intval($row['3rdqtr_estimate'])); /*$row['qtr_totals'];*/ ?></td>
			<td><?php echo $row['amount_utilised']; ?></td>

			<td><?php echo $row['remaining_onbudget']; ?></td>
			<td><?php echo $row['percentage_utilised']; ?></td>
			<td><?php echo $row['percentage_remaining']; ?></td>
			</tr>
			<?php
		}
	}
