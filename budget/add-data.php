...
if(isset($_POST['save_mul']))
{
	...
	for($i=1; $i<=$total; $i++)
	{
		...
		$sql="INSERT INTO users(financial_yr,budget_details,category,code,budget_line,unit_type,quantity,unit_cost,qty_unittype,totalcost,1stqtr_estimate,2ndqtr_estimate,3rdqtr_estimate,qtr_totals) VALUES('".$fy."','".$bd."','".$ca."','".$co."','".$bu."','".$un."','".$qu."','".$ucoss."','".$qtu."','".$tt."','".$fqone."','".$fqtwo."','".$fqthree."','".$qtt."' )";
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse navbar-ex1-collapse">
                                ...
                                <ul class="nav navbar-nav">
                                    <li class="active"><a href="../budgeting.php">Dashboard</a></li>
...
if(isset($_POST['btn-gen-form']))
{
	...
	for($i=1; $i<=$_POST["no_of_rec"]; $i++)
	{
        ...
        <tr>
        <td><?php echo $i; ?></td>
        <td><input type="text" name="fiy<?php echo $i; ?>" id="fiy<?php echo $i; ?>" required="required" placeholder="financial year" class='form-control' /></td>
        <td><input type="text" name="bud<?php echo $i; ?>" id="bud<?php echo $i; ?>" required="required" placeholder="budget details" class='form-control' /></td>
		<td><input type="text" name="cat<?php echo $i; ?>"  id="cat<?php echo $i; ?>" required="required" placeholder="category" class='form-control' /></td>
        <td><input type="text" name="cod<?php echo $i; ?>" id="cod<?php echo $i; ?>" required="required"placeholder="code" class='form-control' /></td>
		<td><input type="text" name="bul<?php echo $i; ?>" id="bul<?php echo $i; ?>" required="required" placeholder="budget_line" class='form-control' /></td>
    ...
    <td><input type="text" onkeyUp = "calcTotal(this)" name="ucoss<?php echo $i; ?>" id="ucoss<?php echo $i; ?>" required="required" placeholder="unit_cost" class='form-control' /></td>
		<td><input type="text" onkeyUp = "calcTotal(this)" name="qtut<?php echo $i; ?>" id="qtut<?php echo $i; ?>" value="1" class='form-control' /></td>

		 <td><input type="text" name="ttc<?php echo $i; ?>" id="ttc<?php echo $i; ?>" disabled="disabled" placeholder="totalcost" class='form-control' /></td>

    <td><input type="text" onkeyUp = "calcTotal(this)" name="1qtr<?php echo $i; ?>" id="1qtr<?php echo $i; ?>"placeholder="1stqtr_estimate" class='form-control' /></td>
		<td><input type="text" onkeyUp = "calcTotal(this)" name="2qtr<?php echo $i; ?>" id="2qtr<?php echo $i; ?>"placeholder="2ndqtr_estimate" class='form-control' /></td>
    <td><input type="text" onkeyUp = "calcTotal(this)" name="3qtr<?php echo $i; ?>" id="3qtr<?php echo $i; ?>"placeholder="3rdqtr_estimate" class='form-control' /></td>

		<td><input type="text" name="qttt<?php echo $i; ?>" id="qttt<?php echo $i; ?>" disabled="disabled" placeholder="qtr_totals" class='form-control' /></td>
        </tr>
        <?php
	}
	?>
    ...
    <a href="../budgeting.php" class="btn btn-primary"> <i class="glyphicon glyphicon-fast-backward"></i> &nbsp; Back to menu</a>
